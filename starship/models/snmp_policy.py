...
class SnmpPolicy(object):
    ...
    def access_community_string(self):
        ...
        The default SNMPv1 or SNMPv2c community name or SNMPv3 username to include on any trap messages to the SNMP host.  
    ...
    def community_access(self):
        ...
        This property controls access to the information in the inventory tables. Accepted values are Full, Limited, Disabled. SNMP Community Access is applicable only for SNMPv1 and SNMPv2c users.  
    ...
    def enabled(self):
        ...
        State of the SNMP Policy on the endpoint. Decides whether the endpoint sends SNMP traps to the designated host.  
    ...
    def profile(self):
        """
        Gets the profile of this SnmpPolicy.
        Relationship to the profile object 

        :return: The profile of this SnmpPolicy.
        :rtype: MoMoRef
        """
    ...
    def profile(self, profile):
        """
        Sets the profile of this SnmpPolicy.
        Relationship to the profile object 

        :param profile: The profile of this SnmpPolicy.
        :type: MoMoRef
        """
    ...
    def snmp_port(self):
        ...
        The port on which the SNMP agent runs.  
    ...
    def sys_location(self):
        ...
        Location of host where SNMP agent(server) runs.  
    ...
    def trap_community(self):
        ...
        The name of the SNMP community group used for sending SNMP trap to other devices. This is only for SNMPv2c users.   
