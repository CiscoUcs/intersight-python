...
class SnmpTrap(object):
    ...
    def trap_port(self):
        ...
        Port used by server to communicate with trap destination.  
    ...
    def trap_type(self):
        ...
        Type of messages to be sent to the manager from the agent. Accepted values are Trap, Inform.  
    ...
    def trap_user(self):
        ...
        SNMP user for the trap. Only applicable for SNMPv3.  
    ...
    def trap_version(self):
        ...
        SNMP version used for the trap. Accepted values are V2, V3.   
