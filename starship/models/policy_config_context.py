...
class PolicyConfigContext(object):
    ...
    def error_state(self):
        ...
        Indicates a profile's error state Values -- validation-error (Profile side validation error), pre-config-error (installer runtime validation error), config-error (installer configuration error)  
    ...
    def oper_state(self):
        ...
        Combined state (configState, and operational state of the associated physical resource) to indicate the current state of the profile. Values -- n/a, power-off, pending-changes, configuring, ok, ok-with-warning, errored   
