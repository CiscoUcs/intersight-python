...
class NetworkconfigPolicy(object):
    ...
    def __init__(self, account_moid=None, ancestors=None, create_time=None, mod_time=None, moid=None, object_type=None, owners=None, parent=None, tags=None, description=None, name=None, alternate_ipv4dns_server=None, alternate_ipv6dns_server=None, dynamic_dns_domain=None, enable_dynamic_dns=None, enable_ipv4dns_from_dhcp=None, enable_ipv6dns_from_dhcp=None, enable_vlan=None, organization=None, preferred_ipv4dns_server=None, preferred_ipv6dns_server=None, priority=None, profile=None, vlan_id=None):
        """
    ...
    def enable_vlan(self):
        ...
        If enabled, Cisco IMC is connected to a virtual LAN.  
