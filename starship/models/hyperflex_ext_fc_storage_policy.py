...
class HyperflexExtFcStoragePolicy(object):
    ...
    attribute_map = {
        ...
        'wwxn_range': 'WwxnRange'
    }

    def __init__(self, account_moid=None, ancestors=None, create_time=None, mod_time=None, moid=None, object_type=None, owners=None, parent=None, tags=None, description=None, name=None, account=None, admin_state=None, cluster_profile=None, exta_traffic=None, extb_traffic=None, wwxn_range=None):
        """
        ...
        if wwxn_range is not None:
          self.wwxn_range = wwxn_range
    ...
    def account(self):
        """
        Gets the account of this HyperflexExtFcStoragePolicy.

        :return: The account of this HyperflexExtFcStoragePolicy.
        :rtype: MoMoRef
        """
    ...
    def account(self, account):
        """
        Sets the account of this HyperflexExtFcStoragePolicy.

        :param account: The account of this HyperflexExtFcStoragePolicy.
        :type: MoMoRef
        """
    ...
    def admin_state(self):
        ...
        Flag to determine if external FC storage configuration is enabled or disabled  
    ...
    def cluster_profile(self):
        """
        Gets the cluster_profile of this HyperflexExtFcStoragePolicy.

        :return: The cluster_profile of this HyperflexExtFcStoragePolicy.
        :rtype: list[MoMoRef]
        """
    ...
    def cluster_profile(self, cluster_profile):
        """
        Sets the cluster_profile of this HyperflexExtFcStoragePolicy.

        :param cluster_profile: The cluster_profile of this HyperflexExtFcStoragePolicy.
        :type: list[MoMoRef]
        """
    ...
    def exta_traffic(self):
        ...
        VSAN for Primary Fabric Interconnect external FC storage traffic  
    ...
    def extb_traffic(self):
        ...
        VSAN for Secondary Fabric Interconnect external FC storage traffic  
    ...
    def wwxn_range(self):
        """
        Gets the wwxn_range of this HyperflexExtFcStoragePolicy.

        :return: The wwxn_range of this HyperflexExtFcStoragePolicy.
        :rtype: HyperflexWwxnRange
        """
        return self._wwxn_range

    @wwxn_range.setter
    def wwxn_range(self, wwxn_range):
        """
        Sets the wwxn_range of this HyperflexExtFcStoragePolicy.

        :param wwxn_range: The wwxn_range of this HyperflexExtFcStoragePolicy.
        :type: HyperflexWwxnRange
        """

        self._wwxn_range = wwxn_range
