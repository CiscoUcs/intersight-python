...
**results** | [**list[WorkflowCustomDataTypeDefinition]**](WorkflowCustomDataTypeDefinition.md) | The array of &#39;workflow.CustomDataTypeDefinition&#39; resources matching the request. | [optional] 
