...
------------- | ------------- | -------------
[**get_ls_service_profile_by_moid**](LsApi.md#get_ls_service_profile_by_moid) | **GET** /ls/ServiceProfiles/{Moid} | Read a &#39;ls.ServiceProfile&#39; resource.
[**get_ls_service_profile_list**](LsApi.md#get_ls_service_profile_list) | **GET** /ls/ServiceProfiles | Read a &#39;ls.ServiceProfile&#39; resource.
[**patch_ls_service_profile**](LsApi.md#patch_ls_service_profile) | **PATCH** /ls/ServiceProfiles/{Moid} | Update a &#39;ls.ServiceProfile&#39; resource.
[**update_ls_service_profile**](LsApi.md#update_ls_service_profile) | **POST** /ls/ServiceProfiles/{Moid} | Update a &#39;ls.ServiceProfile&#39; resource.
...
api_instance = intersight.LsApi(intersight.ApiClient(configuration))
moid = 'moid_example' # str | The unique Moid identifier of a resource instance.

try:
    # Read a 'ls.ServiceProfile' resource.
    api_response = api_instance.get_ls_service_profile_by_moid(moid)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling LsApi->get_ls_service_profile_by_moid: %s\n" % e)
```
...
|-------------|-------------|------------------|
**200** | An instance of the &#39;ls.ServiceProfile&#39; resource. |  * Set-Cookie -  <br>  * x-starship-traceid -  <br>  * Content-Disposition -  <br>  * Content-Length -  <br>  |
...
> LsServiceProfileList get_ls_service_profile_list(filter=filter, orderby=orderby, top=top, skip=skip, select=select, expand=expand, apply=apply, count=count, inlinecount=inlinecount, at=at)
...
try:
    # Read a 'ls.ServiceProfile' resource.
    api_response = api_instance.get_ls_service_profile_list(filter=filter, orderby=orderby, top=top, skip=skip, select=select, expand=expand, apply=apply, count=count, inlinecount=inlinecount, at=at)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling LsApi->get_ls_service_profile_list: %s\n" % e)
```
...
[**LsServiceProfileList**](LsServiceProfileList.md)
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | List of &#39;ls.ServiceProfile&#39; resources for the given filter criteria |  * Set-Cookie -  <br>  * x-starship-traceid -  <br>  * Content-Disposition -  <br>  * Content-Length -  <br>  |
**400** | The request could not be understood by the server due to malformed syntax. The client SHOULD NOT repeat the request without modifications. For example, the request may contain an incorrect JSON syntax, or the request fails validation checks. The HTTP body may contain a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
**401** | The request requires user authentication. The client may repeat the request with a suitable Authorization header field. If the request already included Authorization credentials, then the 401 response indicates that authorization has been refused for those credentials. The HTTP body may contain a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
**403** | The request was properly authenticated, but the server is refusing to fulfill it. The HTTP body may contain a document that provides more details about the error. For example, the user may not have sufficient privileges to perform the request.  |  * x-starship-traceid -  <br>  |
**404** | The specified resource was not found. The HTTP body contains a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
...
> LsServiceProfile patch_ls_service_profile(moid, ls_service_profile)
...
api_instance = intersight.LsApi(intersight.ApiClient(configuration))
moid = 'moid_example' # str | The unique Moid identifier of a resource instance.
ls_service_profile = intersight.LsServiceProfile() # LsServiceProfile | The 'ls.ServiceProfile' resource to update.

try:
    # Update a 'ls.ServiceProfile' resource.
    api_response = api_instance.patch_ls_service_profile(moid, ls_service_profile)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling LsApi->patch_ls_service_profile: %s\n" % e)
```
...
**202** | The HTTP 202 status response code indicates that the request has succeeded. The &#39;ls.ServiceProfile&#39; resource is asynchronously being patched as requested.  |  * Set-Cookie -  <br>  * x-starship-traceid -  <br>  |
**400** | The request could not be understood by the server due to malformed syntax. The client SHOULD NOT repeat the request without modifications. For example, the request may contain an incorrect JSON syntax, or the request fails validation checks. The HTTP body may contain a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
**401** | The request requires user authentication. The client may repeat the request with a suitable Authorization header field. If the request already included Authorization credentials, then the 401 response indicates that authorization has been refused for those credentials. The HTTP body may contain a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
**403** | The request was properly authenticated, but the server is refusing to fulfill it. The HTTP body may contain a document that provides more details about the error. For example, the user may not have sufficient privileges to perform the request.  |  * x-starship-traceid -  <br>  |
**404** | The specified resource was not found. The HTTP body contains a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
...
> LsServiceProfile update_ls_service_profile(moid, ls_service_profile)
...
try:
    # Update a 'ls.ServiceProfile' resource.
    api_response = api_instance.update_ls_service_profile(moid, ls_service_profile)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling LsApi->update_ls_service_profile: %s\n" % e)
```
...
**202** | The HTTP 202 status response code indicates that the request has succeeded. The &#39;ls.ServiceProfile&#39; resource is asynchronously being modified as requested.  |  * Set-Cookie -  <br>  * x-starship-traceid -  <br>  |
**400** | The request could not be understood by the server due to malformed syntax. The client SHOULD NOT repeat the request without modifications. For example, the request may contain an incorrect JSON syntax, or the request fails validation checks. The HTTP body may contain a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
**401** | The request requires user authentication. The client may repeat the request with a suitable Authorization header field. If the request already included Authorization credentials, then the 401 response indicates that authorization has been refused for those credentials. The HTTP body may contain a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
**403** | The request was properly authenticated, but the server is refusing to fulfill it. The HTTP body may contain a document that provides more details about the error. For example, the user may not have sufficient privileges to perform the request.  |  * x-starship-traceid -  <br>  |
**404** | The specified resource was not found. The HTTP body contains a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
