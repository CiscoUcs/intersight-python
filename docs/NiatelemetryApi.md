# intersight.NiatelemetryApi

All URIs are relative to *https://intersight.com/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_niatelemetry_nia_inventory_by_moid**](NiatelemetryApi.md#get_niatelemetry_nia_inventory_by_moid) | **GET** /niatelemetry/NiaInventories/{Moid} | Read a &#39;niatelemetry.NiaInventory&#39; resource.
[**get_niatelemetry_nia_inventory_list**](NiatelemetryApi.md#get_niatelemetry_nia_inventory_list) | **GET** /niatelemetry/NiaInventories | Read a &#39;niatelemetry.NiaInventory&#39; resource.
[**get_niatelemetry_nia_license_state_by_moid**](NiatelemetryApi.md#get_niatelemetry_nia_license_state_by_moid) | **GET** /niatelemetry/NiaLicenseStates/{Moid} | Read a &#39;niatelemetry.NiaLicenseState&#39; resource.
[**get_niatelemetry_nia_license_state_list**](NiatelemetryApi.md#get_niatelemetry_nia_license_state_list) | **GET** /niatelemetry/NiaLicenseStates | Read a &#39;niatelemetry.NiaLicenseState&#39; resource.


# **get_niatelemetry_nia_inventory_by_moid**
> NiatelemetryNiaInventory get_niatelemetry_nia_inventory_by_moid(moid)
...
api_instance = intersight.NiatelemetryApi(intersight.ApiClient(configuration))
moid = 'moid_example' # str | The unique Moid identifier of a resource instance.

try:
    # Read a 'niatelemetry.NiaInventory' resource.
    api_response = api_instance.get_niatelemetry_nia_inventory_by_moid(moid)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NiatelemetryApi->get_niatelemetry_nia_inventory_by_moid: %s\n" % e)
```
...
|-------------|-------------|------------------|
**200** | An instance of the &#39;niatelemetry.NiaInventory&#39; resource. |  * Set-Cookie -  <br>  * x-starship-traceid -  <br>  * Content-Disposition -  <br>  * Content-Length -  <br>  |
...
# **get_niatelemetry_nia_inventory_list**
> NiatelemetryNiaInventoryList get_niatelemetry_nia_inventory_list(filter=filter, orderby=orderby, top=top, skip=skip, select=select, expand=expand, apply=apply, count=count, inlinecount=inlinecount, at=at)
...
try:
    # Read a 'niatelemetry.NiaInventory' resource.
    api_response = api_instance.get_niatelemetry_nia_inventory_list(filter=filter, orderby=orderby, top=top, skip=skip, select=select, expand=expand, apply=apply, count=count, inlinecount=inlinecount, at=at)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NiatelemetryApi->get_niatelemetry_nia_inventory_list: %s\n" % e)
```
...
[**NiatelemetryNiaInventoryList**](NiatelemetryNiaInventoryList.md)
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | List of &#39;niatelemetry.NiaInventory&#39; resources for the given filter criteria |  * Set-Cookie -  <br>  * x-starship-traceid -  <br>  * Content-Disposition -  <br>  * Content-Length -  <br>  |
**400** | The request could not be understood by the server due to malformed syntax. The client SHOULD NOT repeat the request without modifications. For example, the request may contain an incorrect JSON syntax, or the request fails validation checks. The HTTP body may contain a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
**401** | The request requires user authentication. The client may repeat the request with a suitable Authorization header field. If the request already included Authorization credentials, then the 401 response indicates that authorization has been refused for those credentials. The HTTP body may contain a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
**403** | The request was properly authenticated, but the server is refusing to fulfill it. The HTTP body may contain a document that provides more details about the error. For example, the user may not have sufficient privileges to perform the request.  |  * x-starship-traceid -  <br>  |
**404** | The specified resource was not found. The HTTP body contains a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
...
# **get_niatelemetry_nia_license_state_by_moid**
> NiatelemetryNiaLicenseState get_niatelemetry_nia_license_state_by_moid(moid)
...
try:
    # Read a 'niatelemetry.NiaLicenseState' resource.
    api_response = api_instance.get_niatelemetry_nia_license_state_by_moid(moid)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NiatelemetryApi->get_niatelemetry_nia_license_state_by_moid: %s\n" % e)
```
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | An instance of the &#39;niatelemetry.NiaLicenseState&#39; resource. |  * Set-Cookie -  <br>  * x-starship-traceid -  <br>  * Content-Disposition -  <br>  * Content-Length -  <br>  |
**400** | The request could not be understood by the server due to malformed syntax. The client SHOULD NOT repeat the request without modifications. For example, the request may contain an incorrect JSON syntax, or the request fails validation checks. The HTTP body may contain a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
**401** | The request requires user authentication. The client may repeat the request with a suitable Authorization header field. If the request already included Authorization credentials, then the 401 response indicates that authorization has been refused for those credentials. The HTTP body may contain a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
**403** | The request was properly authenticated, but the server is refusing to fulfill it. The HTTP body may contain a document that provides more details about the error. For example, the user may not have sufficient privileges to perform the request.  |  * x-starship-traceid -  <br>  |
**404** | The specified resource was not found. The HTTP body contains a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
...
# **get_niatelemetry_nia_license_state_list**
> NiatelemetryNiaLicenseStateList get_niatelemetry_nia_license_state_list(filter=filter, orderby=orderby, top=top, skip=skip, select=select, expand=expand, apply=apply, count=count, inlinecount=inlinecount, at=at)
...
try:
    # Read a 'niatelemetry.NiaLicenseState' resource.
    api_response = api_instance.get_niatelemetry_nia_license_state_list(filter=filter, orderby=orderby, top=top, skip=skip, select=select, expand=expand, apply=apply, count=count, inlinecount=inlinecount, at=at)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NiatelemetryApi->get_niatelemetry_nia_license_state_list: %s\n" % e)
```
...
[**NiatelemetryNiaLicenseStateList**](NiatelemetryNiaLicenseStateList.md)
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | List of &#39;niatelemetry.NiaLicenseState&#39; resources for the given filter criteria |  * Set-Cookie -  <br>  * x-starship-traceid -  <br>  * Content-Disposition -  <br>  * Content-Length -  <br>  |
**400** | The request could not be understood by the server due to malformed syntax. The client SHOULD NOT repeat the request without modifications. For example, the request may contain an incorrect JSON syntax, or the request fails validation checks. The HTTP body may contain a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
**401** | The request requires user authentication. The client may repeat the request with a suitable Authorization header field. If the request already included Authorization credentials, then the 401 response indicates that authorization has been refused for those credentials. The HTTP body may contain a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
**403** | The request was properly authenticated, but the server is refusing to fulfill it. The HTTP body may contain a document that provides more details about the error. For example, the user may not have sufficient privileges to perform the request.  |  * x-starship-traceid -  <br>  |
**404** | The specified resource was not found. The HTTP body contains a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
