# intersight.NetworkconfigApi

All URIs are relative to *https://intersight.com/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**create_networkconfig_policy**](NetworkconfigApi.md#create_networkconfig_policy) | **POST** /networkconfig/Policies | Create a &#39;networkconfig.Policy&#39; resource.
[**delete_networkconfig_policy**](NetworkconfigApi.md#delete_networkconfig_policy) | **DELETE** /networkconfig/Policies/{Moid} | Delete a &#39;networkconfig.Policy&#39; resource.
[**get_networkconfig_policy_by_moid**](NetworkconfigApi.md#get_networkconfig_policy_by_moid) | **GET** /networkconfig/Policies/{Moid} | Read a &#39;networkconfig.Policy&#39; resource.
[**get_networkconfig_policy_list**](NetworkconfigApi.md#get_networkconfig_policy_list) | **GET** /networkconfig/Policies | Read a &#39;networkconfig.Policy&#39; resource.
[**patch_networkconfig_policy**](NetworkconfigApi.md#patch_networkconfig_policy) | **PATCH** /networkconfig/Policies/{Moid} | Update a &#39;networkconfig.Policy&#39; resource.
[**update_networkconfig_policy**](NetworkconfigApi.md#update_networkconfig_policy) | **POST** /networkconfig/Policies/{Moid} | Update a &#39;networkconfig.Policy&#39; resource.


# **create_networkconfig_policy**
> NetworkconfigPolicy create_networkconfig_policy(networkconfig_policy)
...
api_instance = intersight.NetworkconfigApi(intersight.ApiClient(configuration))
networkconfig_policy = intersight.NetworkconfigPolicy() # NetworkconfigPolicy | The 'networkconfig.Policy' resource to create.

try:
    # Create a 'networkconfig.Policy' resource.
    api_response = api_instance.create_networkconfig_policy(networkconfig_policy)
    pprint(api_response)
...
**202** | The HTTP 202 status response code indicates that the request has succeeded. The &#39;networkconfig.Policy&#39; resource is asynchronously being created as requested.  |  * Set-Cookie -  <br>  * x-starship-traceid -  <br>  |
...
try:
    ...
    print("Exception when calling NetworkconfigApi->delete_networkconfig_policy: %s\n" % e)
```
...
try:
    # Read a 'networkconfig.Policy' resource.
    api_response = api_instance.get_networkconfig_policy_by_moid(moid)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NetworkconfigApi->get_networkconfig_policy_by_moid: %s\n" % e)
```
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | An instance of the &#39;networkconfig.Policy&#39; resource. |  * Set-Cookie -  <br>  * x-starship-traceid -  <br>  * Content-Disposition -  <br>  * Content-Length -  <br>  |
**400** | The request could not be understood by the server due to malformed syntax. The client SHOULD NOT repeat the request without modifications. For example, the request may contain an incorrect JSON syntax, or the request fails validation checks. The HTTP body may contain a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
**401** | The request requires user authentication. The client may repeat the request with a suitable Authorization header field. If the request already included Authorization credentials, then the 401 response indicates that authorization has been refused for those credentials. The HTTP body may contain a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
**403** | The request was properly authenticated, but the server is refusing to fulfill it. The HTTP body may contain a document that provides more details about the error. For example, the user may not have sufficient privileges to perform the request.  |  * x-starship-traceid -  <br>  |
**404** | The specified resource was not found. The HTTP body contains a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
...
> NetworkconfigPolicyList get_networkconfig_policy_list(filter=filter, orderby=orderby, top=top, skip=skip, select=select, expand=expand, apply=apply, count=count, inlinecount=inlinecount, at=at)
...
try:
    # Read a 'networkconfig.Policy' resource.
    api_response = api_instance.get_networkconfig_policy_list(filter=filter, orderby=orderby, top=top, skip=skip, select=select, expand=expand, apply=apply, count=count, inlinecount=inlinecount, at=at)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NetworkconfigApi->get_networkconfig_policy_list: %s\n" % e)
```
...
[**NetworkconfigPolicyList**](NetworkconfigPolicyList.md)
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | List of &#39;networkconfig.Policy&#39; resources for the given filter criteria |  * Set-Cookie -  <br>  * x-starship-traceid -  <br>  * Content-Disposition -  <br>  * Content-Length -  <br>  |
**400** | The request could not be understood by the server due to malformed syntax. The client SHOULD NOT repeat the request without modifications. For example, the request may contain an incorrect JSON syntax, or the request fails validation checks. The HTTP body may contain a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
**401** | The request requires user authentication. The client may repeat the request with a suitable Authorization header field. If the request already included Authorization credentials, then the 401 response indicates that authorization has been refused for those credentials. The HTTP body may contain a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
**403** | The request was properly authenticated, but the server is refusing to fulfill it. The HTTP body may contain a document that provides more details about the error. For example, the user may not have sufficient privileges to perform the request.  |  * x-starship-traceid -  <br>  |
**404** | The specified resource was not found. The HTTP body contains a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
...
> NetworkconfigPolicy patch_networkconfig_policy(moid, networkconfig_policy)
...
api_instance = intersight.NetworkconfigApi(intersight.ApiClient(configuration))
moid = 'moid_example' # str | The unique Moid identifier of a resource instance.
networkconfig_policy = intersight.NetworkconfigPolicy() # NetworkconfigPolicy | The 'networkconfig.Policy' resource to update.

try:
    # Update a 'networkconfig.Policy' resource.
    api_response = api_instance.patch_networkconfig_policy(moid, networkconfig_policy)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NetworkconfigApi->patch_networkconfig_policy: %s\n" % e)
```
...
**202** | The HTTP 202 status response code indicates that the request has succeeded. The &#39;networkconfig.Policy&#39; resource is asynchronously being patched as requested.  |  * Set-Cookie -  <br>  * x-starship-traceid -  <br>  |
**400** | The request could not be understood by the server due to malformed syntax. The client SHOULD NOT repeat the request without modifications. For example, the request may contain an incorrect JSON syntax, or the request fails validation checks. The HTTP body may contain a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
**401** | The request requires user authentication. The client may repeat the request with a suitable Authorization header field. If the request already included Authorization credentials, then the 401 response indicates that authorization has been refused for those credentials. The HTTP body may contain a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
**403** | The request was properly authenticated, but the server is refusing to fulfill it. The HTTP body may contain a document that provides more details about the error. For example, the user may not have sufficient privileges to perform the request.  |  * x-starship-traceid -  <br>  |
**404** | The specified resource was not found. The HTTP body contains a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
...
> NetworkconfigPolicy update_networkconfig_policy(moid, networkconfig_policy)
...
try:
    # Update a 'networkconfig.Policy' resource.
    api_response = api_instance.update_networkconfig_policy(moid, networkconfig_policy)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling NetworkconfigApi->update_networkconfig_policy: %s\n" % e)
```
...
**202** | The HTTP 202 status response code indicates that the request has succeeded. The &#39;networkconfig.Policy&#39; resource is asynchronously being modified as requested.  |  * Set-Cookie -  <br>  * x-starship-traceid -  <br>  |
**400** | The request could not be understood by the server due to malformed syntax. The client SHOULD NOT repeat the request without modifications. For example, the request may contain an incorrect JSON syntax, or the request fails validation checks. The HTTP body may contain a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
**401** | The request requires user authentication. The client may repeat the request with a suitable Authorization header field. If the request already included Authorization credentials, then the 401 response indicates that authorization has been refused for those credentials. The HTTP body may contain a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
**403** | The request was properly authenticated, but the server is refusing to fulfill it. The HTTP body may contain a document that provides more details about the error. For example, the user may not have sufficient privileges to perform the request.  |  * x-starship-traceid -  <br>  |
**404** | The specified resource was not found. The HTTP body contains a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
