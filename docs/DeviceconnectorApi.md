# intersight.DeviceconnectorApi

All URIs are relative to *https://intersight.com/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**create_deviceconnector_policy**](DeviceconnectorApi.md#create_deviceconnector_policy) | **POST** /deviceconnector/Policies | Create a &#39;deviceconnector.Policy&#39; resource.
[**delete_deviceconnector_policy**](DeviceconnectorApi.md#delete_deviceconnector_policy) | **DELETE** /deviceconnector/Policies/{Moid} | Delete a &#39;deviceconnector.Policy&#39; resource.
[**get_deviceconnector_policy_by_moid**](DeviceconnectorApi.md#get_deviceconnector_policy_by_moid) | **GET** /deviceconnector/Policies/{Moid} | Read a &#39;deviceconnector.Policy&#39; resource.
[**get_deviceconnector_policy_list**](DeviceconnectorApi.md#get_deviceconnector_policy_list) | **GET** /deviceconnector/Policies | Read a &#39;deviceconnector.Policy&#39; resource.
[**patch_deviceconnector_policy**](DeviceconnectorApi.md#patch_deviceconnector_policy) | **PATCH** /deviceconnector/Policies/{Moid} | Update a &#39;deviceconnector.Policy&#39; resource.
[**update_deviceconnector_policy**](DeviceconnectorApi.md#update_deviceconnector_policy) | **POST** /deviceconnector/Policies/{Moid} | Update a &#39;deviceconnector.Policy&#39; resource.


# **create_deviceconnector_policy**
> DeviceconnectorPolicy create_deviceconnector_policy(deviceconnector_policy)
...
api_instance = intersight.DeviceconnectorApi(intersight.ApiClient(configuration))
deviceconnector_policy = intersight.DeviceconnectorPolicy() # DeviceconnectorPolicy | The 'deviceconnector.Policy' resource to create.

try:
    # Create a 'deviceconnector.Policy' resource.
    api_response = api_instance.create_deviceconnector_policy(deviceconnector_policy)
    pprint(api_response)
...
**202** | The HTTP 202 status response code indicates that the request has succeeded. The &#39;deviceconnector.Policy&#39; resource is asynchronously being created as requested.  |  * Set-Cookie -  <br>  * x-starship-traceid -  <br>  |
...
try:
    ...
    print("Exception when calling DeviceconnectorApi->delete_deviceconnector_policy: %s\n" % e)
```
...
try:
    # Read a 'deviceconnector.Policy' resource.
    api_response = api_instance.get_deviceconnector_policy_by_moid(moid)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DeviceconnectorApi->get_deviceconnector_policy_by_moid: %s\n" % e)
```
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | An instance of the &#39;deviceconnector.Policy&#39; resource. |  * Set-Cookie -  <br>  * x-starship-traceid -  <br>  * Content-Disposition -  <br>  * Content-Length -  <br>  |
**400** | The request could not be understood by the server due to malformed syntax. The client SHOULD NOT repeat the request without modifications. For example, the request may contain an incorrect JSON syntax, or the request fails validation checks. The HTTP body may contain a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
**401** | The request requires user authentication. The client may repeat the request with a suitable Authorization header field. If the request already included Authorization credentials, then the 401 response indicates that authorization has been refused for those credentials. The HTTP body may contain a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
**403** | The request was properly authenticated, but the server is refusing to fulfill it. The HTTP body may contain a document that provides more details about the error. For example, the user may not have sufficient privileges to perform the request.  |  * x-starship-traceid -  <br>  |
**404** | The specified resource was not found. The HTTP body contains a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
...
> DeviceconnectorPolicyList get_deviceconnector_policy_list(filter=filter, orderby=orderby, top=top, skip=skip, select=select, expand=expand, apply=apply, count=count, inlinecount=inlinecount, at=at)
...
try:
    # Read a 'deviceconnector.Policy' resource.
    api_response = api_instance.get_deviceconnector_policy_list(filter=filter, orderby=orderby, top=top, skip=skip, select=select, expand=expand, apply=apply, count=count, inlinecount=inlinecount, at=at)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DeviceconnectorApi->get_deviceconnector_policy_list: %s\n" % e)
```
...
[**DeviceconnectorPolicyList**](DeviceconnectorPolicyList.md)
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | List of &#39;deviceconnector.Policy&#39; resources for the given filter criteria |  * Set-Cookie -  <br>  * x-starship-traceid -  <br>  * Content-Disposition -  <br>  * Content-Length -  <br>  |
**400** | The request could not be understood by the server due to malformed syntax. The client SHOULD NOT repeat the request without modifications. For example, the request may contain an incorrect JSON syntax, or the request fails validation checks. The HTTP body may contain a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
**401** | The request requires user authentication. The client may repeat the request with a suitable Authorization header field. If the request already included Authorization credentials, then the 401 response indicates that authorization has been refused for those credentials. The HTTP body may contain a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
**403** | The request was properly authenticated, but the server is refusing to fulfill it. The HTTP body may contain a document that provides more details about the error. For example, the user may not have sufficient privileges to perform the request.  |  * x-starship-traceid -  <br>  |
**404** | The specified resource was not found. The HTTP body contains a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
...
> DeviceconnectorPolicy patch_deviceconnector_policy(moid, deviceconnector_policy)
...
api_instance = intersight.DeviceconnectorApi(intersight.ApiClient(configuration))
moid = 'moid_example' # str | The unique Moid identifier of a resource instance.
deviceconnector_policy = intersight.DeviceconnectorPolicy() # DeviceconnectorPolicy | The 'deviceconnector.Policy' resource to update.

try:
    # Update a 'deviceconnector.Policy' resource.
    api_response = api_instance.patch_deviceconnector_policy(moid, deviceconnector_policy)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DeviceconnectorApi->patch_deviceconnector_policy: %s\n" % e)
```
...
**202** | The HTTP 202 status response code indicates that the request has succeeded. The &#39;deviceconnector.Policy&#39; resource is asynchronously being patched as requested.  |  * Set-Cookie -  <br>  * x-starship-traceid -  <br>  |
**400** | The request could not be understood by the server due to malformed syntax. The client SHOULD NOT repeat the request without modifications. For example, the request may contain an incorrect JSON syntax, or the request fails validation checks. The HTTP body may contain a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
**401** | The request requires user authentication. The client may repeat the request with a suitable Authorization header field. If the request already included Authorization credentials, then the 401 response indicates that authorization has been refused for those credentials. The HTTP body may contain a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
**403** | The request was properly authenticated, but the server is refusing to fulfill it. The HTTP body may contain a document that provides more details about the error. For example, the user may not have sufficient privileges to perform the request.  |  * x-starship-traceid -  <br>  |
**404** | The specified resource was not found. The HTTP body contains a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
...
> DeviceconnectorPolicy update_deviceconnector_policy(moid, deviceconnector_policy)
...
try:
    # Update a 'deviceconnector.Policy' resource.
    api_response = api_instance.update_deviceconnector_policy(moid, deviceconnector_policy)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DeviceconnectorApi->update_deviceconnector_policy: %s\n" % e)
```
...
**202** | The HTTP 202 status response code indicates that the request has succeeded. The &#39;deviceconnector.Policy&#39; resource is asynchronously being modified as requested.  |  * Set-Cookie -  <br>  * x-starship-traceid -  <br>  |
**400** | The request could not be understood by the server due to malformed syntax. The client SHOULD NOT repeat the request without modifications. For example, the request may contain an incorrect JSON syntax, or the request fails validation checks. The HTTP body may contain a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
**401** | The request requires user authentication. The client may repeat the request with a suitable Authorization header field. If the request already included Authorization credentials, then the 401 response indicates that authorization has been refused for those credentials. The HTTP body may contain a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
**403** | The request was properly authenticated, but the server is refusing to fulfill it. The HTTP body may contain a document that provides more details about the error. For example, the user may not have sufficient privileges to perform the request.  |  * x-starship-traceid -  <br>  |
**404** | The specified resource was not found. The HTTP body contains a document that provides more details about the error.  |  * x-starship-traceid -  <br>  |
