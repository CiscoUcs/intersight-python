...
**results** | [**list[InventoryGenericInventoryHolder]**](InventoryGenericInventoryHolder.md) | The array of &#39;inventory.GenericInventoryHolder&#39; resources matching the request. | [optional] 
