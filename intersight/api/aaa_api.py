...
class AaaApi(object):
    ...
    def get_aaa_audit_record_by_moid(self, moid, **kwargs):  # noqa: E501
        ...
        return self.get_aaa_audit_record_by_moid_with_http_info(
            moid, **kwargs)  # noqa: E501

    def get_aaa_audit_record_by_moid_with_http_info(self, moid,
                                                    **kwargs):  # noqa: E501
        """Read a 'aaa.AuditRecord' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_aaa_audit_record_by_moid_with_http_info(moid, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(AaaAuditRecord, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'"
                                   " to method get_aaa_audit_record_by_moid" %
                                   key)
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ApiValueError(
                "Missing the required parameter `moid` when calling `get_aaa_audit_record_by_moid`"
            )  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='AaaAuditRecord',  # noqa: E501
    ...
    def get_aaa_audit_record_list(self, **kwargs):  # noqa: E501
        """Read a 'aaa.AuditRecord' resource.  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_aaa_audit_record_list_with_http_info(
            **kwargs)  # noqa: E501

    def get_aaa_audit_record_list_with_http_info(self, **kwargs):  # noqa: E501
        """Read a 'aaa.AuditRecord' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_aaa_audit_record_list_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(AaaAuditRecordList, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'"
                                   " to method get_aaa_audit_record_list" %
                                   key)
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='AaaAuditRecordList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get(
                '_return_http_data_only'),  # noqa: E501
