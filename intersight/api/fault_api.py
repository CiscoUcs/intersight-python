...
class FaultApi(object):
    ...
    def get_fault_instance_by_moid(self, moid, **kwargs):  # noqa: E501
        ...
        return self.get_fault_instance_by_moid_with_http_info(
            moid, **kwargs)  # noqa: E501

    def get_fault_instance_by_moid_with_http_info(self, moid,
                                                  **kwargs):  # noqa: E501
        """Read a 'fault.Instance' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_fault_instance_by_moid_with_http_info(moid, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(FaultInstance, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'"
                                   " to method get_fault_instance_by_moid" %
                                   key)
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ApiValueError(
                "Missing the required parameter `moid` when calling `get_fault_instance_by_moid`"
            )  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='FaultInstance',  # noqa: E501
    ...
    def get_fault_instance_list(self, **kwargs):  # noqa: E501
        """Read a 'fault.Instance' resource.  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_fault_instance_list_with_http_info(
            **kwargs)  # noqa: E501

    def get_fault_instance_list_with_http_info(self, **kwargs):  # noqa: E501
        """Read a 'fault.Instance' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_fault_instance_list_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(FaultInstanceList, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'"
                                   " to method get_fault_instance_list" % key)
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='FaultInstanceList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get(
                '_return_http_data_only'),  # noqa: E501
    ...
    def patch_fault_instance(self, moid, fault_instance,
                             **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str moid: The unique Moid identifier of a resource instance. (required)
        :param FaultInstance fault_instance: The 'fault.Instance' resource to update. (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.patch_fault_instance_with_http_info(
            moid, fault_instance, **kwargs)  # noqa: E501

    def patch_fault_instance_with_http_info(self, moid, fault_instance,
                                            **kwargs):  # noqa: E501
        """Update a 'fault.Instance' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_fault_instance_with_http_info(moid, fault_instance, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['moid', 'fault_instance']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'"
                                   " to method patch_fault_instance" % key)
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'moid' is set
        if self.api_client.client_side_validation and (
                ...
                local_var_params['moid'] is None):  # noqa: E501
            raise ApiValueError(
                "Missing the required parameter `moid` when calling `patch_fault_instance`"
            )  # noqa: E501
        # verify the required parameter 'fault_instance' is set
        if self.api_client.client_side_validation and (
                'fault_instance' not in local_var_params or  # noqa: E501
                local_var_params['fault_instance'] is None):  # noqa: E501
            raise ApiValueError(
                "Missing the required parameter `fault_instance` when calling `patch_fault_instance`"
            )  # noqa: E501
        ...
        body_params = None
        if 'fault_instance' in local_var_params:
            body_params = local_var_params['fault_instance']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
    ...
    def update_fault_instance(self, moid, fault_instance,
                              **kwargs):  # noqa: E501
        """Update a 'fault.Instance' resource.  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_fault_instance_with_http_info(
            moid, fault_instance, **kwargs)  # noqa: E501

    def update_fault_instance_with_http_info(self, moid, fault_instance,
                                             **kwargs):  # noqa: E501
        """Update a 'fault.Instance' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_fault_instance_with_http_info(moid, fault_instance, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'"
                                   " to method update_fault_instance" % key)
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'moid' is set
        if self.api_client.client_side_validation and (
                ...
                local_var_params['moid'] is None):  # noqa: E501
            raise ApiValueError(
                "Missing the required parameter `moid` when calling `update_fault_instance`"
            )  # noqa: E501
        # verify the required parameter 'fault_instance' is set
        if self.api_client.client_side_validation and (
                'fault_instance' not in local_var_params or  # noqa: E501
                local_var_params['fault_instance'] is None):  # noqa: E501
            raise ApiValueError(
                "Missing the required parameter `fault_instance` when calling `update_fault_instance`"
            )  # noqa: E501
