...
class NtpApi(object):
    ...
    def create_ntp_policy(self, ntp_policy, **kwargs):  # noqa: E501
        ...
        :param NtpPolicy ntp_policy: The 'ntp.Policy' resource to create. (required)
        ...
        return self.create_ntp_policy_with_http_info(ntp_policy,
                                                     **kwargs)  # noqa: E501

    def create_ntp_policy_with_http_info(self, ntp_policy,
                                         **kwargs):  # noqa: E501
        """Create a 'ntp.Policy' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_ntp_policy_with_http_info(ntp_policy, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(NtpPolicy, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        all_params = ['ntp_policy']  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'"
                                   " to method create_ntp_policy" % key)
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'ntp_policy' is set
        if self.api_client.client_side_validation and (
                'ntp_policy' not in local_var_params or  # noqa: E501
                local_var_params['ntp_policy'] is None):  # noqa: E501
            raise ApiValueError(
                "Missing the required parameter `ntp_policy` when calling `create_ntp_policy`"
            )  # noqa: E501
        ...
        body_params = None
        if 'ntp_policy' in local_var_params:
            body_params = local_var_params['ntp_policy']
        # HTTP header `Accept`
        ...
        return self.api_client.call_api(
            ...
            response_type='NtpPolicy',  # noqa: E501
    ...
    def delete_ntp_policy(self, moid, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.delete_ntp_policy_with_http_info(moid,
                                                     **kwargs)  # noqa: E501

    def delete_ntp_policy_with_http_info(self, moid, **kwargs):  # noqa: E501
        """Delete a 'ntp.Policy' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_ntp_policy_with_http_info(moid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'"
                                   " to method delete_ntp_policy" % key)
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ApiValueError(
                "Missing the required parameter `moid` when calling `delete_ntp_policy`"
            )  # noqa: E501
    ...
    def get_ntp_policy_by_moid(self, moid, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_ntp_policy_by_moid_with_http_info(
            moid, **kwargs)  # noqa: E501

    def get_ntp_policy_by_moid_with_http_info(self, moid,
                                              **kwargs):  # noqa: E501
        """Read a 'ntp.Policy' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_ntp_policy_by_moid_with_http_info(moid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'"
                                   " to method get_ntp_policy_by_moid" % key)
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'moid' is set
        if self.api_client.client_side_validation and (
                ...
                local_var_params['moid'] is None):  # noqa: E501
            raise ApiValueError(
                "Missing the required parameter `moid` when calling `get_ntp_policy_by_moid`"
            )  # noqa: E501
    ...
    def get_ntp_policy_list(self, **kwargs):  # noqa: E501
        """Read a 'ntp.Policy' resource.  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_ntp_policy_list_with_http_info(**kwargs)  # noqa: E501

    def get_ntp_policy_list_with_http_info(self, **kwargs):  # noqa: E501
        """Read a 'ntp.Policy' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_ntp_policy_list_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(NtpPolicyList, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'"
                                   " to method get_ntp_policy_list" % key)
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='NtpPolicyList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get(
                '_return_http_data_only'),  # noqa: E501
    ...
    def patch_ntp_policy(self, moid, ntp_policy, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str moid: The unique Moid identifier of a resource instance. (required)
        :param NtpPolicy ntp_policy: The 'ntp.Policy' resource to update. (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.patch_ntp_policy_with_http_info(moid, ntp_policy,
                                                    **kwargs)  # noqa: E501

    def patch_ntp_policy_with_http_info(self, moid, ntp_policy,
                                        **kwargs):  # noqa: E501
        """Update a 'ntp.Policy' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_ntp_policy_with_http_info(moid, ntp_policy, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['moid', 'ntp_policy']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'"
                                   " to method patch_ntp_policy" % key)
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'moid' is set
        if self.api_client.client_side_validation and (
                ...
                local_var_params['moid'] is None):  # noqa: E501
            raise ApiValueError(
                "Missing the required parameter `moid` when calling `patch_ntp_policy`"
            )  # noqa: E501
        # verify the required parameter 'ntp_policy' is set
        if self.api_client.client_side_validation and (
                'ntp_policy' not in local_var_params or  # noqa: E501
                local_var_params['ntp_policy'] is None):  # noqa: E501
            raise ApiValueError(
                "Missing the required parameter `ntp_policy` when calling `patch_ntp_policy`"
            )  # noqa: E501
    ...
    def update_ntp_policy(self, moid, ntp_policy, **kwargs):  # noqa: E501
        """Update a 'ntp.Policy' resource.  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_ntp_policy_with_http_info(moid, ntp_policy,
                                                     **kwargs)  # noqa: E501

    def update_ntp_policy_with_http_info(self, moid, ntp_policy,
                                         **kwargs):  # noqa: E501
        """Update a 'ntp.Policy' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_ntp_policy_with_http_info(moid, ntp_policy, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'"
                                   " to method update_ntp_policy" % key)
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'moid' is set
        if self.api_client.client_side_validation and (
                ...
                local_var_params['moid'] is None):  # noqa: E501
            raise ApiValueError(
                "Missing the required parameter `moid` when calling `update_ntp_policy`"
            )  # noqa: E501
        # verify the required parameter 'ntp_policy' is set
        if self.api_client.client_side_validation and (
                'ntp_policy' not in local_var_params or  # noqa: E501
                local_var_params['ntp_policy'] is None):  # noqa: E501
            raise ApiValueError(
                "Missing the required parameter `ntp_policy` when calling `update_ntp_policy`"
            )  # noqa: E501
