...
class TelemetryApi(object):
    ...
    def create_telemetry_time_series(self, telemetry_time_series,
                                     **kwargs):  # noqa: E501
        """Create a 'telemetry.TimeSeries' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_telemetry_time_series(telemetry_time_series, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param TelemetryTimeSeries telemetry_time_series: The 'telemetry.TimeSeries' resource to create. (required)
        ...
        return self.create_telemetry_time_series_with_http_info(
            telemetry_time_series, **kwargs)  # noqa: E501

    def create_telemetry_time_series_with_http_info(self,
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_telemetry_time_series_with_http_info(telemetry_time_series, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(TelemetryTimeSeries, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        all_params = ['telemetry_time_series']  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'"
                                   " to method create_telemetry_time_series" %
                                   key)
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'telemetry_time_series' is set
        if self.api_client.client_side_validation and (
                'telemetry_time_series' not in local_var_params
                or  # noqa: E501
                local_var_params['telemetry_time_series'] is None
        ):  # noqa: E501
            raise ApiValueError(
                "Missing the required parameter `telemetry_time_series` when calling `create_telemetry_time_series`"
            )  # noqa: E501
        ...
        body_params = None
        if 'telemetry_time_series' in local_var_params:
            body_params = local_var_params['telemetry_time_series']
        # HTTP header `Accept`
        ...
        return self.api_client.call_api(
            ...
            response_type='TelemetryTimeSeries',  # noqa: E501
    ...
    def get_telemetry_time_series_by_moid(self, moid, **kwargs):  # noqa: E501
        """Read a 'telemetry.TimeSeries' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_telemetry_time_series_by_moid(moid, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_telemetry_time_series_by_moid_with_http_info(
            moid, **kwargs)  # noqa: E501

    def get_telemetry_time_series_by_moid_with_http_info(
            self, moid, **kwargs):  # noqa: E501
        """Read a 'telemetry.TimeSeries' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_telemetry_time_series_by_moid_with_http_info(moid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method get_telemetry_time_series_by_moid" % key)
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ApiValueError(
                "Missing the required parameter `moid` when calling `get_telemetry_time_series_by_moid`"
            )  # noqa: E501
    ...
    def get_telemetry_time_series_list(self, **kwargs):  # noqa: E501
        """Read a 'telemetry.TimeSeries' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_telemetry_time_series_list(async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: TelemetryTimeSeriesList
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        return self.get_telemetry_time_series_list_with_http_info(
            **kwargs)  # noqa: E501

    def get_telemetry_time_series_list_with_http_info(self,
                                                      **kwargs):  # noqa: E501
        """Read a 'telemetry.TimeSeries' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_telemetry_time_series_list_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(TelemetryTimeSeriesList, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_telemetry_time_series_list" % key)
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='TelemetryTimeSeriesList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get(
                '_return_http_data_only'),  # noqa: E501
