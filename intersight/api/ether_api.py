...
class EtherApi(object):
    ...
    def get_ether_physical_port_by_moid(self, moid, **kwargs):  # noqa: E501
        ...
        return self.get_ether_physical_port_by_moid_with_http_info(
            moid, **kwargs)  # noqa: E501

    def get_ether_physical_port_by_moid_with_http_info(self, moid,
                                                       **kwargs):  # noqa: E501
        """Read a 'ether.PhysicalPort' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_ether_physical_port_by_moid_with_http_info(moid, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(EtherPhysicalPort, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method get_ether_physical_port_by_moid" % key)
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ApiValueError(
                "Missing the required parameter `moid` when calling `get_ether_physical_port_by_moid`"
            )  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='EtherPhysicalPort',  # noqa: E501
    ...
    def get_ether_physical_port_list(self, **kwargs):  # noqa: E501
        """Read a 'ether.PhysicalPort' resource.  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_ether_physical_port_list_with_http_info(
            **kwargs)  # noqa: E501

    def get_ether_physical_port_list_with_http_info(self,
                                                    **kwargs):  # noqa: E501
        """Read a 'ether.PhysicalPort' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_ether_physical_port_list_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(EtherPhysicalPortList, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'"
                                   " to method get_ether_physical_port_list" %
                                   key)
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='EtherPhysicalPortList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get(
                '_return_http_data_only'),  # noqa: E501
    ...
    def patch_ether_physical_port(self, moid, ether_physical_port,
                                  **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str moid: The unique Moid identifier of a resource instance. (required)
        :param EtherPhysicalPort ether_physical_port: The 'ether.PhysicalPort' resource to update. (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.patch_ether_physical_port_with_http_info(
            moid, ether_physical_port, **kwargs)  # noqa: E501

    def patch_ether_physical_port_with_http_info(self, moid,
                                                 ether_physical_port,
                                                 **kwargs):  # noqa: E501
        """Update a 'ether.PhysicalPort' resource.  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_ether_physical_port_with_http_info(moid, ether_physical_port, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['moid', 'ether_physical_port']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'"
                                   " to method patch_ether_physical_port" %
                                   key)
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'moid' is set
        if self.api_client.client_side_validation and (
                ...
                local_var_params['moid'] is None):  # noqa: E501
            raise ApiValueError(
                "Missing the required parameter `moid` when calling `patch_ether_physical_port`"
            )  # noqa: E501
        # verify the required parameter 'ether_physical_port' is set
        if self.api_client.client_side_validation and (
                'ether_physical_port' not in local_var_params or  # noqa: E501
                local_var_params['ether_physical_port'] is None):  # noqa: E501
            raise ApiValueError(
                "Missing the required parameter `ether_physical_port` when calling `patch_ether_physical_port`"
            )  # noqa: E501
        ...
        body_params = None
        if 'ether_physical_port' in local_var_params:
            body_params = local_var_params['ether_physical_port']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
    ...
    def update_ether_physical_port(self, moid, ether_physical_port,
                                   **kwargs):  # noqa: E501
        """Update a 'ether.PhysicalPort' resource.  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_ether_physical_port_with_http_info(
            moid, ether_physical_port, **kwargs)  # noqa: E501

    def update_ether_physical_port_with_http_info(self, moid,
                                                  ether_physical_port,
                                                  **kwargs):  # noqa: E501
        """Update a 'ether.PhysicalPort' resource.  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_ether_physical_port_with_http_info(moid, ether_physical_port, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'"
                                   " to method update_ether_physical_port" %
                                   key)
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'moid' is set
        if self.api_client.client_side_validation and (
                ...
                local_var_params['moid'] is None):  # noqa: E501
            raise ApiValueError(
                "Missing the required parameter `moid` when calling `update_ether_physical_port`"
            )  # noqa: E501
        # verify the required parameter 'ether_physical_port' is set
        if self.api_client.client_side_validation and (
                'ether_physical_port' not in local_var_params or  # noqa: E501
                local_var_params['ether_physical_port'] is None):  # noqa: E501
            raise ApiValueError(
                "Missing the required parameter `ether_physical_port` when calling `update_ether_physical_port`"
            )  # noqa: E501
