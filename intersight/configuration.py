...
class Configuration(object):
    ...
    def auth_settings(self):
        ...
        """
        auth = {}
        if 'X-Starship-Token' in self.api_key:
            auth['cookieAuth'] = {
                'type': 'api_key',
                'in': 'cookie',
                'key': 'X-Starship-Token',
                'value': self.get_api_key_with_prefix('X-Starship-Token')
            }
    ...
    def to_debug_report(self):
        ...
        return "Python SDK Debug Report:\n"\
               ...
               "Version of the API: 1.0.9-1295\n"\
               "SDK Package Version: 1.0.9-1295".\
    ...
    def get_host_settings(self):
        ...
        return [{
            ...
            'description':
            "The Intersight URL for the cloud-based infrastructure management APIs.",
            'variables': {
                'server': {
