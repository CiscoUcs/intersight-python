...
class HclNoteApi(object):
    ...
    def hcl_notes_get(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.hcl_notes_get(callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.hcl_notes_get_with_http_info(**kwargs)
        else:
            (data) = self.hcl_notes_get_with_http_info(**kwargs)
            return data

    def hcl_notes_get_with_http_info(self, **kwargs):
        """
        List of hclNotes
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.hcl_notes_get_with_http_info(callback=callback_function)
        ...
        return self.api_client.call_api('/hcl/Notes', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def hcl_notes_moid_get(self, moid, **kwargs):
        """
        A instance of hclNote
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        >>> def callback_function(response):
        >>>     pprint(response)
        >>>
        >>> thread = api.hcl_notes_moid_get(moid, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str moid: The moid of the hclNote instance. (required)
        :return: HclNote
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.hcl_notes_moid_get_with_http_info(moid, **kwargs)
        else:
            (data) = self.hcl_notes_moid_get_with_http_info(moid, **kwargs)
            return data

    def hcl_notes_moid_get_with_http_info(self, moid, **kwargs):
        """
        A instance of hclNote
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.hcl_notes_moid_get_with_http_info(moid, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method hcl_notes_moid_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'moid' is set
        if ('moid' not in params) or (params['moid'] is None):
            raise ValueError("Missing the required parameter `moid` when calling `hcl_notes_moid_get`")
        ...
        return self.api_client.call_api('/hcl/Notes/{moid}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
