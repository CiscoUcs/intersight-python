...
class FirmwareEulaApi(object):
    ...
    def firmware_eulas_moid_get(self, moid, **kwargs):
        """
        A instance of firmwareEula
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        >>> def callback_function(response):
        >>>     pprint(response)
        >>>
        >>> thread = api.firmware_eulas_moid_get(moid, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.firmware_eulas_moid_get_with_http_info(moid, **kwargs)
        else:
            (data) = self.firmware_eulas_moid_get_with_http_info(moid, **kwargs)
            return data

    def firmware_eulas_moid_get_with_http_info(self, moid, **kwargs):
        """
        A instance of firmwareEula
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.firmware_eulas_moid_get_with_http_info(moid, callback=callback_function)
    ...
    def firmware_eulas_post(self, body, **kwargs):
        """
        Create a firmwareEula
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        >>> def callback_function(response):
        >>>     pprint(response)
        >>>
        >>> thread = api.firmware_eulas_post(body, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.firmware_eulas_post_with_http_info(body, **kwargs)
        else:
            (data) = self.firmware_eulas_post_with_http_info(body, **kwargs)
            return data

    def firmware_eulas_post_with_http_info(self, body, **kwargs):
        """
        Create a firmwareEula
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.firmware_eulas_post_with_http_info(body, callback=callback_function)
