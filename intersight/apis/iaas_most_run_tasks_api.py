...
class IaasMostRunTasksApi(object):
    ...
    def iaas_most_run_tasks_moid_get(self, moid, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.iaas_most_run_tasks_moid_get(moid, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.iaas_most_run_tasks_moid_get_with_http_info(moid, **kwargs)
        else:
            (data) = self.iaas_most_run_tasks_moid_get_with_http_info(moid, **kwargs)
            return data

    def iaas_most_run_tasks_moid_get_with_http_info(self, moid, **kwargs):
        """
        Get a specific instance of 'iaasMostRunTasks'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.iaas_most_run_tasks_moid_get_with_http_info(moid, callback=callback_function)
