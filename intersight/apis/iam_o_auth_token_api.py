...
class IamOAuthTokenApi(object):
    ...
    def iam_o_auth_tokens_get(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.iam_o_auth_tokens_get(callback=callback_function)
        ...
        :return: IamOAuthTokenList
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.iam_o_auth_tokens_get_with_http_info(**kwargs)
        else:
            (data) = self.iam_o_auth_tokens_get_with_http_info(**kwargs)
            return data

    def iam_o_auth_tokens_get_with_http_info(self, **kwargs):
        """
        Read a 'iam.OAuthToken' resource.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.iam_o_auth_tokens_get_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method iam_o_auth_tokens_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/iam/OAuthTokens', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        ...
                                        response_type='IamOAuthTokenList',
    ...
    def iam_o_auth_tokens_moid_delete(self, moid, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.iam_o_auth_tokens_moid_delete(moid, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str moid: The Moid of the iamOAuthToken instance. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.iam_o_auth_tokens_moid_delete_with_http_info(moid, **kwargs)
        else:
            (data) = self.iam_o_auth_tokens_moid_delete_with_http_info(moid, **kwargs)
            return data

    def iam_o_auth_tokens_moid_delete_with_http_info(self, moid, **kwargs):
        """
        Delete a 'iam.OAuthToken' resource.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.iam_o_auth_tokens_moid_delete_with_http_info(moid, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method iam_o_auth_tokens_moid_delete" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'moid' is set
        if ('moid' not in params) or (params['moid'] is None):
            raise ValueError("Missing the required parameter `moid` when calling `iam_o_auth_tokens_moid_delete`")
        ...
        return self.api_client.call_api('/iam/OAuthTokens/{Moid}', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def iam_o_auth_tokens_moid_get(self, moid, **kwargs):
        """
        Read a 'iam.OAuthToken' resource.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.iam_o_auth_tokens_moid_get(moid, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.iam_o_auth_tokens_moid_get_with_http_info(moid, **kwargs)
        else:
            (data) = self.iam_o_auth_tokens_moid_get_with_http_info(moid, **kwargs)
            return data

    def iam_o_auth_tokens_moid_get_with_http_info(self, moid, **kwargs):
        """
        Read a 'iam.OAuthToken' resource.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.iam_o_auth_tokens_moid_get_with_http_info(moid, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method iam_o_auth_tokens_moid_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'moid' is set
        if ('moid' not in params) or (params['moid'] is None):
            raise ValueError("Missing the required parameter `moid` when calling `iam_o_auth_tokens_moid_get`")
        ...
        return self.api_client.call_api('/iam/OAuthTokens/{Moid}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
