...
class EquipmentRackEnclosureSlotApi(object):
    """
    ...
    def equipment_rack_enclosure_slots_get(self, **kwargs):
        """
        Get a list of 'equipmentRackEnclosureSlot' instances
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.equipment_rack_enclosure_slots_get(callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.equipment_rack_enclosure_slots_get_with_http_info(**kwargs)
        else:
            (data) = self.equipment_rack_enclosure_slots_get_with_http_info(**kwargs)
            return data

    def equipment_rack_enclosure_slots_get_with_http_info(self, **kwargs):
        """
        Get a list of 'equipmentRackEnclosureSlot' instances
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.equipment_rack_enclosure_slots_get_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method equipment_rack_enclosure_slots_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/equipment/RackEnclosureSlots', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        ...
                                        response_type='EquipmentRackEnclosureSlotList',
    ...
    def equipment_rack_enclosure_slots_moid_get(self, moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9, moid10, moid11, moid12, moid13, moid14, moid15, **kwargs):
        """
        Get a specific instance of 'equipmentRackEnclosureSlot'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        >>> def callback_function(response):
        >>>     pprint(response)
        >>>
        >>> thread = api.equipment_rack_enclosure_slots_moid_get(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9, moid10, moid11, moid12, moid13, moid14, moid15, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str moid: The moid of the equipmentRackEnclosureSlot instance. (required)
        :param str moid2: The moid of the equipmentRackEnclosureSlot instance. (required)
        :param str moid3: The moid of the equipmentRackEnclosureSlot instance. (required)
        :param str moid4: The moid of the equipmentRackEnclosureSlot instance. (required)
        :param str moid5: The moid of the equipmentRackEnclosureSlot instance. (required)
        :param str moid6: The moid of the equipmentRackEnclosureSlot instance. (required)
        :param str moid7: The moid of the equipmentRackEnclosureSlot instance. (required)
        :param str moid8: The moid of the equipmentRackEnclosureSlot instance. (required)
        :param str moid9: The moid of the equipmentRackEnclosureSlot instance. (required)
        :param str moid10: The moid of the equipmentRackEnclosureSlot instance. (required)
        :param str moid11: The moid of the equipmentRackEnclosureSlot instance. (required)
        :param str moid12: The moid of the equipmentRackEnclosureSlot instance. (required)
        :param str moid13: The moid of the equipmentRackEnclosureSlot instance. (required)
        :param str moid14: The moid of the equipmentRackEnclosureSlot instance. (required)
        :param str moid15: The moid of the equipmentRackEnclosureSlot instance. (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.equipment_rack_enclosure_slots_moid_get_with_http_info(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9, moid10, moid11, moid12, moid13, moid14, moid15, **kwargs)
        else:
            (data) = self.equipment_rack_enclosure_slots_moid_get_with_http_info(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9, moid10, moid11, moid12, moid13, moid14, moid15, **kwargs)
            return data

    def equipment_rack_enclosure_slots_moid_get_with_http_info(self, moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9, moid10, moid11, moid12, moid13, moid14, moid15, **kwargs):
        """
        Get a specific instance of 'equipmentRackEnclosureSlot'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.equipment_rack_enclosure_slots_moid_get_with_http_info(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9, moid10, moid11, moid12, moid13, moid14, moid15, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method equipment_rack_enclosure_slots_moid_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'moid' is set
        if ('moid' not in params) or (params['moid'] is None):
            raise ValueError("Missing the required parameter `moid` when calling `equipment_rack_enclosure_slots_moid_get`")
        # verify the required parameter 'moid2' is set
        if ('moid2' not in params) or (params['moid2'] is None):
            raise ValueError("Missing the required parameter `moid2` when calling `equipment_rack_enclosure_slots_moid_get`")
        # verify the required parameter 'moid3' is set
        if ('moid3' not in params) or (params['moid3'] is None):
            raise ValueError("Missing the required parameter `moid3` when calling `equipment_rack_enclosure_slots_moid_get`")
        # verify the required parameter 'moid4' is set
        if ('moid4' not in params) or (params['moid4'] is None):
            raise ValueError("Missing the required parameter `moid4` when calling `equipment_rack_enclosure_slots_moid_get`")
        # verify the required parameter 'moid5' is set
        if ('moid5' not in params) or (params['moid5'] is None):
            raise ValueError("Missing the required parameter `moid5` when calling `equipment_rack_enclosure_slots_moid_get`")
        # verify the required parameter 'moid6' is set
        if ('moid6' not in params) or (params['moid6'] is None):
            raise ValueError("Missing the required parameter `moid6` when calling `equipment_rack_enclosure_slots_moid_get`")
        # verify the required parameter 'moid7' is set
        if ('moid7' not in params) or (params['moid7'] is None):
            raise ValueError("Missing the required parameter `moid7` when calling `equipment_rack_enclosure_slots_moid_get`")
        # verify the required parameter 'moid8' is set
        if ('moid8' not in params) or (params['moid8'] is None):
            raise ValueError("Missing the required parameter `moid8` when calling `equipment_rack_enclosure_slots_moid_get`")
        # verify the required parameter 'moid9' is set
        if ('moid9' not in params) or (params['moid9'] is None):
            raise ValueError("Missing the required parameter `moid9` when calling `equipment_rack_enclosure_slots_moid_get`")
        # verify the required parameter 'moid10' is set
        if ('moid10' not in params) or (params['moid10'] is None):
            raise ValueError("Missing the required parameter `moid10` when calling `equipment_rack_enclosure_slots_moid_get`")
        # verify the required parameter 'moid11' is set
        if ('moid11' not in params) or (params['moid11'] is None):
            raise ValueError("Missing the required parameter `moid11` when calling `equipment_rack_enclosure_slots_moid_get`")
        # verify the required parameter 'moid12' is set
        if ('moid12' not in params) or (params['moid12'] is None):
            raise ValueError("Missing the required parameter `moid12` when calling `equipment_rack_enclosure_slots_moid_get`")
        # verify the required parameter 'moid13' is set
        if ('moid13' not in params) or (params['moid13'] is None):
            raise ValueError("Missing the required parameter `moid13` when calling `equipment_rack_enclosure_slots_moid_get`")
        # verify the required parameter 'moid14' is set
        if ('moid14' not in params) or (params['moid14'] is None):
            raise ValueError("Missing the required parameter `moid14` when calling `equipment_rack_enclosure_slots_moid_get`")
        # verify the required parameter 'moid15' is set
        if ('moid15' not in params) or (params['moid15'] is None):
            raise ValueError("Missing the required parameter `moid15` when calling `equipment_rack_enclosure_slots_moid_get`")
        ...
        return self.api_client.call_api('/equipment/RackEnclosureSlots/{moid}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def equipment_rack_enclosure_slots_moid_patch(self, moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9, moid10, body10, moid11, body11, moid12, body12, moid13, body13, moid14, body14, moid15, body15, **kwargs):
        """
        Update an instance of 'equipmentRackEnclosureSlot'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        >>> def callback_function(response):
        >>>     pprint(response)
        >>>
        >>> thread = api.equipment_rack_enclosure_slots_moid_patch(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9, moid10, body10, moid11, body11, moid12, body12, moid13, body13, moid14, body14, moid15, body15, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str moid: The moid of the equipmentRackEnclosureSlot instance. (required)
        :param EquipmentRackEnclosureSlot body: equipmentRackEnclosureSlot to update (required)
        :param str moid2: The moid of the equipmentRackEnclosureSlot instance. (required)
        :param EquipmentRackEnclosureSlot body2: equipmentRackEnclosureSlot to update (required)
        :param str moid3: The moid of the equipmentRackEnclosureSlot instance. (required)
        :param EquipmentRackEnclosureSlot body3: equipmentRackEnclosureSlot to update (required)
        :param str moid4: The moid of the equipmentRackEnclosureSlot instance. (required)
        :param EquipmentRackEnclosureSlot body4: equipmentRackEnclosureSlot to update (required)
        :param str moid5: The moid of the equipmentRackEnclosureSlot instance. (required)
        :param EquipmentRackEnclosureSlot body5: equipmentRackEnclosureSlot to update (required)
        :param str moid6: The moid of the equipmentRackEnclosureSlot instance. (required)
        :param EquipmentRackEnclosureSlot body6: equipmentRackEnclosureSlot to update (required)
        :param str moid7: The moid of the equipmentRackEnclosureSlot instance. (required)
        :param EquipmentRackEnclosureSlot body7: equipmentRackEnclosureSlot to update (required)
        :param str moid8: The moid of the equipmentRackEnclosureSlot instance. (required)
        :param EquipmentRackEnclosureSlot body8: equipmentRackEnclosureSlot to update (required)
        :param str moid9: The moid of the equipmentRackEnclosureSlot instance. (required)
        :param EquipmentRackEnclosureSlot body9: equipmentRackEnclosureSlot to update (required)
        :param str moid10: The moid of the equipmentRackEnclosureSlot instance. (required)
        :param EquipmentRackEnclosureSlot body10: equipmentRackEnclosureSlot to update (required)
        :param str moid11: The moid of the equipmentRackEnclosureSlot instance. (required)
        :param EquipmentRackEnclosureSlot body11: equipmentRackEnclosureSlot to update (required)
        :param str moid12: The moid of the equipmentRackEnclosureSlot instance. (required)
        :param EquipmentRackEnclosureSlot body12: equipmentRackEnclosureSlot to update (required)
        :param str moid13: The moid of the equipmentRackEnclosureSlot instance. (required)
        :param EquipmentRackEnclosureSlot body13: equipmentRackEnclosureSlot to update (required)
        :param str moid14: The moid of the equipmentRackEnclosureSlot instance. (required)
        :param EquipmentRackEnclosureSlot body14: equipmentRackEnclosureSlot to update (required)
        :param str moid15: The moid of the equipmentRackEnclosureSlot instance. (required)
        :param EquipmentRackEnclosureSlot body15: equipmentRackEnclosureSlot to update (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.equipment_rack_enclosure_slots_moid_patch_with_http_info(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9, moid10, body10, moid11, body11, moid12, body12, moid13, body13, moid14, body14, moid15, body15, **kwargs)
        else:
            (data) = self.equipment_rack_enclosure_slots_moid_patch_with_http_info(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9, moid10, body10, moid11, body11, moid12, body12, moid13, body13, moid14, body14, moid15, body15, **kwargs)
            return data

    def equipment_rack_enclosure_slots_moid_patch_with_http_info(self, moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9, moid10, body10, moid11, body11, moid12, body12, moid13, body13, moid14, body14, moid15, body15, **kwargs):
        """
        Update an instance of 'equipmentRackEnclosureSlot'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.equipment_rack_enclosure_slots_moid_patch_with_http_info(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9, moid10, body10, moid11, body11, moid12, body12, moid13, body13, moid14, body14, moid15, body15, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method equipment_rack_enclosure_slots_moid_patch" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'moid' is set
        if ('moid' not in params) or (params['moid'] is None):
            raise ValueError("Missing the required parameter `moid` when calling `equipment_rack_enclosure_slots_moid_patch`")
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `equipment_rack_enclosure_slots_moid_patch`")
        # verify the required parameter 'moid2' is set
        if ('moid2' not in params) or (params['moid2'] is None):
            raise ValueError("Missing the required parameter `moid2` when calling `equipment_rack_enclosure_slots_moid_patch`")
        # verify the required parameter 'body2' is set
        if ('body2' not in params) or (params['body2'] is None):
            raise ValueError("Missing the required parameter `body2` when calling `equipment_rack_enclosure_slots_moid_patch`")
        # verify the required parameter 'moid3' is set
        if ('moid3' not in params) or (params['moid3'] is None):
            raise ValueError("Missing the required parameter `moid3` when calling `equipment_rack_enclosure_slots_moid_patch`")
        # verify the required parameter 'body3' is set
        if ('body3' not in params) or (params['body3'] is None):
            raise ValueError("Missing the required parameter `body3` when calling `equipment_rack_enclosure_slots_moid_patch`")
        # verify the required parameter 'moid4' is set
        if ('moid4' not in params) or (params['moid4'] is None):
            raise ValueError("Missing the required parameter `moid4` when calling `equipment_rack_enclosure_slots_moid_patch`")
        # verify the required parameter 'body4' is set
        if ('body4' not in params) or (params['body4'] is None):
            raise ValueError("Missing the required parameter `body4` when calling `equipment_rack_enclosure_slots_moid_patch`")
        # verify the required parameter 'moid5' is set
        if ('moid5' not in params) or (params['moid5'] is None):
            raise ValueError("Missing the required parameter `moid5` when calling `equipment_rack_enclosure_slots_moid_patch`")
        # verify the required parameter 'body5' is set
        if ('body5' not in params) or (params['body5'] is None):
            raise ValueError("Missing the required parameter `body5` when calling `equipment_rack_enclosure_slots_moid_patch`")
        # verify the required parameter 'moid6' is set
        if ('moid6' not in params) or (params['moid6'] is None):
            raise ValueError("Missing the required parameter `moid6` when calling `equipment_rack_enclosure_slots_moid_patch`")
        # verify the required parameter 'body6' is set
        if ('body6' not in params) or (params['body6'] is None):
            raise ValueError("Missing the required parameter `body6` when calling `equipment_rack_enclosure_slots_moid_patch`")
        # verify the required parameter 'moid7' is set
        if ('moid7' not in params) or (params['moid7'] is None):
            raise ValueError("Missing the required parameter `moid7` when calling `equipment_rack_enclosure_slots_moid_patch`")
        # verify the required parameter 'body7' is set
        if ('body7' not in params) or (params['body7'] is None):
            raise ValueError("Missing the required parameter `body7` when calling `equipment_rack_enclosure_slots_moid_patch`")
        # verify the required parameter 'moid8' is set
        if ('moid8' not in params) or (params['moid8'] is None):
            raise ValueError("Missing the required parameter `moid8` when calling `equipment_rack_enclosure_slots_moid_patch`")
        # verify the required parameter 'body8' is set
        if ('body8' not in params) or (params['body8'] is None):
            raise ValueError("Missing the required parameter `body8` when calling `equipment_rack_enclosure_slots_moid_patch`")
        # verify the required parameter 'moid9' is set
        if ('moid9' not in params) or (params['moid9'] is None):
            raise ValueError("Missing the required parameter `moid9` when calling `equipment_rack_enclosure_slots_moid_patch`")
        # verify the required parameter 'body9' is set
        if ('body9' not in params) or (params['body9'] is None):
            raise ValueError("Missing the required parameter `body9` when calling `equipment_rack_enclosure_slots_moid_patch`")
        # verify the required parameter 'moid10' is set
        if ('moid10' not in params) or (params['moid10'] is None):
            raise ValueError("Missing the required parameter `moid10` when calling `equipment_rack_enclosure_slots_moid_patch`")
        # verify the required parameter 'body10' is set
        if ('body10' not in params) or (params['body10'] is None):
            raise ValueError("Missing the required parameter `body10` when calling `equipment_rack_enclosure_slots_moid_patch`")
        # verify the required parameter 'moid11' is set
        if ('moid11' not in params) or (params['moid11'] is None):
            raise ValueError("Missing the required parameter `moid11` when calling `equipment_rack_enclosure_slots_moid_patch`")
        # verify the required parameter 'body11' is set
        if ('body11' not in params) or (params['body11'] is None):
            raise ValueError("Missing the required parameter `body11` when calling `equipment_rack_enclosure_slots_moid_patch`")
        # verify the required parameter 'moid12' is set
        if ('moid12' not in params) or (params['moid12'] is None):
            raise ValueError("Missing the required parameter `moid12` when calling `equipment_rack_enclosure_slots_moid_patch`")
        # verify the required parameter 'body12' is set
        if ('body12' not in params) or (params['body12'] is None):
            raise ValueError("Missing the required parameter `body12` when calling `equipment_rack_enclosure_slots_moid_patch`")
        # verify the required parameter 'moid13' is set
        if ('moid13' not in params) or (params['moid13'] is None):
            raise ValueError("Missing the required parameter `moid13` when calling `equipment_rack_enclosure_slots_moid_patch`")
        # verify the required parameter 'body13' is set
        if ('body13' not in params) or (params['body13'] is None):
            raise ValueError("Missing the required parameter `body13` when calling `equipment_rack_enclosure_slots_moid_patch`")
        # verify the required parameter 'moid14' is set
        if ('moid14' not in params) or (params['moid14'] is None):
            raise ValueError("Missing the required parameter `moid14` when calling `equipment_rack_enclosure_slots_moid_patch`")
        # verify the required parameter 'body14' is set
        if ('body14' not in params) or (params['body14'] is None):
            raise ValueError("Missing the required parameter `body14` when calling `equipment_rack_enclosure_slots_moid_patch`")
        # verify the required parameter 'moid15' is set
        if ('moid15' not in params) or (params['moid15'] is None):
            raise ValueError("Missing the required parameter `moid15` when calling `equipment_rack_enclosure_slots_moid_patch`")
        # verify the required parameter 'body15' is set
        if ('body15' not in params) or (params['body15'] is None):
            raise ValueError("Missing the required parameter `body15` when calling `equipment_rack_enclosure_slots_moid_patch`")
        ...
        return self.api_client.call_api('/equipment/RackEnclosureSlots/{moid}', 'PATCH',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def equipment_rack_enclosure_slots_moid_post(self, moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9, moid10, body10, moid11, body11, moid12, body12, moid13, body13, moid14, body14, moid15, body15, **kwargs):
        """
        Update an instance of 'equipmentRackEnclosureSlot'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.equipment_rack_enclosure_slots_moid_post(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9, moid10, body10, moid11, body11, moid12, body12, moid13, body13, moid14, body14, moid15, body15, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.equipment_rack_enclosure_slots_moid_post_with_http_info(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9, moid10, body10, moid11, body11, moid12, body12, moid13, body13, moid14, body14, moid15, body15, **kwargs)
        else:
            (data) = self.equipment_rack_enclosure_slots_moid_post_with_http_info(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9, moid10, body10, moid11, body11, moid12, body12, moid13, body13, moid14, body14, moid15, body15, **kwargs)
            return data

    def equipment_rack_enclosure_slots_moid_post_with_http_info(self, moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9, moid10, body10, moid11, body11, moid12, body12, moid13, body13, moid14, body14, moid15, body15, **kwargs):
        """
        Update an instance of 'equipmentRackEnclosureSlot'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.equipment_rack_enclosure_slots_moid_post_with_http_info(moid, body, moid2, body2, moid3, body3, moid4, body4, moid5, body5, moid6, body6, moid7, body7, moid8, body8, moid9, body9, moid10, body10, moid11, body11, moid12, body12, moid13, body13, moid14, body14, moid15, body15, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method equipment_rack_enclosure_slots_moid_post" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'moid' is set
        if ('moid' not in params) or (params['moid'] is None):
            raise ValueError("Missing the required parameter `moid` when calling `equipment_rack_enclosure_slots_moid_post`")
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `equipment_rack_enclosure_slots_moid_post`")
        # verify the required parameter 'moid2' is set
        if ('moid2' not in params) or (params['moid2'] is None):
            raise ValueError("Missing the required parameter `moid2` when calling `equipment_rack_enclosure_slots_moid_post`")
        # verify the required parameter 'body2' is set
        if ('body2' not in params) or (params['body2'] is None):
            raise ValueError("Missing the required parameter `body2` when calling `equipment_rack_enclosure_slots_moid_post`")
        # verify the required parameter 'moid3' is set
        if ('moid3' not in params) or (params['moid3'] is None):
            raise ValueError("Missing the required parameter `moid3` when calling `equipment_rack_enclosure_slots_moid_post`")
        # verify the required parameter 'body3' is set
        if ('body3' not in params) or (params['body3'] is None):
            raise ValueError("Missing the required parameter `body3` when calling `equipment_rack_enclosure_slots_moid_post`")
        # verify the required parameter 'moid4' is set
        if ('moid4' not in params) or (params['moid4'] is None):
            raise ValueError("Missing the required parameter `moid4` when calling `equipment_rack_enclosure_slots_moid_post`")
        # verify the required parameter 'body4' is set
        if ('body4' not in params) or (params['body4'] is None):
            raise ValueError("Missing the required parameter `body4` when calling `equipment_rack_enclosure_slots_moid_post`")
        # verify the required parameter 'moid5' is set
        if ('moid5' not in params) or (params['moid5'] is None):
            raise ValueError("Missing the required parameter `moid5` when calling `equipment_rack_enclosure_slots_moid_post`")
        # verify the required parameter 'body5' is set
        if ('body5' not in params) or (params['body5'] is None):
            raise ValueError("Missing the required parameter `body5` when calling `equipment_rack_enclosure_slots_moid_post`")
        # verify the required parameter 'moid6' is set
        if ('moid6' not in params) or (params['moid6'] is None):
            raise ValueError("Missing the required parameter `moid6` when calling `equipment_rack_enclosure_slots_moid_post`")
        # verify the required parameter 'body6' is set
        if ('body6' not in params) or (params['body6'] is None):
            raise ValueError("Missing the required parameter `body6` when calling `equipment_rack_enclosure_slots_moid_post`")
        # verify the required parameter 'moid7' is set
        if ('moid7' not in params) or (params['moid7'] is None):
            raise ValueError("Missing the required parameter `moid7` when calling `equipment_rack_enclosure_slots_moid_post`")
        # verify the required parameter 'body7' is set
        if ('body7' not in params) or (params['body7'] is None):
            raise ValueError("Missing the required parameter `body7` when calling `equipment_rack_enclosure_slots_moid_post`")
        # verify the required parameter 'moid8' is set
        if ('moid8' not in params) or (params['moid8'] is None):
            raise ValueError("Missing the required parameter `moid8` when calling `equipment_rack_enclosure_slots_moid_post`")
        # verify the required parameter 'body8' is set
        if ('body8' not in params) or (params['body8'] is None):
            raise ValueError("Missing the required parameter `body8` when calling `equipment_rack_enclosure_slots_moid_post`")
        # verify the required parameter 'moid9' is set
        if ('moid9' not in params) or (params['moid9'] is None):
            raise ValueError("Missing the required parameter `moid9` when calling `equipment_rack_enclosure_slots_moid_post`")
        # verify the required parameter 'body9' is set
        if ('body9' not in params) or (params['body9'] is None):
            raise ValueError("Missing the required parameter `body9` when calling `equipment_rack_enclosure_slots_moid_post`")
        # verify the required parameter 'moid10' is set
        if ('moid10' not in params) or (params['moid10'] is None):
            raise ValueError("Missing the required parameter `moid10` when calling `equipment_rack_enclosure_slots_moid_post`")
        # verify the required parameter 'body10' is set
        if ('body10' not in params) or (params['body10'] is None):
            raise ValueError("Missing the required parameter `body10` when calling `equipment_rack_enclosure_slots_moid_post`")
        # verify the required parameter 'moid11' is set
        if ('moid11' not in params) or (params['moid11'] is None):
            raise ValueError("Missing the required parameter `moid11` when calling `equipment_rack_enclosure_slots_moid_post`")
        # verify the required parameter 'body11' is set
        if ('body11' not in params) or (params['body11'] is None):
            raise ValueError("Missing the required parameter `body11` when calling `equipment_rack_enclosure_slots_moid_post`")
        # verify the required parameter 'moid12' is set
        if ('moid12' not in params) or (params['moid12'] is None):
            raise ValueError("Missing the required parameter `moid12` when calling `equipment_rack_enclosure_slots_moid_post`")
        # verify the required parameter 'body12' is set
        if ('body12' not in params) or (params['body12'] is None):
            raise ValueError("Missing the required parameter `body12` when calling `equipment_rack_enclosure_slots_moid_post`")
        # verify the required parameter 'moid13' is set
        if ('moid13' not in params) or (params['moid13'] is None):
            raise ValueError("Missing the required parameter `moid13` when calling `equipment_rack_enclosure_slots_moid_post`")
        # verify the required parameter 'body13' is set
        if ('body13' not in params) or (params['body13'] is None):
            raise ValueError("Missing the required parameter `body13` when calling `equipment_rack_enclosure_slots_moid_post`")
        # verify the required parameter 'moid14' is set
        if ('moid14' not in params) or (params['moid14'] is None):
            raise ValueError("Missing the required parameter `moid14` when calling `equipment_rack_enclosure_slots_moid_post`")
        # verify the required parameter 'body14' is set
        if ('body14' not in params) or (params['body14'] is None):
            raise ValueError("Missing the required parameter `body14` when calling `equipment_rack_enclosure_slots_moid_post`")
        # verify the required parameter 'moid15' is set
        if ('moid15' not in params) or (params['moid15'] is None):
            raise ValueError("Missing the required parameter `moid15` when calling `equipment_rack_enclosure_slots_moid_post`")
        # verify the required parameter 'body15' is set
        if ('body15' not in params) or (params['body15'] is None):
            raise ValueError("Missing the required parameter `body15` when calling `equipment_rack_enclosure_slots_moid_post`")
        ...
        return self.api_client.call_api('/equipment/RackEnclosureSlots/{moid}', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
