...
class HyperflexConfigResultEntryApi(object):
    ...
    def hyperflex_config_result_entries_get(self, **kwargs):
        """
        List of hyperflexConfigResultEntries
    ...
    def hyperflex_config_result_entries_moid_get(self, moid, **kwargs):
        """
        A instance of hyperflexConfigResultEntry
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        >>> def callback_function(response):
        >>>     pprint(response)
        >>>
        >>> thread = api.hyperflex_config_result_entries_moid_get(moid, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.hyperflex_config_result_entries_moid_get_with_http_info(moid, **kwargs)
        else:
            (data) = self.hyperflex_config_result_entries_moid_get_with_http_info(moid, **kwargs)
            return data

    def hyperflex_config_result_entries_moid_get_with_http_info(self, moid, **kwargs):
        """
        A instance of hyperflexConfigResultEntry
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.hyperflex_config_result_entries_moid_get_with_http_info(moid, callback=callback_function)
