...
class InventoryDeviceInfoApi(object):
    ...
    def inventory_device_infos_moid_get(self, moid, **kwargs):
        """
        A instance of inventoryDeviceInfo
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        >>> def callback_function(response):
        >>>     pprint(response)
        >>>
        >>> thread = api.inventory_device_infos_moid_get(moid, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.inventory_device_infos_moid_get_with_http_info(moid, **kwargs)
        else:
            (data) = self.inventory_device_infos_moid_get_with_http_info(moid, **kwargs)
            return data

    def inventory_device_infos_moid_get_with_http_info(self, moid, **kwargs):
        """
        A instance of inventoryDeviceInfo
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.inventory_device_infos_moid_get_with_http_info(moid, callback=callback_function)
