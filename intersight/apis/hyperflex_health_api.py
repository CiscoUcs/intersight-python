...
class HyperflexHealthApi(object):
    """
    ...
    def hyperflex_healths_get(self, **kwargs):
        """
        Get a list of 'hyperflexHealth' instances
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.hyperflex_healths_get(callback=callback_function)
        ...
        :return: HyperflexHealthList
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.hyperflex_healths_get_with_http_info(**kwargs)
        else:
            (data) = self.hyperflex_healths_get_with_http_info(**kwargs)
            return data

    def hyperflex_healths_get_with_http_info(self, **kwargs):
        """
        Get a list of 'hyperflexHealth' instances
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.hyperflex_healths_get_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method hyperflex_healths_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/hyperflex/Healths', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        ...
                                        response_type='HyperflexHealthList',
    ...
    def hyperflex_healths_moid_get(self, moid, **kwargs):
        """
        Get a specific instance of 'hyperflexHealth'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        >>> def callback_function(response):
        >>>     pprint(response)
        >>>
        >>> thread = api.hyperflex_healths_moid_get(moid, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str moid: The moid of the hyperflexHealth instance. (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.hyperflex_healths_moid_get_with_http_info(moid, **kwargs)
        else:
            (data) = self.hyperflex_healths_moid_get_with_http_info(moid, **kwargs)
            return data

    def hyperflex_healths_moid_get_with_http_info(self, moid, **kwargs):
        """
        Get a specific instance of 'hyperflexHealth'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.hyperflex_healths_moid_get_with_http_info(moid, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method hyperflex_healths_moid_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'moid' is set
        if ('moid' not in params) or (params['moid'] is None):
            raise ValueError("Missing the required parameter `moid` when calling `hyperflex_healths_moid_get`")
        ...
        return self.api_client.call_api('/hyperflex/Healths/{moid}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
