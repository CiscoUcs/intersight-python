...
class PciSwitchApi(object):
    ...
    def pci_switches_get(self, **kwargs):
        """
        Get a list of 'pciSwitch' instances
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.pci_switches_get(callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.pci_switches_get_with_http_info(**kwargs)
        else:
            (data) = self.pci_switches_get_with_http_info(**kwargs)
            return data

    def pci_switches_get_with_http_info(self, **kwargs):
        """
        Get a list of 'pciSwitch' instances
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.pci_switches_get_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method pci_switches_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/pci/Switches', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def pci_switches_moid_get(self, moid, **kwargs):
        """
        Get a specific instance of 'pciSwitch'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        >>> def callback_function(response):
        >>>     pprint(response)
        >>>
        >>> thread = api.pci_switches_moid_get(moid, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str moid: The moid of the pciSwitch instance. (required)
        :return: PciSwitch
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.pci_switches_moid_get_with_http_info(moid, **kwargs)
        else:
            (data) = self.pci_switches_moid_get_with_http_info(moid, **kwargs)
            return data

    def pci_switches_moid_get_with_http_info(self, moid, **kwargs):
        """
        Get a specific instance of 'pciSwitch'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.pci_switches_moid_get_with_http_info(moid, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method pci_switches_moid_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'moid' is set
        if ('moid' not in params) or (params['moid'] is None):
            raise ValueError("Missing the required parameter `moid` when calling `pci_switches_moid_get`")
        ...
        return self.api_client.call_api('/pci/Switches/{moid}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def pci_switches_moid_patch(self, moid, body, **kwargs):
        """
        Update an instance of 'pciSwitch'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        >>> def callback_function(response):
        >>>     pprint(response)
        >>>
        >>> thread = api.pci_switches_moid_patch(moid, body, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str moid: The moid of the pciSwitch instance. (required)
        :param PciSwitch body: pciSwitch to update (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.pci_switches_moid_patch_with_http_info(moid, body, **kwargs)
        else:
            (data) = self.pci_switches_moid_patch_with_http_info(moid, body, **kwargs)
            return data

    def pci_switches_moid_patch_with_http_info(self, moid, body, **kwargs):
        """
        Update an instance of 'pciSwitch'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.pci_switches_moid_patch_with_http_info(moid, body, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method pci_switches_moid_patch" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'moid' is set
        if ('moid' not in params) or (params['moid'] is None):
            raise ValueError("Missing the required parameter `moid` when calling `pci_switches_moid_patch`")
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `pci_switches_moid_patch`")
        ...
        return self.api_client.call_api('/pci/Switches/{moid}', 'PATCH',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def pci_switches_moid_post(self, moid, body, **kwargs):
        """
        Update an instance of 'pciSwitch'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.pci_switches_moid_post(moid, body, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.pci_switches_moid_post_with_http_info(moid, body, **kwargs)
        else:
            (data) = self.pci_switches_moid_post_with_http_info(moid, body, **kwargs)
            return data

    def pci_switches_moid_post_with_http_info(self, moid, body, **kwargs):
        """
        Update an instance of 'pciSwitch'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.pci_switches_moid_post_with_http_info(moid, body, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method pci_switches_moid_post" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'moid' is set
        if ('moid' not in params) or (params['moid'] is None):
            raise ValueError("Missing the required parameter `moid` when calling `pci_switches_moid_post`")
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `pci_switches_moid_post`")
        ...
        return self.api_client.call_api('/pci/Switches/{moid}', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
