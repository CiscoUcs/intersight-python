...
class OsCatalogApi(object):
    ...
    def os_catalogs_get(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.os_catalogs_get(callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.os_catalogs_get_with_http_info(**kwargs)
        else:
            (data) = self.os_catalogs_get_with_http_info(**kwargs)
            return data

    def os_catalogs_get_with_http_info(self, **kwargs):
        """
        Read a 'os.Catalog' resource.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.os_catalogs_get_with_http_info(callback=callback_function)
        ...
        return self.api_client.call_api('/os/Catalogs', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def os_catalogs_moid_get(self, moid, **kwargs):
        """
        Read a 'os.Catalog' resource.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.os_catalogs_moid_get(moid, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str moid: The Moid of the osCatalog instance. (required)
        :return: OsCatalog
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.os_catalogs_moid_get_with_http_info(moid, **kwargs)
        else:
            (data) = self.os_catalogs_moid_get_with_http_info(moid, **kwargs)
            return data

    def os_catalogs_moid_get_with_http_info(self, moid, **kwargs):
        """
        Read a 'os.Catalog' resource.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.os_catalogs_moid_get_with_http_info(moid, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method os_catalogs_moid_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'moid' is set
        if ('moid' not in params) or (params['moid'] is None):
            raise ValueError("Missing the required parameter `moid` when calling `os_catalogs_moid_get`")
        ...
        return self.api_client.call_api('/os/Catalogs/{Moid}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
