...
class ServerConfigImportApi(object):
    """
    ...
    def server_config_imports_get(self, **kwargs):
        """
        Get a list of 'serverConfigImport' instances
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.server_config_imports_get(callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.server_config_imports_get_with_http_info(**kwargs)
        else:
            (data) = self.server_config_imports_get_with_http_info(**kwargs)
            return data

    def server_config_imports_get_with_http_info(self, **kwargs):
        """
        Get a list of 'serverConfigImport' instances
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.server_config_imports_get_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method server_config_imports_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/server/ConfigImports', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        ...
                                        response_type='ServerConfigImportList',
    ...
    def server_config_imports_moid_get(self, moid, **kwargs):
        """
        Get a specific instance of 'serverConfigImport'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        >>> def callback_function(response):
        >>>     pprint(response)
        >>>
        >>> thread = api.server_config_imports_moid_get(moid, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str moid: The moid of the serverConfigImport instance. (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.server_config_imports_moid_get_with_http_info(moid, **kwargs)
        else:
            (data) = self.server_config_imports_moid_get_with_http_info(moid, **kwargs)
            return data

    def server_config_imports_moid_get_with_http_info(self, moid, **kwargs):
        """
        Get a specific instance of 'serverConfigImport'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.server_config_imports_moid_get_with_http_info(moid, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method server_config_imports_moid_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'moid' is set
        if ('moid' not in params) or (params['moid'] is None):
            raise ValueError("Missing the required parameter `moid` when calling `server_config_imports_moid_get`")
        ...
        return self.api_client.call_api('/server/ConfigImports/{moid}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def server_config_imports_post(self, body, **kwargs):
        """
        Create an instance of 'serverConfigImport'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        >>> def callback_function(response):
        >>>     pprint(response)
        >>>
        >>> thread = api.server_config_imports_post(body, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param ServerConfigImport body: serverConfigImport to add (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.server_config_imports_post_with_http_info(body, **kwargs)
        else:
            (data) = self.server_config_imports_post_with_http_info(body, **kwargs)
            return data

    def server_config_imports_post_with_http_info(self, body, **kwargs):
        """
        Create an instance of 'serverConfigImport'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.server_config_imports_post_with_http_info(body, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method server_config_imports_post" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `server_config_imports_post`")
        ...
        return self.api_client.call_api('/server/ConfigImports', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
