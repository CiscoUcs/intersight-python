...
class HclDataImportLogApi(object):
    """
    ...
    def hcl_data_import_logs_get(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.hcl_data_import_logs_get(callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.hcl_data_import_logs_get_with_http_info(**kwargs)
        else:
            (data) = self.hcl_data_import_logs_get_with_http_info(**kwargs)
            return data

    def hcl_data_import_logs_get_with_http_info(self, **kwargs):
        """
        Get a list of 'hclDataImportLog' instances
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.hcl_data_import_logs_get_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method hcl_data_import_logs_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/hcl/DataImportLogs', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        ...
                                        response_type='HclDataImportLogList',
    ...
    def hcl_data_import_logs_moid_get(self, moid, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.hcl_data_import_logs_moid_get(moid, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str moid: The moid of the hclDataImportLog instance. (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.hcl_data_import_logs_moid_get_with_http_info(moid, **kwargs)
        else:
            (data) = self.hcl_data_import_logs_moid_get_with_http_info(moid, **kwargs)
            return data

    def hcl_data_import_logs_moid_get_with_http_info(self, moid, **kwargs):
        """
        Get a specific instance of 'hclDataImportLog'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.hcl_data_import_logs_moid_get_with_http_info(moid, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method hcl_data_import_logs_moid_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'moid' is set
        if ('moid' not in params) or (params['moid'] is None):
            raise ValueError("Missing the required parameter `moid` when calling `hcl_data_import_logs_moid_get`")
        ...
        return self.api_client.call_api('/hcl/DataImportLogs/{moid}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def hcl_data_import_logs_post(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.hcl_data_import_logs_post(body, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param HclDataImportLog body: hclDataImportLog to add (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.hcl_data_import_logs_post_with_http_info(body, **kwargs)
        else:
            (data) = self.hcl_data_import_logs_post_with_http_info(body, **kwargs)
            return data

    def hcl_data_import_logs_post_with_http_info(self, body, **kwargs):
        """
        Create an instance of 'hclDataImportLog'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.hcl_data_import_logs_post_with_http_info(body, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method hcl_data_import_logs_post" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `hcl_data_import_logs_post`")
        ...
        return self.api_client.call_api('/hcl/DataImportLogs', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
