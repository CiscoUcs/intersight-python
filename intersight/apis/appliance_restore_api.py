...
class ApplianceRestoreApi(object):
    """
    ...
    def appliance_restores_get(self, **kwargs):
        """
        Get a list of 'applianceRestore' instances
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.appliance_restores_get(callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.appliance_restores_get_with_http_info(**kwargs)
        else:
            (data) = self.appliance_restores_get_with_http_info(**kwargs)
            return data

    def appliance_restores_get_with_http_info(self, **kwargs):
        """
        Get a list of 'applianceRestore' instances
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.appliance_restores_get_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method appliance_restores_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/appliance/Restores', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        ...
                                        response_type='ApplianceRestoreList',
    ...
    def appliance_restores_moid_delete(self, moid, **kwargs):
        """
        Delete an instance of 'applianceRestore'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        >>> def callback_function(response):
        >>>     pprint(response)
        >>>
        >>> thread = api.appliance_restores_moid_delete(moid, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str moid: The moid of the applianceRestore instance. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.appliance_restores_moid_delete_with_http_info(moid, **kwargs)
        else:
            (data) = self.appliance_restores_moid_delete_with_http_info(moid, **kwargs)
            return data

    def appliance_restores_moid_delete_with_http_info(self, moid, **kwargs):
        """
        Delete an instance of 'applianceRestore'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.appliance_restores_moid_delete_with_http_info(moid, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method appliance_restores_moid_delete" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'moid' is set
        if ('moid' not in params) or (params['moid'] is None):
            raise ValueError("Missing the required parameter `moid` when calling `appliance_restores_moid_delete`")
        ...
        return self.api_client.call_api('/appliance/Restores/{moid}', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def appliance_restores_moid_get(self, moid, **kwargs):
        """
        Get a specific instance of 'applianceRestore'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        >>> def callback_function(response):
        >>>     pprint(response)
        >>>
        >>> thread = api.appliance_restores_moid_get(moid, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.appliance_restores_moid_get_with_http_info(moid, **kwargs)
        else:
            (data) = self.appliance_restores_moid_get_with_http_info(moid, **kwargs)
            return data

    def appliance_restores_moid_get_with_http_info(self, moid, **kwargs):
        """
        Get a specific instance of 'applianceRestore'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.appliance_restores_moid_get_with_http_info(moid, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method appliance_restores_moid_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'moid' is set
        if ('moid' not in params) or (params['moid'] is None):
            raise ValueError("Missing the required parameter `moid` when calling `appliance_restores_moid_get`")
        ...
        return self.api_client.call_api('/appliance/Restores/{moid}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def appliance_restores_post(self, body, **kwargs):
        """
        Create an instance of 'applianceRestore'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        >>> def callback_function(response):
        >>>     pprint(response)
        >>>
        >>> thread = api.appliance_restores_post(body, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param ApplianceRestore body: applianceRestore to add (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.appliance_restores_post_with_http_info(body, **kwargs)
        else:
            (data) = self.appliance_restores_post_with_http_info(body, **kwargs)
            return data

    def appliance_restores_post_with_http_info(self, body, **kwargs):
        """
        Create an instance of 'applianceRestore'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.appliance_restores_post_with_http_info(body, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method appliance_restores_post" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `appliance_restores_post`")
        ...
        return self.api_client.call_api('/appliance/Restores', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
