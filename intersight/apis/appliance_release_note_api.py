...
class ApplianceReleaseNoteApi(object):
    """
    ...
    def appliance_release_notes_get(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.appliance_release_notes_get(callback=callback_function)
        ...
        :return: ApplianceReleaseNoteList
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.appliance_release_notes_get_with_http_info(**kwargs)
        else:
            (data) = self.appliance_release_notes_get_with_http_info(**kwargs)
            return data

    def appliance_release_notes_get_with_http_info(self, **kwargs):
        """
        Read a 'appliance.ReleaseNote' resource.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.appliance_release_notes_get_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method appliance_release_notes_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/appliance/ReleaseNotes', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        ...
                                        response_type='ApplianceReleaseNoteList',
    ...
    def appliance_release_notes_moid_get(self, moid, **kwargs):
        """
        Read a 'appliance.ReleaseNote' resource.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.appliance_release_notes_moid_get(moid, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str moid: The Moid of the applianceReleaseNote instance. (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.appliance_release_notes_moid_get_with_http_info(moid, **kwargs)
        else:
            (data) = self.appliance_release_notes_moid_get_with_http_info(moid, **kwargs)
            return data

    def appliance_release_notes_moid_get_with_http_info(self, moid, **kwargs):
        """
        Read a 'appliance.ReleaseNote' resource.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.appliance_release_notes_moid_get_with_http_info(moid, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method appliance_release_notes_moid_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'moid' is set
        if ('moid' not in params) or (params['moid'] is None):
            raise ValueError("Missing the required parameter `moid` when calling `appliance_release_notes_moid_get`")
        ...
        return self.api_client.call_api('/appliance/ReleaseNotes/{Moid}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
