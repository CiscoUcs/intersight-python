...
class WorkflowPendingDynamicWorkflowInfoApi(object):
    """
    ...
    def workflow_pending_dynamic_workflow_infos_get(self, **kwargs):
        """
        Get a list of 'workflowPendingDynamicWorkflowInfo' instances
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.workflow_pending_dynamic_workflow_infos_get(callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.workflow_pending_dynamic_workflow_infos_get_with_http_info(**kwargs)
        else:
            (data) = self.workflow_pending_dynamic_workflow_infos_get_with_http_info(**kwargs)
            return data

    def workflow_pending_dynamic_workflow_infos_get_with_http_info(self, **kwargs):
        """
        Get a list of 'workflowPendingDynamicWorkflowInfo' instances
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.workflow_pending_dynamic_workflow_infos_get_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method workflow_pending_dynamic_workflow_infos_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/workflow/PendingDynamicWorkflowInfos', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        ...
                                        response_type='WorkflowPendingDynamicWorkflowInfoList',
    ...
    def workflow_pending_dynamic_workflow_infos_moid_get(self, moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9, moid10, moid11, moid12, moid13, moid14, moid15, **kwargs):
        """
        Get a specific instance of 'workflowPendingDynamicWorkflowInfo'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        >>> def callback_function(response):
        >>>     pprint(response)
        >>>
        >>> thread = api.workflow_pending_dynamic_workflow_infos_moid_get(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9, moid10, moid11, moid12, moid13, moid14, moid15, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str moid: The moid of the workflowPendingDynamicWorkflowInfo instance. (required)
        :param str moid2: The moid of the workflowPendingDynamicWorkflowInfo instance. (required)
        :param str moid3: The moid of the workflowPendingDynamicWorkflowInfo instance. (required)
        :param str moid4: The moid of the workflowPendingDynamicWorkflowInfo instance. (required)
        :param str moid5: The moid of the workflowPendingDynamicWorkflowInfo instance. (required)
        :param str moid6: The moid of the workflowPendingDynamicWorkflowInfo instance. (required)
        :param str moid7: The moid of the workflowPendingDynamicWorkflowInfo instance. (required)
        :param str moid8: The moid of the workflowPendingDynamicWorkflowInfo instance. (required)
        :param str moid9: The moid of the workflowPendingDynamicWorkflowInfo instance. (required)
        :param str moid10: The moid of the workflowPendingDynamicWorkflowInfo instance. (required)
        :param str moid11: The moid of the workflowPendingDynamicWorkflowInfo instance. (required)
        :param str moid12: The moid of the workflowPendingDynamicWorkflowInfo instance. (required)
        :param str moid13: The moid of the workflowPendingDynamicWorkflowInfo instance. (required)
        :param str moid14: The moid of the workflowPendingDynamicWorkflowInfo instance. (required)
        :param str moid15: The moid of the workflowPendingDynamicWorkflowInfo instance. (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.workflow_pending_dynamic_workflow_infos_moid_get_with_http_info(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9, moid10, moid11, moid12, moid13, moid14, moid15, **kwargs)
        else:
            (data) = self.workflow_pending_dynamic_workflow_infos_moid_get_with_http_info(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9, moid10, moid11, moid12, moid13, moid14, moid15, **kwargs)
            return data

    def workflow_pending_dynamic_workflow_infos_moid_get_with_http_info(self, moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9, moid10, moid11, moid12, moid13, moid14, moid15, **kwargs):
        """
        Get a specific instance of 'workflowPendingDynamicWorkflowInfo'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.workflow_pending_dynamic_workflow_infos_moid_get_with_http_info(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9, moid10, moid11, moid12, moid13, moid14, moid15, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method workflow_pending_dynamic_workflow_infos_moid_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'moid' is set
        if ('moid' not in params) or (params['moid'] is None):
            raise ValueError("Missing the required parameter `moid` when calling `workflow_pending_dynamic_workflow_infos_moid_get`")
        # verify the required parameter 'moid2' is set
        if ('moid2' not in params) or (params['moid2'] is None):
            raise ValueError("Missing the required parameter `moid2` when calling `workflow_pending_dynamic_workflow_infos_moid_get`")
        # verify the required parameter 'moid3' is set
        if ('moid3' not in params) or (params['moid3'] is None):
            raise ValueError("Missing the required parameter `moid3` when calling `workflow_pending_dynamic_workflow_infos_moid_get`")
        # verify the required parameter 'moid4' is set
        if ('moid4' not in params) or (params['moid4'] is None):
            raise ValueError("Missing the required parameter `moid4` when calling `workflow_pending_dynamic_workflow_infos_moid_get`")
        # verify the required parameter 'moid5' is set
        if ('moid5' not in params) or (params['moid5'] is None):
            raise ValueError("Missing the required parameter `moid5` when calling `workflow_pending_dynamic_workflow_infos_moid_get`")
        # verify the required parameter 'moid6' is set
        if ('moid6' not in params) or (params['moid6'] is None):
            raise ValueError("Missing the required parameter `moid6` when calling `workflow_pending_dynamic_workflow_infos_moid_get`")
        # verify the required parameter 'moid7' is set
        if ('moid7' not in params) or (params['moid7'] is None):
            raise ValueError("Missing the required parameter `moid7` when calling `workflow_pending_dynamic_workflow_infos_moid_get`")
        # verify the required parameter 'moid8' is set
        if ('moid8' not in params) or (params['moid8'] is None):
            raise ValueError("Missing the required parameter `moid8` when calling `workflow_pending_dynamic_workflow_infos_moid_get`")
        # verify the required parameter 'moid9' is set
        if ('moid9' not in params) or (params['moid9'] is None):
            raise ValueError("Missing the required parameter `moid9` when calling `workflow_pending_dynamic_workflow_infos_moid_get`")
        # verify the required parameter 'moid10' is set
        if ('moid10' not in params) or (params['moid10'] is None):
            raise ValueError("Missing the required parameter `moid10` when calling `workflow_pending_dynamic_workflow_infos_moid_get`")
        # verify the required parameter 'moid11' is set
        if ('moid11' not in params) or (params['moid11'] is None):
            raise ValueError("Missing the required parameter `moid11` when calling `workflow_pending_dynamic_workflow_infos_moid_get`")
        # verify the required parameter 'moid12' is set
        if ('moid12' not in params) or (params['moid12'] is None):
            raise ValueError("Missing the required parameter `moid12` when calling `workflow_pending_dynamic_workflow_infos_moid_get`")
        # verify the required parameter 'moid13' is set
        if ('moid13' not in params) or (params['moid13'] is None):
            raise ValueError("Missing the required parameter `moid13` when calling `workflow_pending_dynamic_workflow_infos_moid_get`")
        # verify the required parameter 'moid14' is set
        if ('moid14' not in params) or (params['moid14'] is None):
            raise ValueError("Missing the required parameter `moid14` when calling `workflow_pending_dynamic_workflow_infos_moid_get`")
        # verify the required parameter 'moid15' is set
        if ('moid15' not in params) or (params['moid15'] is None):
            raise ValueError("Missing the required parameter `moid15` when calling `workflow_pending_dynamic_workflow_infos_moid_get`")
        ...
        return self.api_client.call_api('/workflow/PendingDynamicWorkflowInfos/{moid}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
