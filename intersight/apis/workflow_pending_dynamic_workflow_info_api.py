...
class WorkflowPendingDynamicWorkflowInfoApi(object):
    ...
    def workflow_pending_dynamic_workflow_infos_moid_get(self, moid, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.workflow_pending_dynamic_workflow_infos_moid_get(moid, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.workflow_pending_dynamic_workflow_infos_moid_get_with_http_info(moid, **kwargs)
        else:
            (data) = self.workflow_pending_dynamic_workflow_infos_moid_get_with_http_info(moid, **kwargs)
            return data

    def workflow_pending_dynamic_workflow_infos_moid_get_with_http_info(self, moid, **kwargs):
        """
        Get a specific instance of 'workflowPendingDynamicWorkflowInfo'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.workflow_pending_dynamic_workflow_infos_moid_get_with_http_info(moid, callback=callback_function)
