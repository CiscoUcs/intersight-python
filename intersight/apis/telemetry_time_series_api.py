...
class TelemetryTimeSeriesApi(object):
    ...
    def telemetry_time_series_get(self, **kwargs):
        """
        Get a list of 'telemetryTimeSeries' instances
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.telemetry_time_series_get(callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.telemetry_time_series_get_with_http_info(**kwargs)
        else:
            (data) = self.telemetry_time_series_get_with_http_info(**kwargs)
            return data

    def telemetry_time_series_get_with_http_info(self, **kwargs):
        """
        Get a list of 'telemetryTimeSeries' instances
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.telemetry_time_series_get_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method telemetry_time_series_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/telemetry/TimeSeries', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        ...
                                        response_type='TelemetryTimeSeriesList',
    ...
    def telemetry_time_series_moid_get(self, moid, **kwargs):
        """
        Get a specific instance of 'telemetryTimeSeries'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        >>> def callback_function(response):
        >>>     pprint(response)
        >>>
        >>> thread = api.telemetry_time_series_moid_get(moid, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str moid: The moid of the telemetryTimeSeries instance. (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.telemetry_time_series_moid_get_with_http_info(moid, **kwargs)
        else:
            (data) = self.telemetry_time_series_moid_get_with_http_info(moid, **kwargs)
            return data

    def telemetry_time_series_moid_get_with_http_info(self, moid, **kwargs):
        """
        Get a specific instance of 'telemetryTimeSeries'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.telemetry_time_series_moid_get_with_http_info(moid, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method telemetry_time_series_moid_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'moid' is set
        if ('moid' not in params) or (params['moid'] is None):
            raise ValueError("Missing the required parameter `moid` when calling `telemetry_time_series_moid_get`")
        ...
        return self.api_client.call_api('/telemetry/TimeSeries/{moid}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='TelemetryTimeSeries',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def telemetry_time_series_post(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.telemetry_time_series_post(body, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.telemetry_time_series_post_with_http_info(body, **kwargs)
        else:
            (data) = self.telemetry_time_series_post_with_http_info(body, **kwargs)
            return data

    def telemetry_time_series_post_with_http_info(self, body, **kwargs):
        """
        Create an instance of 'telemetryTimeSeries'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.telemetry_time_series_post_with_http_info(body, callback=callback_function)
