...
class MetaDefinitionApi(object):
    ...
    def meta_definitions_moid_delete(self, moid, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.meta_definitions_moid_delete(moid, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.meta_definitions_moid_delete_with_http_info(moid, **kwargs)
        else:
            (data) = self.meta_definitions_moid_delete_with_http_info(moid, **kwargs)
            return data

    def meta_definitions_moid_delete_with_http_info(self, moid, **kwargs):
        """
        Delete an instance of 'metaDefinition'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.meta_definitions_moid_delete_with_http_info(moid, callback=callback_function)
    ...
    def meta_definitions_moid_get(self, moid, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.meta_definitions_moid_get(moid, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.meta_definitions_moid_get_with_http_info(moid, **kwargs)
        else:
            (data) = self.meta_definitions_moid_get_with_http_info(moid, **kwargs)
            return data

    def meta_definitions_moid_get_with_http_info(self, moid, **kwargs):
        """
        Get a specific instance of 'metaDefinition'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.meta_definitions_moid_get_with_http_info(moid, callback=callback_function)
