...
class ApplianceSystemInfoApi(object):
    """
    ...
    def appliance_system_infos_get(self, **kwargs):
        """
        Get a list of 'applianceSystemInfo' instances
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.appliance_system_infos_get(callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.appliance_system_infos_get_with_http_info(**kwargs)
        else:
            (data) = self.appliance_system_infos_get_with_http_info(**kwargs)
            return data

    def appliance_system_infos_get_with_http_info(self, **kwargs):
        """
        Get a list of 'applianceSystemInfo' instances
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.appliance_system_infos_get_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method appliance_system_infos_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/appliance/SystemInfos', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        ...
                                        response_type='ApplianceSystemInfoList',
    ...
    def appliance_system_infos_moid_get(self, moid, **kwargs):
        """
        Get a specific instance of 'applianceSystemInfo'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        >>> def callback_function(response):
        >>>     pprint(response)
        >>>
        >>> thread = api.appliance_system_infos_moid_get(moid, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str moid: The moid of the applianceSystemInfo instance. (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.appliance_system_infos_moid_get_with_http_info(moid, **kwargs)
        else:
            (data) = self.appliance_system_infos_moid_get_with_http_info(moid, **kwargs)
            return data

    def appliance_system_infos_moid_get_with_http_info(self, moid, **kwargs):
        """
        Get a specific instance of 'applianceSystemInfo'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.appliance_system_infos_moid_get_with_http_info(moid, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method appliance_system_infos_moid_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'moid' is set
        if ('moid' not in params) or (params['moid'] is None):
            raise ValueError("Missing the required parameter `moid` when calling `appliance_system_infos_moid_get`")
        ...
        return self.api_client.call_api('/appliance/SystemInfos/{moid}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
