...
class HyperflexNodeApi(object):
    ...
    def hyperflex_nodes_moid_get(self, moid, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.hyperflex_nodes_moid_get(moid, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.hyperflex_nodes_moid_get_with_http_info(moid, **kwargs)
        else:
            (data) = self.hyperflex_nodes_moid_get_with_http_info(moid, **kwargs)
            return data

    def hyperflex_nodes_moid_get_with_http_info(self, moid, **kwargs):
        """
        Get a specific instance of 'hyperflexNode'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.hyperflex_nodes_moid_get_with_http_info(moid, callback=callback_function)
