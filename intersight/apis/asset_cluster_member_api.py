...
class AssetClusterMemberApi(object):
    ...
    def asset_cluster_members_moid_get(self, moid, **kwargs):
        """
        Read a 'asset.ClusterMember' resource.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.asset_cluster_members_moid_get(moid, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.asset_cluster_members_moid_get_with_http_info(moid, **kwargs)
        else:
            (data) = self.asset_cluster_members_moid_get_with_http_info(moid, **kwargs)
            return data

    def asset_cluster_members_moid_get_with_http_info(self, moid, **kwargs):
        """
        Read a 'asset.ClusterMember' resource.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.asset_cluster_members_moid_get_with_http_info(moid, callback=callback_function)
