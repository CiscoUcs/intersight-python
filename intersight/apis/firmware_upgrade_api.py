...
class FirmwareUpgradeApi(object):
    """
    ...
    def firmware_upgrades_get(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.firmware_upgrades_get(callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.firmware_upgrades_get_with_http_info(**kwargs)
        else:
            (data) = self.firmware_upgrades_get_with_http_info(**kwargs)
            return data

    def firmware_upgrades_get_with_http_info(self, **kwargs):
        """
        Get a list of 'firmwareUpgrade' instances
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.firmware_upgrades_get_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method firmware_upgrades_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/firmware/Upgrades', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        ...
                                        response_type='FirmwareUpgradeList',
    ...
    def firmware_upgrades_moid_delete(self, moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9, moid10, moid11, moid12, moid13, moid14, moid15, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.firmware_upgrades_moid_delete(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9, moid10, moid11, moid12, moid13, moid14, moid15, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str moid: The moid of the firmwareUpgrade instance. (required)
        :param str moid2: The moid of the firmwareUpgrade instance. (required)
        :param str moid3: The moid of the firmwareUpgrade instance. (required)
        :param str moid4: The moid of the firmwareUpgrade instance. (required)
        :param str moid5: The moid of the firmwareUpgrade instance. (required)
        :param str moid6: The moid of the firmwareUpgrade instance. (required)
        :param str moid7: The moid of the firmwareUpgrade instance. (required)
        :param str moid8: The moid of the firmwareUpgrade instance. (required)
        :param str moid9: The moid of the firmwareUpgrade instance. (required)
        :param str moid10: The moid of the firmwareUpgrade instance. (required)
        :param str moid11: The moid of the firmwareUpgrade instance. (required)
        :param str moid12: The moid of the firmwareUpgrade instance. (required)
        :param str moid13: The moid of the firmwareUpgrade instance. (required)
        :param str moid14: The moid of the firmwareUpgrade instance. (required)
        :param str moid15: The moid of the firmwareUpgrade instance. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.firmware_upgrades_moid_delete_with_http_info(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9, moid10, moid11, moid12, moid13, moid14, moid15, **kwargs)
        else:
            (data) = self.firmware_upgrades_moid_delete_with_http_info(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9, moid10, moid11, moid12, moid13, moid14, moid15, **kwargs)
            return data

    def firmware_upgrades_moid_delete_with_http_info(self, moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9, moid10, moid11, moid12, moid13, moid14, moid15, **kwargs):
        """
        Delete an instance of 'firmwareUpgrade'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.firmware_upgrades_moid_delete_with_http_info(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9, moid10, moid11, moid12, moid13, moid14, moid15, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method firmware_upgrades_moid_delete" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'moid' is set
        if ('moid' not in params) or (params['moid'] is None):
            raise ValueError("Missing the required parameter `moid` when calling `firmware_upgrades_moid_delete`")
        # verify the required parameter 'moid2' is set
        if ('moid2' not in params) or (params['moid2'] is None):
            raise ValueError("Missing the required parameter `moid2` when calling `firmware_upgrades_moid_delete`")
        # verify the required parameter 'moid3' is set
        if ('moid3' not in params) or (params['moid3'] is None):
            raise ValueError("Missing the required parameter `moid3` when calling `firmware_upgrades_moid_delete`")
        # verify the required parameter 'moid4' is set
        if ('moid4' not in params) or (params['moid4'] is None):
            raise ValueError("Missing the required parameter `moid4` when calling `firmware_upgrades_moid_delete`")
        # verify the required parameter 'moid5' is set
        if ('moid5' not in params) or (params['moid5'] is None):
            raise ValueError("Missing the required parameter `moid5` when calling `firmware_upgrades_moid_delete`")
        # verify the required parameter 'moid6' is set
        if ('moid6' not in params) or (params['moid6'] is None):
            raise ValueError("Missing the required parameter `moid6` when calling `firmware_upgrades_moid_delete`")
        # verify the required parameter 'moid7' is set
        if ('moid7' not in params) or (params['moid7'] is None):
            raise ValueError("Missing the required parameter `moid7` when calling `firmware_upgrades_moid_delete`")
        # verify the required parameter 'moid8' is set
        if ('moid8' not in params) or (params['moid8'] is None):
            raise ValueError("Missing the required parameter `moid8` when calling `firmware_upgrades_moid_delete`")
        # verify the required parameter 'moid9' is set
        if ('moid9' not in params) or (params['moid9'] is None):
            raise ValueError("Missing the required parameter `moid9` when calling `firmware_upgrades_moid_delete`")
        # verify the required parameter 'moid10' is set
        if ('moid10' not in params) or (params['moid10'] is None):
            raise ValueError("Missing the required parameter `moid10` when calling `firmware_upgrades_moid_delete`")
        # verify the required parameter 'moid11' is set
        if ('moid11' not in params) or (params['moid11'] is None):
            raise ValueError("Missing the required parameter `moid11` when calling `firmware_upgrades_moid_delete`")
        # verify the required parameter 'moid12' is set
        if ('moid12' not in params) or (params['moid12'] is None):
            raise ValueError("Missing the required parameter `moid12` when calling `firmware_upgrades_moid_delete`")
        # verify the required parameter 'moid13' is set
        if ('moid13' not in params) or (params['moid13'] is None):
            raise ValueError("Missing the required parameter `moid13` when calling `firmware_upgrades_moid_delete`")
        # verify the required parameter 'moid14' is set
        if ('moid14' not in params) or (params['moid14'] is None):
            raise ValueError("Missing the required parameter `moid14` when calling `firmware_upgrades_moid_delete`")
        # verify the required parameter 'moid15' is set
        if ('moid15' not in params) or (params['moid15'] is None):
            raise ValueError("Missing the required parameter `moid15` when calling `firmware_upgrades_moid_delete`")
        ...
        return self.api_client.call_api('/firmware/Upgrades/{moid}', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def firmware_upgrades_moid_get(self, moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9, moid10, moid11, moid12, moid13, moid14, moid15, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.firmware_upgrades_moid_get(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9, moid10, moid11, moid12, moid13, moid14, moid15, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.firmware_upgrades_moid_get_with_http_info(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9, moid10, moid11, moid12, moid13, moid14, moid15, **kwargs)
        else:
            (data) = self.firmware_upgrades_moid_get_with_http_info(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9, moid10, moid11, moid12, moid13, moid14, moid15, **kwargs)
            return data

    def firmware_upgrades_moid_get_with_http_info(self, moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9, moid10, moid11, moid12, moid13, moid14, moid15, **kwargs):
        """
        Get a specific instance of 'firmwareUpgrade'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.firmware_upgrades_moid_get_with_http_info(moid, moid2, moid3, moid4, moid5, moid6, moid7, moid8, moid9, moid10, moid11, moid12, moid13, moid14, moid15, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method firmware_upgrades_moid_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'moid' is set
        if ('moid' not in params) or (params['moid'] is None):
            raise ValueError("Missing the required parameter `moid` when calling `firmware_upgrades_moid_get`")
        # verify the required parameter 'moid2' is set
        if ('moid2' not in params) or (params['moid2'] is None):
            raise ValueError("Missing the required parameter `moid2` when calling `firmware_upgrades_moid_get`")
        # verify the required parameter 'moid3' is set
        if ('moid3' not in params) or (params['moid3'] is None):
            raise ValueError("Missing the required parameter `moid3` when calling `firmware_upgrades_moid_get`")
        # verify the required parameter 'moid4' is set
        if ('moid4' not in params) or (params['moid4'] is None):
            raise ValueError("Missing the required parameter `moid4` when calling `firmware_upgrades_moid_get`")
        # verify the required parameter 'moid5' is set
        if ('moid5' not in params) or (params['moid5'] is None):
            raise ValueError("Missing the required parameter `moid5` when calling `firmware_upgrades_moid_get`")
        # verify the required parameter 'moid6' is set
        if ('moid6' not in params) or (params['moid6'] is None):
            raise ValueError("Missing the required parameter `moid6` when calling `firmware_upgrades_moid_get`")
        # verify the required parameter 'moid7' is set
        if ('moid7' not in params) or (params['moid7'] is None):
            raise ValueError("Missing the required parameter `moid7` when calling `firmware_upgrades_moid_get`")
        # verify the required parameter 'moid8' is set
        if ('moid8' not in params) or (params['moid8'] is None):
            raise ValueError("Missing the required parameter `moid8` when calling `firmware_upgrades_moid_get`")
        # verify the required parameter 'moid9' is set
        if ('moid9' not in params) or (params['moid9'] is None):
            raise ValueError("Missing the required parameter `moid9` when calling `firmware_upgrades_moid_get`")
        # verify the required parameter 'moid10' is set
        if ('moid10' not in params) or (params['moid10'] is None):
            raise ValueError("Missing the required parameter `moid10` when calling `firmware_upgrades_moid_get`")
        # verify the required parameter 'moid11' is set
        if ('moid11' not in params) or (params['moid11'] is None):
            raise ValueError("Missing the required parameter `moid11` when calling `firmware_upgrades_moid_get`")
        # verify the required parameter 'moid12' is set
        if ('moid12' not in params) or (params['moid12'] is None):
            raise ValueError("Missing the required parameter `moid12` when calling `firmware_upgrades_moid_get`")
        # verify the required parameter 'moid13' is set
        if ('moid13' not in params) or (params['moid13'] is None):
            raise ValueError("Missing the required parameter `moid13` when calling `firmware_upgrades_moid_get`")
        # verify the required parameter 'moid14' is set
        if ('moid14' not in params) or (params['moid14'] is None):
            raise ValueError("Missing the required parameter `moid14` when calling `firmware_upgrades_moid_get`")
        # verify the required parameter 'moid15' is set
        if ('moid15' not in params) or (params['moid15'] is None):
            raise ValueError("Missing the required parameter `moid15` when calling `firmware_upgrades_moid_get`")
        ...
        return self.api_client.call_api('/firmware/Upgrades/{moid}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def firmware_upgrades_post(self, body, body2, body3, body4, body5, body6, body7, body8, body9, body10, body11, body12, body13, body14, body15, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.firmware_upgrades_post(body, body2, body3, body4, body5, body6, body7, body8, body9, body10, body11, body12, body13, body14, body15, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param FirmwareUpgrade body: firmwareUpgrade to add (required)
        ...
        :param FirmwareUpgrade body9: firmwareUpgrade to add (required)
        :param FirmwareUpgrade body10: firmwareUpgrade to add (required)
        :param FirmwareUpgrade body11: firmwareUpgrade to add (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.firmware_upgrades_post_with_http_info(body, body2, body3, body4, body5, body6, body7, body8, body9, body10, body11, body12, body13, body14, body15, **kwargs)
        else:
            (data) = self.firmware_upgrades_post_with_http_info(body, body2, body3, body4, body5, body6, body7, body8, body9, body10, body11, body12, body13, body14, body15, **kwargs)
            return data

    def firmware_upgrades_post_with_http_info(self, body, body2, body3, body4, body5, body6, body7, body8, body9, body10, body11, body12, body13, body14, body15, **kwargs):
        """
        Create an instance of 'firmwareUpgrade'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.firmware_upgrades_post_with_http_info(body, body2, body3, body4, body5, body6, body7, body8, body9, body10, body11, body12, body13, body14, body15, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method firmware_upgrades_post" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `firmware_upgrades_post`")
        # verify the required parameter 'body2' is set
        if ('body2' not in params) or (params['body2'] is None):
            raise ValueError("Missing the required parameter `body2` when calling `firmware_upgrades_post`")
        # verify the required parameter 'body3' is set
        if ('body3' not in params) or (params['body3'] is None):
            raise ValueError("Missing the required parameter `body3` when calling `firmware_upgrades_post`")
        # verify the required parameter 'body4' is set
        if ('body4' not in params) or (params['body4'] is None):
            raise ValueError("Missing the required parameter `body4` when calling `firmware_upgrades_post`")
        # verify the required parameter 'body5' is set
        if ('body5' not in params) or (params['body5'] is None):
            raise ValueError("Missing the required parameter `body5` when calling `firmware_upgrades_post`")
        # verify the required parameter 'body6' is set
        if ('body6' not in params) or (params['body6'] is None):
            raise ValueError("Missing the required parameter `body6` when calling `firmware_upgrades_post`")
        # verify the required parameter 'body7' is set
        if ('body7' not in params) or (params['body7'] is None):
            raise ValueError("Missing the required parameter `body7` when calling `firmware_upgrades_post`")
        # verify the required parameter 'body8' is set
        if ('body8' not in params) or (params['body8'] is None):
            raise ValueError("Missing the required parameter `body8` when calling `firmware_upgrades_post`")
        # verify the required parameter 'body9' is set
        if ('body9' not in params) or (params['body9'] is None):
            raise ValueError("Missing the required parameter `body9` when calling `firmware_upgrades_post`")
        # verify the required parameter 'body10' is set
        if ('body10' not in params) or (params['body10'] is None):
            raise ValueError("Missing the required parameter `body10` when calling `firmware_upgrades_post`")
        # verify the required parameter 'body11' is set
        if ('body11' not in params) or (params['body11'] is None):
            raise ValueError("Missing the required parameter `body11` when calling `firmware_upgrades_post`")
        # verify the required parameter 'body12' is set
        if ('body12' not in params) or (params['body12'] is None):
            raise ValueError("Missing the required parameter `body12` when calling `firmware_upgrades_post`")
        # verify the required parameter 'body13' is set
        if ('body13' not in params) or (params['body13'] is None):
            raise ValueError("Missing the required parameter `body13` when calling `firmware_upgrades_post`")
        # verify the required parameter 'body14' is set
        if ('body14' not in params) or (params['body14'] is None):
            raise ValueError("Missing the required parameter `body14` when calling `firmware_upgrades_post`")
        # verify the required parameter 'body15' is set
        if ('body15' not in params) or (params['body15'] is None):
            raise ValueError("Missing the required parameter `body15` when calling `firmware_upgrades_post`")
        ...
        return self.api_client.call_api('/firmware/Upgrades', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
