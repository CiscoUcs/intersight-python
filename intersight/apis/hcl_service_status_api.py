...
class HclServiceStatusApi(object):
    ...
    def hcl_service_statuses_moid_get(self, moid, **kwargs):
        """
        Read a 'hcl.ServiceStatus' resource.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.hcl_service_statuses_moid_get(moid, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.hcl_service_statuses_moid_get_with_http_info(moid, **kwargs)
        else:
            (data) = self.hcl_service_statuses_moid_get_with_http_info(moid, **kwargs)
            return data

    def hcl_service_statuses_moid_get_with_http_info(self, moid, **kwargs):
        """
        Read a 'hcl.ServiceStatus' resource.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.hcl_service_statuses_moid_get_with_http_info(moid, callback=callback_function)
