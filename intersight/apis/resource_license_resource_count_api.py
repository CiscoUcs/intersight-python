...
class ResourceLicenseResourceCountApi(object):
    """
    ...
    def resource_license_resource_counts_get(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.resource_license_resource_counts_get(callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.resource_license_resource_counts_get_with_http_info(**kwargs)
        else:
            (data) = self.resource_license_resource_counts_get_with_http_info(**kwargs)
            return data

    def resource_license_resource_counts_get_with_http_info(self, **kwargs):
        """
        Read a 'resource.LicenseResourceCount' resource.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.resource_license_resource_counts_get_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method resource_license_resource_counts_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/resource/LicenseResourceCounts', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        ...
                                        response_type='ResourceLicenseResourceCountList',
    ...
    def resource_license_resource_counts_moid_get(self, moid, **kwargs):
        """
        Read a 'resource.LicenseResourceCount' resource.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.resource_license_resource_counts_moid_get(moid, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str moid: The Moid of the resourceLicenseResourceCount instance. (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.resource_license_resource_counts_moid_get_with_http_info(moid, **kwargs)
        else:
            (data) = self.resource_license_resource_counts_moid_get_with_http_info(moid, **kwargs)
            return data

    def resource_license_resource_counts_moid_get_with_http_info(self, moid, **kwargs):
        """
        Read a 'resource.LicenseResourceCount' resource.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.resource_license_resource_counts_moid_get_with_http_info(moid, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method resource_license_resource_counts_moid_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'moid' is set
        if ('moid' not in params) or (params['moid'] is None):
            raise ValueError("Missing the required parameter `moid` when calling `resource_license_resource_counts_moid_get`")
        ...
        return self.api_client.call_api('/resource/LicenseResourceCounts/{Moid}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
