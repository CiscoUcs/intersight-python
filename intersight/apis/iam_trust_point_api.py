...
class IamTrustPointApi(object):
    ...
    def iam_trust_points_get(self, **kwargs):
        """
        Get a list of 'iamTrustPoint' instances
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.iam_trust_points_get(callback=callback_function)
        ...
        :return: IamTrustPointList
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.iam_trust_points_get_with_http_info(**kwargs)
        else:
            (data) = self.iam_trust_points_get_with_http_info(**kwargs)
            return data

    def iam_trust_points_get_with_http_info(self, **kwargs):
        """
        Get a list of 'iamTrustPoint' instances
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.iam_trust_points_get_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method iam_trust_points_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/iam/TrustPoints', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        ...
                                        response_type='IamTrustPointList',
    ...
    def iam_trust_points_moid_delete(self, moid, **kwargs):
        """
        Delete an instance of 'iamTrustPoint'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        >>> def callback_function(response):
        >>>     pprint(response)
        >>>
        >>> thread = api.iam_trust_points_moid_delete(moid, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str moid: The moid of the iamTrustPoint instance. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.iam_trust_points_moid_delete_with_http_info(moid, **kwargs)
        else:
            (data) = self.iam_trust_points_moid_delete_with_http_info(moid, **kwargs)
            return data

    def iam_trust_points_moid_delete_with_http_info(self, moid, **kwargs):
        """
        Delete an instance of 'iamTrustPoint'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.iam_trust_points_moid_delete_with_http_info(moid, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method iam_trust_points_moid_delete" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'moid' is set
        if ('moid' not in params) or (params['moid'] is None):
            raise ValueError("Missing the required parameter `moid` when calling `iam_trust_points_moid_delete`")
        ...
        return self.api_client.call_api('/iam/TrustPoints/{moid}', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def iam_trust_points_moid_get(self, moid, **kwargs):
        """
        Get a specific instance of 'iamTrustPoint'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        >>> def callback_function(response):
        >>>     pprint(response)
        >>>
        >>> thread = api.iam_trust_points_moid_get(moid, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.iam_trust_points_moid_get_with_http_info(moid, **kwargs)
        else:
            (data) = self.iam_trust_points_moid_get_with_http_info(moid, **kwargs)
            return data

    def iam_trust_points_moid_get_with_http_info(self, moid, **kwargs):
        """
        Get a specific instance of 'iamTrustPoint'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.iam_trust_points_moid_get_with_http_info(moid, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method iam_trust_points_moid_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'moid' is set
        if ('moid' not in params) or (params['moid'] is None):
            raise ValueError("Missing the required parameter `moid` when calling `iam_trust_points_moid_get`")
        ...
        return self.api_client.call_api('/iam/TrustPoints/{moid}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def iam_trust_points_post(self, body, **kwargs):
        """
        Create an instance of 'iamTrustPoint'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        >>> def callback_function(response):
        >>>     pprint(response)
        >>>
        >>> thread = api.iam_trust_points_post(body, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param IamTrustPoint body: iamTrustPoint to add (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.iam_trust_points_post_with_http_info(body, **kwargs)
        else:
            (data) = self.iam_trust_points_post_with_http_info(body, **kwargs)
            return data

    def iam_trust_points_post_with_http_info(self, body, **kwargs):
        """
        Create an instance of 'iamTrustPoint'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.iam_trust_points_post_with_http_info(body, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method iam_trust_points_post" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `iam_trust_points_post`")
        ...
        return self.api_client.call_api('/iam/TrustPoints', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
