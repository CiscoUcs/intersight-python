...
class IaasUcsdManagedInfraApi(object):
    ...
    def iaas_ucsd_managed_infras_moid_get(self, moid, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.iaas_ucsd_managed_infras_moid_get(moid, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.iaas_ucsd_managed_infras_moid_get_with_http_info(moid, **kwargs)
        else:
            (data) = self.iaas_ucsd_managed_infras_moid_get_with_http_info(moid, **kwargs)
            return data

    def iaas_ucsd_managed_infras_moid_get_with_http_info(self, moid, **kwargs):
        """
        Get a specific instance of 'iaasUcsdManagedInfra'
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.iaas_ucsd_managed_infras_moid_get_with_http_info(moid, callback=callback_function)
