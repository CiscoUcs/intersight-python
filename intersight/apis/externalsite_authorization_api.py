...
class ExternalsiteAuthorizationApi(object):
    ...
    def externalsite_authorizations_get(self, **kwargs):
        """
        List of externalsiteAuthorizations
    ...
    def externalsite_authorizations_moid_get(self, moid, **kwargs):
        """
        A instance of externalsiteAuthorization
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        >>> def callback_function(response):
        >>>     pprint(response)
        >>>
        >>> thread = api.externalsite_authorizations_moid_get(moid, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.externalsite_authorizations_moid_get_with_http_info(moid, **kwargs)
        else:
            (data) = self.externalsite_authorizations_moid_get_with_http_info(moid, **kwargs)
            return data

    def externalsite_authorizations_moid_get_with_http_info(self, moid, **kwargs):
        """
        A instance of externalsiteAuthorization
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.externalsite_authorizations_moid_get_with_http_info(moid, callback=callback_function)
    ...
    def externalsite_authorizations_moid_patch(self, moid, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.externalsite_authorizations_moid_patch(moid, body, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.externalsite_authorizations_moid_patch_with_http_info(moid, body, **kwargs)
        else:
            (data) = self.externalsite_authorizations_moid_patch_with_http_info(moid, body, **kwargs)
            return data

    def externalsite_authorizations_moid_patch_with_http_info(self, moid, body, **kwargs):
        """
        Update an instance of externalsiteAuthorization
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.externalsite_authorizations_moid_patch_with_http_info(moid, body, callback=callback_function)
    ...
    def externalsite_authorizations_moid_post(self, moid, body, **kwargs):
        """
        Update an instance of externalsiteAuthorization
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.externalsite_authorizations_moid_post(moid, body, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.externalsite_authorizations_moid_post_with_http_info(moid, body, **kwargs)
        else:
            (data) = self.externalsite_authorizations_moid_post_with_http_info(moid, body, **kwargs)
            return data

    def externalsite_authorizations_moid_post_with_http_info(self, moid, body, **kwargs):
        """
        Update an instance of externalsiteAuthorization
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.externalsite_authorizations_moid_post_with_http_info(moid, body, callback=callback_function)
    ...
    def externalsite_authorizations_post(self, body, **kwargs):
        """
        Create a externalsiteAuthorization
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        >>> def callback_function(response):
        >>>     pprint(response)
        >>>
        >>> thread = api.externalsite_authorizations_post(body, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.externalsite_authorizations_post_with_http_info(body, **kwargs)
        else:
            (data) = self.externalsite_authorizations_post_with_http_info(body, **kwargs)
            return data

    def externalsite_authorizations_post_with_http_info(self, body, **kwargs):
        """
        Create a externalsiteAuthorization
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.externalsite_authorizations_post_with_http_info(body, callback=callback_function)
