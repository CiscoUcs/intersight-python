...
class IamDomainGroupApi(object):
    ...
    def iam_domain_groups_moid_get(self, moid, **kwargs):
        """
        Read a 'iam.DomainGroup' resource.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.iam_domain_groups_moid_get(moid, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.iam_domain_groups_moid_get_with_http_info(moid, **kwargs)
        else:
            (data) = self.iam_domain_groups_moid_get_with_http_info(moid, **kwargs)
            return data

    def iam_domain_groups_moid_get_with_http_info(self, moid, **kwargs):
        """
        Read a 'iam.DomainGroup' resource.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.iam_domain_groups_moid_get_with_http_info(moid, callback=callback_function)
