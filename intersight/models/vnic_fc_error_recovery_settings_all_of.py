...
class VnicFcErrorRecoverySettingsAllOf(object):
    ...
    def __init__(self,
        ...
        """VnicFcErrorRecoverySettingsAllOf - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def enabled(self):
        """Gets the enabled of this VnicFcErrorRecoverySettingsAllOf.  # noqa: E501

        Enables Fibre Channel Error recovery.    # noqa: E501

        :return: The enabled of this VnicFcErrorRecoverySettingsAllOf.  # noqa: E501
        :rtype: bool
        """
    ...
    def enabled(self, enabled):
        """Sets the enabled of this VnicFcErrorRecoverySettingsAllOf.

        Enables Fibre Channel Error recovery.    # noqa: E501

        :param enabled: The enabled of this VnicFcErrorRecoverySettingsAllOf.  # noqa: E501
        :type: bool
        """
    ...
    def io_retry_count(self):
        """Gets the io_retry_count of this VnicFcErrorRecoverySettingsAllOf.  # noqa: E501
        ...
        :return: The io_retry_count of this VnicFcErrorRecoverySettingsAllOf.  # noqa: E501
        :rtype: int
        """
    ...
    def io_retry_count(self, io_retry_count):
        """Sets the io_retry_count of this VnicFcErrorRecoverySettingsAllOf.

        The number of times an I/O request to a port is retried because the port is busy before the system decides the port is unavailable.    # noqa: E501

        :param io_retry_count: The io_retry_count of this VnicFcErrorRecoverySettingsAllOf.  # noqa: E501
        :type: int
        """
    ...
    def io_retry_timeout(self):
        """Gets the io_retry_timeout of this VnicFcErrorRecoverySettingsAllOf.  # noqa: E501

        The number of seconds the adapter waits before aborting the pending command and resending the same IO request.    # noqa: E501

        :return: The io_retry_timeout of this VnicFcErrorRecoverySettingsAllOf.  # noqa: E501
        :rtype: int
        """
    ...
    def io_retry_timeout(self, io_retry_timeout):
        """Sets the io_retry_timeout of this VnicFcErrorRecoverySettingsAllOf.

        The number of seconds the adapter waits before aborting the pending command and resending the same IO request.    # noqa: E501

        :param io_retry_timeout: The io_retry_timeout of this VnicFcErrorRecoverySettingsAllOf.  # noqa: E501
        :type: int
        """
    ...
    def link_down_timeout(self):
        """Gets the link_down_timeout of this VnicFcErrorRecoverySettingsAllOf.  # noqa: E501
        ...
        :return: The link_down_timeout of this VnicFcErrorRecoverySettingsAllOf.  # noqa: E501
        :rtype: int
        """
    ...
    def link_down_timeout(self, link_down_timeout):
        """Sets the link_down_timeout of this VnicFcErrorRecoverySettingsAllOf.

        The number of milliseconds the port should actually be down before it is marked down and fabric connectivity is lost.    # noqa: E501

        :param link_down_timeout: The link_down_timeout of this VnicFcErrorRecoverySettingsAllOf.  # noqa: E501
        :type: int
        """
    ...
    def port_down_timeout(self):
        """Gets the port_down_timeout of this VnicFcErrorRecoverySettingsAllOf.  # noqa: E501
        ...
        :return: The port_down_timeout of this VnicFcErrorRecoverySettingsAllOf.  # noqa: E501
        :rtype: int
        """
    ...
    def port_down_timeout(self, port_down_timeout):
        """Sets the port_down_timeout of this VnicFcErrorRecoverySettingsAllOf.

        The number of milliseconds a remote Fibre Channel port should be offline before informing the SCSI upper layer that the port is unavailable. For a server with a VIC adapter running ESXi, the recommended value is 10000. For a server with a port used to boot a Windows OS from the SAN, the recommended value is 5000 milliseconds.     # noqa: E501

        :param port_down_timeout: The port_down_timeout of this VnicFcErrorRecoverySettingsAllOf.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VnicFcErrorRecoverySettingsAllOf):
            return False
