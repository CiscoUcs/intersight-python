...
class FeedbackFeedbackData(object):
    ...
    def __init__(self, object_type=None, account_name=None, comment=None, email=None, evaluation='Excellent', follow_up=None, trace_ids=None, type='Evaluation'):
        """
    ...
    def object_type(self):
        """
        Gets the object_type of this FeedbackFeedbackData.
        The concrete type of this complex type.  The ObjectType property must be set explicitly by API clients when the type is ambiguous. In all other cases, the  ObjectType is optional.  The type is ambiguous when a managed object contains an array of nested documents, and the documents in the array are heterogeneous, i.e. the array can contain nested documents of different types.    

        :return: The object_type of this FeedbackFeedbackData.
        :rtype: str
        """
    ...
    def object_type(self, object_type):
        """
        Sets the object_type of this FeedbackFeedbackData.
        The concrete type of this complex type.  The ObjectType property must be set explicitly by API clients when the type is ambiguous. In all other cases, the  ObjectType is optional.  The type is ambiguous when a managed object contains an array of nested documents, and the documents in the array are heterogeneous, i.e. the array can contain nested documents of different types.    

        :param object_type: The object_type of this FeedbackFeedbackData.
        :type: str
        """
    ...
    def account_name(self):
        """
        Gets the account_name of this FeedbackFeedbackData.
        Account name of the feedback sender. Copied in order to be persisted in case of account removal.  

        :return: The account_name of this FeedbackFeedbackData.
        :rtype: str
        """
    ...
    def account_name(self, account_name):
        ...
        :param account_name: The account_name of this FeedbackFeedbackData.
        :type: str
        """
