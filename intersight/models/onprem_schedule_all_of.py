...
class OnpremScheduleAllOf(object):
    ...
    def __init__(self,
        ...
        """OnpremScheduleAllOf - a model defined in OpenAPI"""  # noqa: E501
    ...
    def day_of_month(self):
        """Gets the day_of_month of this OnpremScheduleAllOf.  # noqa: E501

        Schedule a task on a specific day of the month. Valid values are 1 through 31. If monthOfYear is specified, then dayOfMonth value must be valid for that month. DayOfMonth may not be set when dayOfWeek is specfied.    # noqa: E501

        :return: The day_of_month of this OnpremScheduleAllOf.  # noqa: E501
        :rtype: int
        """
    ...
    def day_of_month(self, day_of_month):
        """Sets the day_of_month of this OnpremScheduleAllOf.

        Schedule a task on a specific day of the month. Valid values are 1 through 31. If monthOfYear is specified, then dayOfMonth value must be valid for that month. DayOfMonth may not be set when dayOfWeek is specfied.    # noqa: E501

        :param day_of_month: The day_of_month of this OnpremScheduleAllOf.  # noqa: E501
        :type: int
        """
    ...
    def day_of_week(self):
        """Gets the day_of_week of this OnpremScheduleAllOf.  # noqa: E501

        Schedule a task on a specific day of the week. Valid values are 1 through 7, with 1 being Sunday. DayOfWeek may not be specfied when dayOfMonth is specified.    # noqa: E501

        :return: The day_of_week of this OnpremScheduleAllOf.  # noqa: E501
        :rtype: int
        """
    ...
    def day_of_week(self, day_of_week):
        """Sets the day_of_week of this OnpremScheduleAllOf.

        Schedule a task on a specific day of the week. Valid values are 1 through 7, with 1 being Sunday. DayOfWeek may not be specfied when dayOfMonth is specified.    # noqa: E501

        :param day_of_week: The day_of_week of this OnpremScheduleAllOf.  # noqa: E501
        :type: int
        """
    ...
    def month_of_year(self):
        """Gets the month_of_year of this OnpremScheduleAllOf.  # noqa: E501

        Schedule a task on a specific month of the year. Valid values are 1 through 12, with 1 being January.    # noqa: E501

        :return: The month_of_year of this OnpremScheduleAllOf.  # noqa: E501
        :rtype: int
        """
    ...
    def month_of_year(self, month_of_year):
        """Sets the month_of_year of this OnpremScheduleAllOf.

        Schedule a task on a specific month of the year. Valid values are 1 through 12, with 1 being January.    # noqa: E501

        :param month_of_year: The month_of_year of this OnpremScheduleAllOf.  # noqa: E501
        :type: int
        """
    ...
    def repeat_interval(self):
        """Gets the repeat_interval of this OnpremScheduleAllOf.  # noqa: E501

        Schedule a task to run periodically at an interval. Default unit of the RepeatInterval is in minutes. If the RepeateInterval value is set, then all other properties are ignored by the scheduler. RepeateInterval constraints are enforced by the services that use the schedule. Each service has pre-configured service specific properties for enforcing minimum and maximum values of the RepeatInterval.    # noqa: E501

        :return: The repeat_interval of this OnpremScheduleAllOf.  # noqa: E501
        :rtype: int
        """
    ...
    def repeat_interval(self, repeat_interval):
        """Sets the repeat_interval of this OnpremScheduleAllOf.

        Schedule a task to run periodically at an interval. Default unit of the RepeatInterval is in minutes. If the RepeateInterval value is set, then all other properties are ignored by the scheduler. RepeateInterval constraints are enforced by the services that use the schedule. Each service has pre-configured service specific properties for enforcing minimum and maximum values of the RepeatInterval.    # noqa: E501

        :param repeat_interval: The repeat_interval of this OnpremScheduleAllOf.  # noqa: E501
        :type: int
        """
    ...
    def time_of_day(self):
        """Gets the time_of_day of this OnpremScheduleAllOf.  # noqa: E501

        Time of the day in seconds. TimeOfDay is required for all schedule configurations, except when the RepeateInterval field is specified.    # noqa: E501

        :return: The time_of_day of this OnpremScheduleAllOf.  # noqa: E501
        :rtype: int
        """
    ...
    def time_of_day(self, time_of_day):
        """Sets the time_of_day of this OnpremScheduleAllOf.

        Time of the day in seconds. TimeOfDay is required for all schedule configurations, except when the RepeateInterval field is specified.    # noqa: E501

        :param time_of_day: The time_of_day of this OnpremScheduleAllOf.  # noqa: E501
        :type: int
        """
    ...
    @property
    def time_zone(self):
        """Gets the time_zone of this OnpremScheduleAllOf.  # noqa: E501

        Timezone to use for the schedule calculation. If a timezone value is not speficied, then the schedule calculation will be based on UTC.    # noqa: E501

        :return: The time_zone of this OnpremScheduleAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def time_zone(self, time_zone):
        """Sets the time_zone of this OnpremScheduleAllOf.

        Timezone to use for the schedule calculation. If a timezone value is not speficied, then the schedule calculation will be based on UTC.    # noqa: E501

        :param time_zone: The time_zone of this OnpremScheduleAllOf.  # noqa: E501
        :type: str
        """
        allowed_values = [
    ...
    def week_of_month(self):
        """Gets the week_of_month of this OnpremScheduleAllOf.  # noqa: E501

        Schedule a task on a specific week of the month. Valid values are 1 through 5. Value of 5 means last week of the month. WeekOfMonth may not be set when dayOfMonth is specified.     # noqa: E501

        :return: The week_of_month of this OnpremScheduleAllOf.  # noqa: E501
        :rtype: int
        """
    ...
    def week_of_month(self, week_of_month):
        """Sets the week_of_month of this OnpremScheduleAllOf.

        Schedule a task on a specific week of the month. Valid values are 1 through 5. Value of 5 means last week of the month. WeekOfMonth may not be set when dayOfMonth is specified.     # noqa: E501

        :param week_of_month: The week_of_month of this OnpremScheduleAllOf.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OnpremScheduleAllOf):
            return False
