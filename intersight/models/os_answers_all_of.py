...
class OsAnswersAllOf(object):
    ...
    def __init__(self,
        ...
        """OsAnswersAllOf - a model defined in OpenAPI"""  # noqa: E501
    ...
    def is_answer_file_set(self):
        """Gets the is_answer_file_set of this OsAnswersAllOf.  # noqa: E501

        Indicates whether the value of the 'answerFile' property has been set.    # noqa: E501

        :return: The is_answer_file_set of this OsAnswersAllOf.  # noqa: E501
        :rtype: bool
        """
    ...
    def is_answer_file_set(self, is_answer_file_set):
        """Sets the is_answer_file_set of this OsAnswersAllOf.

        Indicates whether the value of the 'answerFile' property has been set.    # noqa: E501

        :param is_answer_file_set: The is_answer_file_set of this OsAnswersAllOf.  # noqa: E501
        :type: bool
        """
    ...
    def answer_file(self):
        """Gets the answer_file of this OsAnswersAllOf.  # noqa: E501
        ...
        :return: The answer_file of this OsAnswersAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def answer_file(self, answer_file):
        """Sets the answer_file of this OsAnswersAllOf.

        If the source of the answers is a static file, the content of the file is stored as value in this property.  The value is mandatory only when the 'Source' property has been set to 'File'.     # noqa: E501

        :param answer_file: The answer_file of this OsAnswersAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def hostname(self):
        """Gets the hostname of this OsAnswersAllOf.  # noqa: E501

        Hostname to be configured for the server in the OS.     # noqa: E501

        :return: The hostname of this OsAnswersAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def hostname(self, hostname):
        """Sets the hostname of this OsAnswersAllOf.

        Hostname to be configured for the server in the OS.     # noqa: E501

        :param hostname: The hostname of this OsAnswersAllOf.  # noqa: E501
        :type: str
        """
    ...
    def ip_config_type(self):
        """Gets the ip_config_type of this OsAnswersAllOf.  # noqa: E501
        ...
        :return: The ip_config_type of this OsAnswersAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def ip_config_type(self, ip_config_type):
        """Sets the ip_config_type of this OsAnswersAllOf.

        IP configuration type. Values are Static or Dynamic configuration of IP.  In case of static IP configuration, IP address, gateway and other details need to be populated. In case of dynamic the IP configuration is obtained dynamically from DHCP.     # noqa: E501

        :param ip_config_type: The ip_config_type of this OsAnswersAllOf.  # noqa: E501
        :type: str
        """
    ...
    def ip_v4_config(self):
        """Gets the ip_v4_config of this OsAnswersAllOf.  # noqa: E501


        :return: The ip_v4_config of this OsAnswersAllOf.  # noqa: E501
    ...
    def ip_v4_config(self, ip_v4_config):
        """Sets the ip_v4_config of this OsAnswersAllOf.


        :param ip_v4_config: The ip_v4_config of this OsAnswersAllOf.  # noqa: E501
    ...
    def is_root_password_set(self):
        """Gets the is_root_password_set of this OsAnswersAllOf.  # noqa: E501


        :return: The is_root_password_set of this OsAnswersAllOf.  # noqa: E501
        :rtype: bool
        """
    ...
    def is_root_password_set(self, is_root_password_set):
        """Sets the is_root_password_set of this OsAnswersAllOf.


        :param is_root_password_set: The is_root_password_set of this OsAnswersAllOf.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def nameserver(self):
        """Gets the nameserver of this OsAnswersAllOf.  # noqa: E501

        IP address of the name server to be configured in the OS.     # noqa: E501

        :return: The nameserver of this OsAnswersAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def nameserver(self, nameserver):
        """Sets the nameserver of this OsAnswersAllOf.

        IP address of the name server to be configured in the OS.     # noqa: E501

        :param nameserver: The nameserver of this OsAnswersAllOf.  # noqa: E501
        :type: str
        """
    ...
    def product_key(self):
        """Gets the product_key of this OsAnswersAllOf.  # noqa: E501

        The product key to be used for a specific version of Windows installation.     # noqa: E501

        :return: The product_key of this OsAnswersAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def product_key(self, product_key):
        """Sets the product_key of this OsAnswersAllOf.

        The product key to be used for a specific version of Windows installation.     # noqa: E501

        :param product_key: The product_key of this OsAnswersAllOf.  # noqa: E501
        :type: str
        """
    ...
    def root_password(self):
        """Gets the root_password of this OsAnswersAllOf.  # noqa: E501

        Password to be configured for the root / administrator user in the OS.     # noqa: E501

        :return: The root_password of this OsAnswersAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def root_password(self, root_password):
        """Sets the root_password of this OsAnswersAllOf.

        Password to be configured for the root / administrator user in the OS.     # noqa: E501

        :param root_password: The root_password of this OsAnswersAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def source(self):
        """Gets the source of this OsAnswersAllOf.  # noqa: E501
        ...
        :return: The source of this OsAnswersAllOf.  # noqa: E501
        :rtype: str
        """
        return self._source
    ...
    def source(self, source):
        """Sets the source of this OsAnswersAllOf.

        Answer values can be provided from three sources - Embedded in OS image, static file, or as placeholder values for an answer file template.  Source of the answers is given as value, Embedded/File/Template. 'Embedded' option indicates that the answer file is embedded within the OS Image. 'File' option indicates that the answers are provided as a file. 'Template' indicates that the placeholders in the selected os.ConfigurationFile MO are replaced with values provided as os.Answers MO.      # noqa: E501

        :param source: The source of this OsAnswersAllOf.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OsAnswersAllOf):
            return False
