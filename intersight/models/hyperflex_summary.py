...
class HyperflexSummary(object):
    ...
    swagger_types = {
        ...
        'downtime': 'str',
        'free_capacity': 'int',
        'healing_info': 'HyperflexOptionalStPlatformClusterHealingInfo',
        'name': 'str',
        'resiliency_details': 'object',
        'resiliency_details_size': 'int',
        'resiliency_info': 'HyperflexOptionalStPlatformClusterResiliencyInfo',
        'space_status': 'str',
        'state': 'str',
        'total_capacity': 'int',
        'total_savings': 'float',
    ...
    def object_type(self):
        """
        Gets the object_type of this HyperflexSummary.
        The concrete type of this complex type.  The ObjectType property must be set explicitly by API clients when the type is ambiguous. In all other cases, the  ObjectType is optional.  The type is ambiguous when a managed object contains an array of nested documents, and the documents in the array are heterogeneous, i.e. the array can contain nested documents of different types.    

        :return: The object_type of this HyperflexSummary.
        :rtype: str
        """
    ...
    def object_type(self, object_type):
        """
        Sets the object_type of this HyperflexSummary.
        The concrete type of this complex type.  The ObjectType property must be set explicitly by API clients when the type is ambiguous. In all other cases, the  ObjectType is optional.  The type is ambiguous when a managed object contains an array of nested documents, and the documents in the array are heterogeneous, i.e. the array can contain nested documents of different types.    

        :param object_type: The object_type of this HyperflexSummary.
        :type: str
        """
    ...
    def healing_info(self):
        ...
        :rtype: HyperflexOptionalStPlatformClusterHealingInfo
        """
    ...
    def healing_info(self, healing_info):
        ...
        :type: HyperflexOptionalStPlatformClusterHealingInfo
        """
    ...
    def resiliency_info(self):
        ...
        :rtype: HyperflexOptionalStPlatformClusterResiliencyInfo
        """
    ...
    def resiliency_info(self, resiliency_info):
        ...
        :type: HyperflexOptionalStPlatformClusterResiliencyInfo
        """
