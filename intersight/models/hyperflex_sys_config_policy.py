...
class HyperflexSysConfigPolicy(object):
    ...
    def __init__(self, account_moid=None, ancestors=None, create_time=None, mod_time=None, moid=None, object_type=None, owners=None, parent=None, tags=None, description=None, name=None, account=None, cluster_profiles=None, dns_servers=None, ntp_servers=None, timezone=None):
        """
    ...
    def account(self):
        """
        Gets the account of this HyperflexSysConfigPolicy.

        :return: The account of this HyperflexSysConfigPolicy.
        :rtype: MoMoRef
        """
    ...
    def account(self, account):
        """
        Sets the account of this HyperflexSysConfigPolicy.

        :param account: The account of this HyperflexSysConfigPolicy.
        :type: MoMoRef
        """
