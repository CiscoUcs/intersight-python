...
class HyperflexVcenterConfigPolicy(object):
    ...
    def __init__(self, account_moid=None, ancestors=None, create_time=None, mod_time=None, moid=None, object_type=None, owners=None, parent=None, tags=None, version_context=None, description=None, name=None, cluster_profiles=None, data_center=None, hostname=None, is_password_set=None, organization=None, password=None, sso_url=None, username=None):
        """
    ...
    def password(self):
        ...
        vCenter password must be atleast 6 characters. Follow the corresponding password policy governed by vCenter.  
