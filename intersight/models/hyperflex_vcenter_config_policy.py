...
class HyperflexVcenterConfigPolicy(object):
    ...
    def __init__(self, account_moid=None, create_time=None, domain_group_moid=None, mod_time=None, moid=None, object_type=None, owners=None, shared_scope=None, tags=None, version_context=None, ancestors=None, parent=None, permission_resources=None, description=None, name=None, data_center=None, hostname=None, is_password_set=None, password=None, sso_url=None, username=None, cluster_profiles=None, organization=None):
        """
    ...
    def domain_group_moid(self):
        """
        Gets the domain_group_moid of this HyperflexVcenterConfigPolicy.
        The DomainGroup ID for this managed object.

        :return: The domain_group_moid of this HyperflexVcenterConfigPolicy.
        :rtype: str
        """
    ...
    def domain_group_moid(self, domain_group_moid):
        """
        Sets the domain_group_moid of this HyperflexVcenterConfigPolicy.
        The DomainGroup ID for this managed object.

        :param domain_group_moid: The domain_group_moid of this HyperflexVcenterConfigPolicy.
        :type: str
        """
    ...
    def shared_scope(self):
        """
        Gets the shared_scope of this HyperflexVcenterConfigPolicy.
        Intersight provides pre-built workflows, tasks and policies to end users through global catalogs. Objects that are made available through global catalogs are said to have a 'shared' ownership. Shared objects are either made globally available to all end users or restricted to end users based on their license entitlement. Users can use this property to differentiate the scope (global or a specific license tier) to which a shared MO belongs.

        :return: The shared_scope of this HyperflexVcenterConfigPolicy.
        :rtype: str
        """
    ...
    def shared_scope(self, shared_scope):
        """
        Sets the shared_scope of this HyperflexVcenterConfigPolicy.
        Intersight provides pre-built workflows, tasks and policies to end users through global catalogs. Objects that are made available through global catalogs are said to have a 'shared' ownership. Shared objects are either made globally available to all end users or restricted to end users based on their license entitlement. Users can use this property to differentiate the scope (global or a specific license tier) to which a shared MO belongs.

        :param shared_scope: The shared_scope of this HyperflexVcenterConfigPolicy.
        :type: str
        """
    ...
    def version_context(self):
        """
        Gets the version_context of this HyperflexVcenterConfigPolicy.
        The versioning info for this managed object.

        :return: The version_context of this HyperflexVcenterConfigPolicy.
    ...
    def version_context(self, version_context):
        """
        Sets the version_context of this HyperflexVcenterConfigPolicy.
        The versioning info for this managed object.

        :param version_context: The version_context of this HyperflexVcenterConfigPolicy.
    ...
    def permission_resources(self):
        """
        Gets the permission_resources of this HyperflexVcenterConfigPolicy.
        ...
        :return: The permission_resources of this HyperflexVcenterConfigPolicy.
        :rtype: list[MoBaseMoRef]
        """
    ...
    def permission_resources(self, permission_resources):
        """
        Sets the permission_resources of this HyperflexVcenterConfigPolicy.
        A slice of all permission resources (organizations) associated with this object. Permission ties resources and its associated roles/privileges. These resources which can be specified in a permission is PermissionResource. Currently only organizations can be specified in permission. All logical and physical resources part of an organization will have organization in PermissionResources field. If DeviceRegistration contains another DeviceRegistration and if parent is in org1 and child is part of org2, then child objects will have PermissionResources as org1 and org2. Parent Objects will have PermissionResources as org1. All profiles/policies created with in an organization will have the organization as PermissionResources.

        :param permission_resources: The permission_resources of this HyperflexVcenterConfigPolicy.
        :type: list[MoBaseMoRef]
        """
    ...
    def is_password_set(self):
        """
        Gets the is_password_set of this HyperflexVcenterConfigPolicy.

        :return: The is_password_set of this HyperflexVcenterConfigPolicy.
        :rtype: bool
        """
    ...
    def is_password_set(self, is_password_set):
        """
        Sets the is_password_set of this HyperflexVcenterConfigPolicy.

        :param is_password_set: The is_password_set of this HyperflexVcenterConfigPolicy.
        :type: bool
        """
    ...
    def password(self):
        """
        Gets the password of this HyperflexVcenterConfigPolicy.
        The password for authenticating with vCenter. Follow the corresponding password policy governed by vCenter.

        :return: The password of this HyperflexVcenterConfigPolicy.
        :rtype: str
        """
    ...
    def password(self, password):
        """
        Sets the password of this HyperflexVcenterConfigPolicy.
        The password for authenticating with vCenter. Follow the corresponding password policy governed by vCenter.

        :param password: The password of this HyperflexVcenterConfigPolicy.
        :type: str
        """
    ...
    def username(self):
        """
        Gets the username of this HyperflexVcenterConfigPolicy.
        The vCenter username (e.g. administrator@vsphere.local).

        :return: The username of this HyperflexVcenterConfigPolicy.
        :rtype: str
        """
    ...
    def username(self, username):
        """
        Sets the username of this HyperflexVcenterConfigPolicy.
        The vCenter username (e.g. administrator@vsphere.local).

        :param username: The username of this HyperflexVcenterConfigPolicy.
        :type: str
        """
    ...
    def organization(self):
        """
        Gets the organization of this HyperflexVcenterConfigPolicy.
        Relationship to the Organization that owns the Managed Object.

        :return: The organization of this HyperflexVcenterConfigPolicy.
    ...
    def organization(self, organization):
        """
        Sets the organization of this HyperflexVcenterConfigPolicy.
        Relationship to the Organization that owns the Managed Object.

        :param organization: The organization of this HyperflexVcenterConfigPolicy.
