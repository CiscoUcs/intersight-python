...
class ApplianceUpgrade(object):
    ...
    def __init__(self, account_moid=None, ancestors=None, create_time=None, domain_group_moid=None, mod_time=None, moid=None, object_type=None, owners=None, parent=None, shared_scope=None, tags=None, version_context=None, account=None, active=None, auto_created=None, completed_phases=None, current_phase=None, description=None, elapsed_time=None, end_time=None, fingerprint=None, image_bundle=None, messages=None, services=None, start_time=None, status=None, ui_packages=None, version=None):
        """
