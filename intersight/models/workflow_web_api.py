...
class WorkflowWebApi(object):
    ...
    def __init__(self, object_type=None, body=None, content_type='json', name=None, outcomes=None, response_spec=None, skip_on_condition=None, timeout=None, endpoint_request_type='Internal', headers=None, method=None, protocol=None, target_type='Endpoint', url=None):
        """
        ...
        self._timeout = None
        self._endpoint_request_type = None
        self._headers = None
        self._method = None
        self._protocol = None
        ...
        if endpoint_request_type is not None:
          self.endpoint_request_type = endpoint_request_type
    ...
    @property
    def endpoint_request_type(self):
        """
        Gets the endpoint_request_type of this WorkflowWebApi.
        ...
        :return: The endpoint_request_type of this WorkflowWebApi.
        :rtype: str
        """
        return self._endpoint_request_type

    @endpoint_request_type.setter
    def endpoint_request_type(self, endpoint_request_type):
        """
        Sets the endpoint_request_type of this WorkflowWebApi.
        If the target type is Endpoint, this property determines whether the request is to be handled as internal request or external request by the device connector.

        :param endpoint_request_type: The endpoint_request_type of this WorkflowWebApi.
        :type: str
        """
        allowed_values = ["Internal", "External"]
        if endpoint_request_type not in allowed_values:
            raise ValueError(
                "Invalid value for `endpoint_request_type` ({0}), must be one of {1}"
                .format(endpoint_request_type, allowed_values)
            )

        self._endpoint_request_type = endpoint_request_type
