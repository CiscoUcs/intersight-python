...
class WorkflowXmlApi(object):
    ...
    swagger_types = {
        ...
        'name': 'str',
        'outcomes': 'object',
        'response_spec': 'ContentOptionalGrammar',
    ...
    def __init__(self, object_type=None, body=None, content_type='json', name=None, outcomes=None, response_spec=None, skip_on_condition=None, timeout=None):
        """
        WorkflowXmlApi - a model defined in Swagger
        """
    ...
    def object_type(self):
        """
        Gets the object_type of this WorkflowXmlApi.
        The concrete type of this complex type.  The ObjectType property must be set explicitly by API clients when the type is ambiguous. In all other cases, the  ObjectType is optional.  The type is ambiguous when a managed object contains an array of nested documents, and the documents in the array are heterogeneous, i.e. the array can contain nested documents of different types.    

        :return: The object_type of this WorkflowXmlApi.
        :rtype: str
        """
    ...
    def object_type(self, object_type):
        """
        Sets the object_type of this WorkflowXmlApi.
        The concrete type of this complex type.  The ObjectType property must be set explicitly by API clients when the type is ambiguous. In all other cases, the  ObjectType is optional.  The type is ambiguous when a managed object contains an array of nested documents, and the documents in the array are heterogeneous, i.e. the array can contain nested documents of different types.    

        :param object_type: The object_type of this WorkflowXmlApi.
        :type: str
        """
    ...
    def body(self):
        """
        Gets the body of this WorkflowXmlApi.
        ...
        :return: The body of this WorkflowXmlApi.
        :rtype: str
        """
        return self._body
    ...
    def body(self, body):
        """
        Sets the body of this WorkflowXmlApi.
        The optional request body that is sent as part of this API request.  The request body can contain a golang template that can be populated with task input parameters and previous API output parameters.   

        :param body: The body of this WorkflowXmlApi.
        :type: str
        """
    ...
    def content_type(self):
        """
        Gets the content_type of this WorkflowXmlApi.
        ...
        :return: The content_type of this WorkflowXmlApi.
        :rtype: str
        """
    ...
    def content_type(self, content_type):
        """
        Sets the content_type of this WorkflowXmlApi.
        Intersight Orchestrator, with the support of response parser specification, can extract the values from API responses and map them to task output parameters. The value extraction is supported for response content types XML and JSON.  The type of the content that gets passed as payload and response in this API.   

        :param content_type: The content_type of this WorkflowXmlApi.
        :type: str
        """
    ...
    def name(self):
        """
        Gets the name of this WorkflowXmlApi.
        ...
        :return: The name of this WorkflowXmlApi.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this WorkflowXmlApi.
        A reference name for this API request within the batch API request.  This name shall be used to map the API output parameters to subsequent API input parameters within a batch API task.   

        :param name: The name of this WorkflowXmlApi.
        :type: str
        """
    ...
    def outcomes(self):
        """
        Gets the outcomes of this WorkflowXmlApi.
        ...
        :return: The outcomes of this WorkflowXmlApi.
        :rtype: object
        """
    ...
    def outcomes(self, outcomes):
        """
        Sets the outcomes of this WorkflowXmlApi.
        All the possible outcomes of this API are captured here. Outcomes property is a collection property of type workflow.Outcome objects.  The outcomes can be mapped to the message to be shown. The outcomes are evaluated in the order they are given. At the end of the outcomes list, an catchall success/fail outcome can be added with condition as 'true'.  This is an optional property and if not specified the task will be marked as success.   

        :param outcomes: The outcomes of this WorkflowXmlApi.
        :type: object
        """
    ...
    def response_spec(self):
        """
        Gets the response_spec of this WorkflowXmlApi.
        ...
        :return: The response_spec of this WorkflowXmlApi.
        :rtype: ContentOptionalGrammar
        """
    ...
    def response_spec(self, response_spec):
        """
        Sets the response_spec of this WorkflowXmlApi.
        The optional grammar specification for parsing the response to extract the required values.  The specification should have extraction specification specified for all the API output parameters.   

        :param response_spec: The response_spec of this WorkflowXmlApi.
        :type: ContentOptionalGrammar
        """
    ...
    def skip_on_condition(self):
        """
        Gets the skip_on_condition of this WorkflowXmlApi.
        ...
        :return: The skip_on_condition of this WorkflowXmlApi.
        :rtype: str
        """
    ...
    def skip_on_condition(self, skip_on_condition):
        """
        Sets the skip_on_condition of this WorkflowXmlApi.
        The skip expression, if provided, allows the batch API executor to skip the api execution when the given expression evaluates to true.  The expression is given as such a golang template that has to be evaluated to a final content true/false. The expression is an optional and in case not provided, the API will always be executed.   

        :param skip_on_condition: The skip_on_condition of this WorkflowXmlApi.
        :type: str
        """
    ...
    def timeout(self):
        """
        Gets the timeout of this WorkflowXmlApi.
        ...
        :return: The timeout of this WorkflowXmlApi.
        :rtype: int
        """
    ...
    def timeout(self, timeout):
        """
        Sets the timeout of this WorkflowXmlApi.
        The duration in seconds by which the API response is expected from the API target.  If the end point does not respond for the API request within this timeout duration, the task will be marked as failed.    

        :param timeout: The timeout of this WorkflowXmlApi.
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, WorkflowXmlApi):
            return False
