...
class StoragePureHost(object):
    ...
    def __init__(self, account_moid=None, ancestors=None, create_time=None, domain_group_moid=None, mod_time=None, moid=None, object_type=None, owners=None, parent=None, shared_scope=None, tags=None, version_context=None, description=None, initiators=None, name=None, os_type=None, storage_array=None, host_group=None, host_group_name=None, host_names=None, hosts=None, registered_device=None, storage_utilization=None, type='Host'):
        """
