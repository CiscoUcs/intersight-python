...
class SoftwarerepositoryNfsServer(object):
    ...
    def __init__(self, object_type=None, mount_options=None, remote_file=None, remote_ip=None, remote_share=None):
        """
        SoftwarerepositoryNfsServer - a model defined in Swagger
        """
    ...
    def object_type(self):
        """
        Gets the object_type of this SoftwarerepositoryNfsServer.
        The concrete type of this complex type. The ObjectType property must be set explicitly by API clients when the type is ambiguous. In all other cases, the  ObjectType is optional.  The type is ambiguous when a managed object contains an array of nested documents, and the documents in the array are heterogeneous, i.e. the array can contain nested documents of different types.

        :return: The object_type of this SoftwarerepositoryNfsServer.
        :rtype: str
        """
    ...
    def object_type(self, object_type):
        """
        Sets the object_type of this SoftwarerepositoryNfsServer.
        The concrete type of this complex type. The ObjectType property must be set explicitly by API clients when the type is ambiguous. In all other cases, the  ObjectType is optional.  The type is ambiguous when a managed object contains an array of nested documents, and the documents in the array are heterogeneous, i.e. the array can contain nested documents of different types.

        :param object_type: The object_type of this SoftwarerepositoryNfsServer.
        :type: str
        """
    ...
    def mount_options(self):
        """
        Gets the mount_options of this SoftwarerepositoryNfsServer.
        ...
        :return: The mount_options of this SoftwarerepositoryNfsServer.
        :rtype: str
        """
    ...
    def mount_options(self, mount_options):
        ...
        :param mount_options: The mount_options of this SoftwarerepositoryNfsServer.
        :type: str
        """
    ...
    def remote_file(self):
        """
        Gets the remote_file of this SoftwarerepositoryNfsServer.
        Filename of the image in the NFS server. For example:ucs-c220m5-huu-3.1.2c.iso.

        :return: The remote_file of this SoftwarerepositoryNfsServer.
        :rtype: str
        """
    ...
    def remote_file(self, remote_file):
        ...
        :param remote_file: The remote_file of this SoftwarerepositoryNfsServer.
        :type: str
        """
    ...
    def remote_ip(self):
        """
        Gets the remote_ip of this SoftwarerepositoryNfsServer.
        Hostname or IP Address of the NFS server.

        :return: The remote_ip of this SoftwarerepositoryNfsServer.
        :rtype: str
        """
    ...
    def remote_ip(self, remote_ip):
        ...
        :param remote_ip: The remote_ip of this SoftwarerepositoryNfsServer.
        :type: str
        """
    ...
    def remote_share(self):
        """
        Gets the remote_share of this SoftwarerepositoryNfsServer.
        Remote directory where the image is present. For example:/share/subfolder.

        :return: The remote_share of this SoftwarerepositoryNfsServer.
        :rtype: str
        """
    ...
    def remote_share(self, remote_share):
        ...
        :param remote_share: The remote_share of this SoftwarerepositoryNfsServer.
        :type: str
        """
