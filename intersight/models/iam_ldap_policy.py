...
class IamLdapPolicy(object):
    ...
    def __init__(self, account_moid=None, ancestors=None, create_time=None, mod_time=None, moid=None, object_type=None, owners=None, parent=None, tags=None, description=None, name=None, base_properties=None, dns_parameters=None, enable_dns=None, enabled=None, groups=None, organization=None, profiles=None, providers=None, user_search_precedence='LocalUserDb'):
        """
    ...
    def enable_dns(self):
        ...
        DNS can be configured to access LDAP servers  
    ...
    def enabled(self):
        ...
        User authentication is performed by the LDAP servers specified in the LDAP policy  
    ...
    def user_search_precedence(self):
        ...
        User search precedence between local user database and LDAP user database   
