...
class IamLdapPolicy(object):
    ...
    def __init__(self, account_moid=None, ancestors=None, create_time=None, domain_group_moid=None, mod_time=None, moid=None, object_type=None, owners=None, parent=None, shared_scope=None, tags=None, version_context=None, description=None, name=None, base_properties=None, dns_parameters=None, enable_dns=None, enabled=None, groups=None, organization=None, profiles=None, providers=None, user_search_precedence='LocalUserDb'):
        """
