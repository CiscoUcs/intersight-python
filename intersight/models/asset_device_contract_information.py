...
class AssetDeviceContractInformation(object):
    ...
    def __init__(self, account_moid=None, ancestors=None, create_time=None, domain_group_moid=None, mod_time=None, moid=None, object_type=None, owners=None, parent=None, shared_scope=None, tags=None, version_context=None, contract=None, contract_status='Not Covered', covered_product_line_end_date=None, device_id=None, device_type='None', end_customer=None, end_user_global_ultimate=None, is_valid=None, item_type=None, maintenance_purchase_order_number=None, maintenance_sales_order_number=None, platform_type='null', product=None, purchase_order_number=None, registered_device=None, reseller_global_ultimate=None, sales_order_number=None, service_description=None, service_end_date=None, service_level=None, service_sku=None, service_start_date=None, warranty_end_date=None, warranty_type=None):
        """
