...
class VnicEthAdapterPolicy(object):
    ...
    def __init__(self, account_moid=None, ancestors=None, create_time=None, domain_group_moid=None, mod_time=None, moid=None, object_type=None, owners=None, parent=None, shared_scope=None, tags=None, version_context=None, description=None, name=None, advanced_filter=None, arfs_settings=None, completion_queue_settings=None, interrupt_settings=None, nvgre_settings=None, organization=None, roce_settings=None, rss_settings=None, rx_queue_settings=None, tcp_offload_settings=None, tx_queue_settings=None, vxlan_settings=None):
        """
