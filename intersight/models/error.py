...
class Error(object):
    ...
    def code(self):
        ...
        A value that is used to determine the nature of the error, and why it occurred.  # noqa: E501
    ...
    def code(self, code):
        ...
        if self.local_vars_configuration.client_side_validation and code is None:  # noqa: E501
            raise ValueError(
                "Invalid value for `code`, must not be `None`")  # noqa: E501
        allowed_values = [
            "InternalServerError", "InvalidMethod", "InvalidUrl",
            "InvalidRequest", "NotFound", "NotSupported", "NotImplemented",
            "AuthenticationFailure", "UnauthorizedOperation",
            "ValidationConflict", "ServiceUnavailable"
        ]  # noqa: E501
    ...
    def message_id(self):
        ...
        A language-independent identifier of the specific error message.  # noqa: E501
