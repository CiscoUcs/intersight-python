...
class StoragePureReplicationSchedule(object):
    ...
    def __init__(self, account_moid=None, ancestors=None, create_time=None, domain_group_moid=None, mod_time=None, moid=None, object_type=None, owners=None, parent=None, shared_scope=None, tags=None, version_context=None, frequency=None, name=None, protection_group=None, replication_time=None, retention_time=None, storage_array=None, daily_limit=None, registered_device=None, replication_blackout_intervals=None, snapshot_expiry_time=None):
        """
