...
class CondHclStatusAction(object):
    ...
    def __init__(self, account_moid=None, ancestors=None, create_time=None, mod_time=None, moid=None, object_type=None, owners=None, parent=None, tags=None, cimc_version=None, component=None, description=None, driver_name=None, driver_version=None, firmware_version=None, hcl_status_detail=None, model=None, type=None):
        """
        ...
        if cimc_version is not None:
          self.cimc_version = cimc_version
    ...
    @property
    def cimc_version(self):
        """
        Gets the cimc_version of this CondHclStatusAction.
        the recommended HCL cimcVersion version for the component. This could be the same version as the inventoried version, in this case the current cimc is already compliant and only the other non-compliant versions need to change  

        :return: The cimc_version of this CondHclStatusAction.
        :rtype: str
        """
        return self._cimc_version

    @cimc_version.setter
    def cimc_version(self, cimc_version):
        """
        Sets the cimc_version of this CondHclStatusAction.
        the recommended HCL cimcVersion version for the component. This could be the same version as the inventoried version, in this case the current cimc is already compliant and only the other non-compliant versions need to change  

        :param cimc_version: The cimc_version of this CondHclStatusAction.
        :type: str
        """

        self._cimc_version = cimc_version
    ...
    def driver_name(self):
        ...
        the current driver name of the component we are validating as found in the HCL data  
    ...
    def driver_version(self):
        ...
        the recommended HCL driver version for the component. This could be the same version as the inventoried version, in this case the current driver is already compliant and only the other non-compliant versions need to change  
    ...
    def firmware_version(self):
        ...
        the recommended HCL firmware version for the component. This could be the same version as the inventoried version, in this case the firmware is already compliant and only the other non-compliant versions need to change  
