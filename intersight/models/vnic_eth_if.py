...
class VnicEthIf(object):
    ...
    def __init__(self, account_moid=None, ancestors=None, create_time=None, domain_group_moid=None, mod_time=None, moid=None, object_type=None, owners=None, parent=None, shared_scope=None, tags=None, version_context=None, cdn=None, eth_adapter_policy=None, eth_network_policy=None, eth_qos_policy=None, lan_connectivity_policy=None, name=None, order=None, organization=None, placement=None, usnic_settings=None, vmq_settings=None):
        """
