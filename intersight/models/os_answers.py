...
class OsAnswers(object):
    ...
    def __init__(self, object_type=None, is_answer_file_set=None, answer_file=None, hostname=None, ip_config_type='static', ip_v4_config=None, is_root_password_crypted=None, is_root_password_set=None, nameserver=None, product_key=None, root_password=None, source='None'):
        """
        ...
        self._is_root_password_crypted = None
        ...
        if is_root_password_crypted is not None:
          self.is_root_password_crypted = is_root_password_crypted
    ...
    @property
    def is_root_password_crypted(self):
        """
        Gets the is_root_password_crypted of this OsAnswers.
        Enable to indicate Root Password provided is encrypted.

        :return: The is_root_password_crypted of this OsAnswers.
        :rtype: bool
        """
        return self._is_root_password_crypted

    @is_root_password_crypted.setter
    def is_root_password_crypted(self, is_root_password_crypted):
        """
        Sets the is_root_password_crypted of this OsAnswers.
        Enable to indicate Root Password provided is encrypted.

        :param is_root_password_crypted: The is_root_password_crypted of this OsAnswers.
        :type: bool
        """

        self._is_root_password_crypted = is_root_password_crypted
