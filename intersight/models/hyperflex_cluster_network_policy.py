...
class HyperflexClusterNetworkPolicy(object):
    ...
    swagger_types = {
        ...
        'name': 'str',
        'jumbo_frame': 'bool',
        'kvm_ip_range': 'HyperflexOptionalIpAddrRange',
        'mac_prefix_range': 'HyperflexOptionalMacAddrPrefixRange',
        'mgmt_vlan': 'HyperflexOptionalNamedVlan',
        'uplink_speed': 'str',
        'vm_migration_vlan': 'HyperflexOptionalNamedVlan',
        'vm_network_vlans': 'list[HyperflexOptionalNamedVlan]',
    ...
    def kvm_ip_range(self):
        ...
        :rtype: HyperflexOptionalIpAddrRange
        """
    ...
    def kvm_ip_range(self, kvm_ip_range):
        ...
        :type: HyperflexOptionalIpAddrRange
        """
    ...
    def mac_prefix_range(self):
        ...
        :rtype: HyperflexOptionalMacAddrPrefixRange
        """
    ...
    def mac_prefix_range(self, mac_prefix_range):
        ...
        :type: HyperflexOptionalMacAddrPrefixRange
        """
    ...
    def uplink_speed(self):
        ...
        Link speed of the server adapter port to the upstream switch. When the policy is attached to a cluster profile with EDGE management platform, the uplink speed can be '1G' or '10/25G'. When the policy is attached to a cluster profile with Fabric Interconnect management platform, the uplink speed can be 'default' only.  
    ...
    def vm_network_vlans(self):
        ...
        :rtype: list[HyperflexOptionalNamedVlan]
        """
    ...
    def vm_network_vlans(self, vm_network_vlans):
        ...
        :type: list[HyperflexOptionalNamedVlan]
        """
