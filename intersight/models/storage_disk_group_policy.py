...
class StorageDiskGroupPolicy(object):
    ...
    def __init__(self, account_moid=None, ancestors=None, create_time=None, mod_time=None, moid=None, object_type=None, owners=None, parent=None, tags=None, description=None, name=None, dedicated_hot_spares=None, encryption_state=None, organization=None, raid_level='Raid1', span_groups=None, use_jbods=None):
        """
    ...
    def encryption_state(self):
        """
        Gets the encryption_state of this StorageDiskGroupPolicy.
        Enables encryption of SEDs in the disk group if the encryption keys are configured in the Storage policy to which this disk group policy is associated.  

        :return: The encryption_state of this StorageDiskGroupPolicy.
        :rtype: bool
        """
    ...
    def encryption_state(self, encryption_state):
        """
        Sets the encryption_state of this StorageDiskGroupPolicy.
        Enables encryption of SEDs in the disk group if the encryption keys are configured in the Storage policy to which this disk group policy is associated.  

        :param encryption_state: The encryption_state of this StorageDiskGroupPolicy.
        :type: bool
        """
    ...
    def raid_level(self):
        ...
        The supported RAID level for the disk group. Accepted Values - Raid0, Raid1, Raid5, Raid6, Raid10, Raid50, Raid60.  
    ...
    def raid_level(self, raid_level):
        ...
        :type: str
        """
        allowed_values = ["Raid1", "Raid0", "Raid5", "Raid6", "Raid10", "Raid50", "Raid60"]
    ...
    def use_jbods(self):
        ...
        Disks selected in disk group which are in JBOD state will be set to Unconfigured Good state before being used in virtual drive creation.   
