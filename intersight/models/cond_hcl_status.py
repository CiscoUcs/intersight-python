...
class CondHclStatus(object):
    ...
    def __init__(self, account_moid=None, ancestors=None, create_time=None, domain_group_moid=None, mod_time=None, moid=None, object_type=None, owners=None, parent=None, shared_scope=None, tags=None, version_context=None, component_status='Incomplete', details=None, hardware_status='Incomplete', hcl_firmware_version=None, hcl_model=None, hcl_os_vendor=None, hcl_os_version=None, hcl_processor=None, inv_firmware_version=None, inv_model=None, inv_os_vendor=None, inv_os_version=None, inv_processor=None, managed_object=None, reason='Missing-Os-Info', registered_device=None, server_reason='Missing-Os-Driver-Info', software_status='Incomplete', status='Incomplete'):
        """
