...
class MetaDefinition(object):
    ...
    def __init__(self, account_moid=None, ancestors=None, create_time=None, domain_group_moid=None, mod_time=None, moid=None, object_type=None, owners=None, parent=None, shared_scope=None, tags=None, version_context=None, access_privileges=None, ancestor_classes=None, is_concrete=None, meta_type='ManagedObject', name=None, namespace=None, parent_class=None, properties=None, relationships=None, rest_path=None, version=None):
        """
