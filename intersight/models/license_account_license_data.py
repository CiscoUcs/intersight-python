...
class LicenseAccountLicenseData(object):
    ...
    def __init__(self, account_moid=None, create_time=None, domain_group_moid=None, mod_time=None, moid=None, object_type=None, owners=None, shared_scope=None, tags=None, version_context=None, ancestors=None, parent=None, permission_resources=None, account_id=None, agent_data=None, auth_expire_time=None, auth_initial_time=None, auth_next_time=None, category=None, default_license_type='Base', group=None, last_sync=None, last_updated_time=None, license_state=None, license_tech_support_info=None, register_expire_time=None, register_initial_time=None, register_next_time=None, registration_status=None, renew_failure_string=None, smart_account=None, sync_status=None, virtual_account=None, account=None, customer_op=None, licenseinfos=None, smartlicense_token=None):
        """
