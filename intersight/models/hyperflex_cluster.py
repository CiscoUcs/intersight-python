...
class HyperflexCluster(object):
    ...
    swagger_types = {
        ...
        'summary': 'HyperflexOptionalSummary',
    ...
    def summary(self):
        ...
        :rtype: HyperflexOptionalSummary
        """
