...
class VnicFcIf(object):
    ...
    def __init__(self, account_moid=None, ancestors=None, create_time=None, domain_group_moid=None, mod_time=None, moid=None, object_type=None, owners=None, parent=None, shared_scope=None, tags=None, version_context=None, fc_adapter_policy=None, fc_network_policy=None, fc_qos_policy=None, name=None, order=None, organization=None, persistent_bindings=None, placement=None, san_connectivity_policy=None, type='fc-initiator'):
        """
