...
class NiaapiNewReleaseDetail(object):
    ...
    def __init__(self, description=None, link=None, release_note_link=None, release_note_link_title=None, software_download_link=None, software_download_link_title=None, title=None, version=None):
        """
