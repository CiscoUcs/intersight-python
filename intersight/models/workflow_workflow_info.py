...
class WorkflowWorkflowInfo(object):
    ...
    swagger_types = {
        ...
        '_0_profile': 'ServerProfileRef',
        '_1_cluster_profile': 'HyperflexClusterProfileRef',
    ...
    attribute_map = {
        ...
        '_0_profile': '_0_Profile',
        '_1_cluster_profile': '_1_ClusterProfile',
        'account': 'Account',
    ...
    def __init__(self, account_moid=None, create_time=None, domain_group_moid=None, mod_time=None, moid=None, object_type=None, owners=None, shared_scope=None, tags=None, version_context=None, ancestors=None, parent=None, permission_resources=None, action='None', cleanup_time=None, end_time=None, failed_workflow_cleanup_duration=None, input=None, inst_id=None, internal=None, last_action='None', message=None, meta_version=None, name=None, output=None, progress=None, properties=None, retry_from_task_name=None, src=None, start_time=None, status=None, success_workflow_cleanup_duration=None, trace_id=None, type=None, user_id=None, wait_reason='None', workflow_ctx=None, workflow_meta_type='SystemDefined', workflow_task_count=None, _0_profile=None, _1_cluster_profile=None, account=None, organization=None, parent_task_info=None, pending_dynamic_workflow_info=None, permission=None, task_infos=None, workflow_definition=None):
        """
        ...
        self._retry_from_task_name = None
        self._src = None
        ...
        self.__0_profile = None
        self.__1_cluster_profile = None
        self._account = None
        ...
        if retry_from_task_name is not None:
          self.retry_from_task_name = retry_from_task_name
        if src is not None:
          self.src = src
        ...
        if _0_profile is not None:
          self._0_profile = _0_profile
        if _1_cluster_profile is not None:
          self._1_cluster_profile = _1_cluster_profile
    ...
    def last_action(self):
        """
        Gets the last_action of this WorkflowWorkflowInfo.
        The last action that was issued on the workflow is saved in this field.

        :return: The last_action of this WorkflowWorkflowInfo.
        :rtype: str
        """
    ...
    def last_action(self, last_action):
        """
        Sets the last_action of this WorkflowWorkflowInfo.
        The last action that was issued on the workflow is saved in this field.

        :param last_action: The last_action of this WorkflowWorkflowInfo.
        :type: str
        """
        allowed_values = ["None", "Create", "Start", "Pause", "Resume", "Retry", "RetryFailed", "Cancel"]
    ...
    def properties(self):
        """
        Gets the properties of this WorkflowWorkflowInfo.
        Type to capture all the properties for the workflow info passed on from workflow definition.

        :return: The properties of this WorkflowWorkflowInfo.
        :rtype: WorkflowWorkflowInfoProperties
        """
    ...
    def properties(self, properties):
        """
        Sets the properties of this WorkflowWorkflowInfo.
        Type to capture all the properties for the workflow info passed on from workflow definition.

        :param properties: The properties of this WorkflowWorkflowInfo.
    ...
    @property
    def retry_from_task_name(self):
        """
        Gets the retry_from_task_name of this WorkflowWorkflowInfo.
        ...
        :return: The retry_from_task_name of this WorkflowWorkflowInfo.
        :rtype: str
        """
        return self._retry_from_task_name

    @retry_from_task_name.setter
    def retry_from_task_name(self, retry_from_task_name):
        """
        Sets the retry_from_task_name of this WorkflowWorkflowInfo.
        This field is applicable when Retry action is issued for a workflow which is in a final state. When this field is not specified then the workflow will retry from the start of the workflow. When this field is specified then the workflow will be retried from the specified task. The field should carry the task name which is the unique name of the task within the workflow. The task name must be one of the tasks that completed or failed in the previous run, you cannot retry a workflow from a task which wasn't run in the previous iteration.

        :param retry_from_task_name: The retry_from_task_name of this WorkflowWorkflowInfo.
        :type: str
        """

        self._retry_from_task_name = retry_from_task_name
    ...
    def wait_reason(self, wait_reason):
        ...
        :type: str
        """
        allowed_values = ["None", "GatherTasks", "Duplicate", "RateLimit", "WaitTask", "PendingRetryFailed"]
    ...
    def _0_profile(self):
        """
        Gets the _0_profile of this WorkflowWorkflowInfo.
        ...
        :return: The _0_profile of this WorkflowWorkflowInfo.
        :rtype: ServerProfileRef
        """
        return self.__0_profile

    @_0_profile.setter
    def _0_profile(self, _0_profile):
        """
        Sets the _0_profile of this WorkflowWorkflowInfo.
        A collection of references to the [server.Profile](mo://server.Profile) Managed Object. When this managed object is deleted, the referenced [server.Profile](mo://server.Profile) MO unsets its reference to this deleted MO.

        :param _0_profile: The _0_profile of this WorkflowWorkflowInfo.
        :type: ServerProfileRef
        """

        self.__0_profile = _0_profile

    @property
    def _1_cluster_profile(self):
        """
        Gets the _1_cluster_profile of this WorkflowWorkflowInfo.
        ...
        :return: The _1_cluster_profile of this WorkflowWorkflowInfo.
        :rtype: HyperflexClusterProfileRef
        """
        return self.__1_cluster_profile

    @_1_cluster_profile.setter
    def _1_cluster_profile(self, _1_cluster_profile):
        """
        Sets the _1_cluster_profile of this WorkflowWorkflowInfo.
        A collection of references to the [hyperflex.ClusterProfile](mo://hyperflex.ClusterProfile) Managed Object. When this managed object is deleted, the referenced [hyperflex.ClusterProfile](mo://hyperflex.ClusterProfile) MO unsets its reference to this deleted MO.

        :param _1_cluster_profile: The _1_cluster_profile of this WorkflowWorkflowInfo.
        :type: HyperflexClusterProfileRef
        """

        self.__1_cluster_profile = _1_cluster_profile
