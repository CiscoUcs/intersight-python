...
class FirmwareRunningFirmware(object):
    ...
    def __init__(self, account_moid=None, ancestors=None, create_time=None, domain_group_moid=None, mod_time=None, moid=None, object_type=None, owners=None, parent=None, shared_scope=None, tags=None, version_context=None, device_mo_id=None, dn=None, rn=None, bios_unit=None, component=None, management_controller=None, network_elements=None, package_version=None, registered_device=None, storage_controller=None, storage_physical_disk=None, type=None, version=None):
        """
