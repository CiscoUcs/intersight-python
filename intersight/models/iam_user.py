...
class IamUser(object):
    ...
    def __init__(self, account_moid=None, create_time=None, domain_group_moid=None, mod_time=None, moid=None, object_type=None, owners=None, shared_scope=None, tags=None, version_context=None, ancestors=None, parent=None, permission_resources=None, client_ip_address=None, email=None, first_name=None, last_login_time=None, last_name=None, name=None, user_id_or_email=None, user_type=None, api_keys=None, app_registrations=None, idp=None, idpreference=None, local_user_password=None, oauth_tokens=None, permissions=None, sessions=None):
        """
    ...
    def user_id_or_email(self):
        """
        Gets the user_id_or_email of this IamUser.
        UserID or email as configured in the IdP.  

        :return: The user_id_or_email of this IamUser.
        :rtype: str
        """
    ...
    def user_id_or_email(self, user_id_or_email):
        """
        Sets the user_id_or_email of this IamUser.
        UserID or email as configured in the IdP.  

        :param user_id_or_email: The user_id_or_email of this IamUser.
        :type: str
        """
