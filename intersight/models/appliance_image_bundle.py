...
class ApplianceImageBundle(object):
    ...
    swagger_types = {
        ...
        'ansible_packages': 'list[OnpremOptionalImagePackage]',
        'auto_upgrade': 'bool',
        'dc_packages': 'list[OnpremOptionalImagePackage]',
        'debug_packages': 'list[OnpremOptionalImagePackage]',
        'description': 'str',
        'endpoint_packages': 'list[OnpremOptionalImagePackage]',
        'fingerprint': 'str',
        'has_error': 'bool',
        'infra_packages': 'list[OnpremOptionalImagePackage]',
        'init_packages': 'list[OnpremOptionalImagePackage]',
        'name': 'str',
        'notes': 'str',
        'priority': 'str',
        'release_time': 'datetime',
        'service_packages': 'list[OnpremOptionalImagePackage]',
        'status_message': 'str',
        'system_packages': 'list[OnpremOptionalImagePackage]',
        'ui_packages': 'list[OnpremOptionalImagePackage]',
    ...
    def ansible_packages(self):
        ...
        :rtype: list[OnpremOptionalImagePackage]
        """
    ...
    def ansible_packages(self, ansible_packages):
        ...
        :type: list[OnpremOptionalImagePackage]
        """
