...
class ApplianceImageBundle(object):
    ...
    def __init__(self, account_moid=None, ancestors=None, create_time=None, domain_group_moid=None, mod_time=None, moid=None, object_type=None, owners=None, parent=None, shared_scope=None, tags=None, version_context=None, ansible_packages=None, auto_upgrade=None, dc_packages=None, debug_packages=None, description=None, endpoint_packages=None, fingerprint=None, has_error=None, infra_packages=None, init_packages=None, name=None, notes=None, priority='Normal', release_time=None, service_packages=None, status_message=None, system_packages=None, ui_packages=None, upgrade_end_time=None, upgrade_grace_period=None, upgrade_start_time=None, version=None):
        """
