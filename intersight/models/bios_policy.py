...
class BiosPolicy(object):
    ...
    def cdn_support(self, cdn_support):
        ...
        :type: str
        """
        allowed_values = ["platform-default", "Disabled", "LOMs Only"]
    ...
    def qpi_link_frequency(self, qpi_link_frequency):
        ...
        :type: str
        """
        allowed_values = ["platform-default", "6.4-gt/s", "7.2-gt/s", "8.0-gt/s", "auto"]
