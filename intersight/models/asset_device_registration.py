...
class AssetDeviceRegistration(object):
    ...
    swagger_types = {
        ...
        'execution_mode': 'str',
        'parent_signature': 'AssetOptionalParentConnectionSignature',
        'pid': 'list[str]',
        'platform_type': 'str',
        ...
        'parent_connection': 'AssetDeviceRegistrationRef',
    ...
    def __init__(self, account_moid=None, create_time=None, domain_group_moid=None, mod_time=None, moid=None, object_type=None, owners=None, shared_scope=None, tags=None, version_context=None, ancestors=None, parent=None, permission_resources=None, api_version=None, app_partition_number=None, connection_id=None, connection_reason=None, connection_status='null', connection_status_last_change_time=None, connector_version=None, device_external_ip_address=None, proxy_app=None, access_key_id=None, claimed_by_user_name=None, claimed_time=None, device_hostname=None, device_ip_address=None, execution_mode='null', parent_signature=None, pid=None, platform_type='null', public_access_key=None, read_only=None, serial=None, vendor=None, account=None, claimed_by_user=None, cluster_members=None, device_claim=None, device_configuration=None, domain_group=None, parent_connection=None, security_token=None):
        """
    ...
    def domain_group_moid(self):
        """
        Gets the domain_group_moid of this AssetDeviceRegistration.
        The DomainGroup ID for this managed object.  

        :return: The domain_group_moid of this AssetDeviceRegistration.
        :rtype: str
        """
    ...
    def domain_group_moid(self, domain_group_moid):
        """
        Sets the domain_group_moid of this AssetDeviceRegistration.
        The DomainGroup ID for this managed object.  

        :param domain_group_moid: The domain_group_moid of this AssetDeviceRegistration.
        :type: str
        """
    ...
    def shared_scope(self):
        """
        Gets the shared_scope of this AssetDeviceRegistration.
        Intersight provides pre-built workflows, tasks and policies to end users through global catalogs. Objects that are made available through global catalogs are said to have a 'shared' ownership. Shared objects are either made globally available to all end users or restricted to end users based on their license entitlement. Users can use this property to differentiate the scope (global or a specific license tier) to which a shared MO belongs.  

        :return: The shared_scope of this AssetDeviceRegistration.
        :rtype: str
        """
    ...
    def shared_scope(self, shared_scope):
        """
        Sets the shared_scope of this AssetDeviceRegistration.
        Intersight provides pre-built workflows, tasks and policies to end users through global catalogs. Objects that are made available through global catalogs are said to have a 'shared' ownership. Shared objects are either made globally available to all end users or restricted to end users based on their license entitlement. Users can use this property to differentiate the scope (global or a specific license tier) to which a shared MO belongs.  

        :param shared_scope: The shared_scope of this AssetDeviceRegistration.
        :type: str
        """
    ...
    def permission_resources(self):
        """
        Gets the permission_resources of this AssetDeviceRegistration.
        ...
        :return: The permission_resources of this AssetDeviceRegistration.
        :rtype: list[MoBaseMoRef]
        """
    ...
    def permission_resources(self, permission_resources):
        """
        Sets the permission_resources of this AssetDeviceRegistration.
        A slice of all permission resources (organizations) associated with this object. Permission ties resources and its associated roles/privileges. These resources which can be specified in a permission is PermissionResource. Currently only organizations can be specified in permission. All logical and physical resources part of an organization will have organization in PermissionResources field. If DeviceRegistration contains another DeviceRegistration and if parent is in org1 and child is part of org2, then child objects will have PermissionResources as org1 and org2. Parent Objects will have PermissionResources as org1. All profiles/policies created with in an organization will have the organization as PermissionResources. 

        :param permission_resources: The permission_resources of this AssetDeviceRegistration.
        :type: list[MoBaseMoRef]
        """
    ...
    def parent_signature(self):
        """
        Gets the parent_signature of this AssetDeviceRegistration.
        A signature generated by a parent device used to authenticate that a leaf device is connected through the parent.  

        :return: The parent_signature of this AssetDeviceRegistration.
        :rtype: AssetOptionalParentConnectionSignature
        """
    ...
    def parent_signature(self, parent_signature):
        ...
        :param parent_signature: The parent_signature of this AssetDeviceRegistration.
        :type: AssetOptionalParentConnectionSignature
        """
    ...
    def parent_connection(self):
        """
        Gets the parent_connection of this AssetDeviceRegistration.
        The parent device of this device, through which this device connector is connected. If present the device will inherit its ownership through this object and any claim operation will be cascaded from it. e.g. A rack server may have a parent as the Fabric Interconnect cluster to which it is attached. 

        :return: The parent_connection of this AssetDeviceRegistration.
    ...
    def parent_connection(self, parent_connection):
        ...
        :param parent_connection: The parent_connection of this AssetDeviceRegistration.
