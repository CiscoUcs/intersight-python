...
class WorkflowProperties(object):
    ...
    def __init__(self, object_type=None, input_definition=None, output_definition=None, retry_count=None, retry_delay=None, retry_policy='Fixed', timeout=None, timeout_policy='Timeout'):
        """
