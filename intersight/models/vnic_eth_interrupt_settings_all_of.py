...
class VnicEthInterruptSettingsAllOf(object):
    ...
    def coalescing_time(self):
        """Gets the coalescing_time of this VnicEthInterruptSettingsAllOf.  # noqa: E501
        ...
        :return: The coalescing_time of this VnicEthInterruptSettingsAllOf.  # noqa: E501
        :rtype: int
        """
    ...
    def coalescing_time(self, coalescing_time):
        """Sets the coalescing_time of this VnicEthInterruptSettingsAllOf.

        The time to wait between interrupts or the idle period that must be encountered before an interrupt is sent. To turn off interrupt coalescing, enter 0 (zero) in this field.    # noqa: E501

        :param coalescing_time: The coalescing_time of this VnicEthInterruptSettingsAllOf.  # noqa: E501
        :type: int
        """
    ...
    def coalescing_type(self):
        """Gets the coalescing_type of this VnicEthInterruptSettingsAllOf.  # noqa: E501
        ...
        :return: The coalescing_type of this VnicEthInterruptSettingsAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def coalescing_type(self, coalescing_type):
        """Sets the coalescing_type of this VnicEthInterruptSettingsAllOf.

        Interrupt Coalescing Type. This can be one of the following:- MIN  - The system waits for the time specified in the Coalescing Time field before sending another interrupt event IDLE - The system does not send an interrupt until there is a period of no activity lasting as least as long as the time specified in the Coalescing Time field.    # noqa: E501

        :param coalescing_type: The coalescing_type of this VnicEthInterruptSettingsAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def count(self):
        """Gets the count of this VnicEthInterruptSettingsAllOf.  # noqa: E501
        ...
        :return: The count of this VnicEthInterruptSettingsAllOf.  # noqa: E501
        :rtype: int
        """
        return self._count
    ...
    def count(self, count):
        """Sets the count of this VnicEthInterruptSettingsAllOf.

        The number of interrupt resources to allocate. Typical value is be equal to the number of completion queue resources.    # noqa: E501

        :param count: The count of this VnicEthInterruptSettingsAllOf.  # noqa: E501
        :type: int
        """
    ...
    @property
    def mode(self):
        """Gets the mode of this VnicEthInterruptSettingsAllOf.  # noqa: E501
        ...
        :return: The mode of this VnicEthInterruptSettingsAllOf.  # noqa: E501
        :rtype: str
        """
        return self._mode
    ...
    @mode.setter
    def mode(self, mode):
        """Sets the mode of this VnicEthInterruptSettingsAllOf.

        Preferred driver interrupt mode. This can be one of the following:- MSIx - Message Signaled Interrupts (MSI) with the optional extension. MSI  - MSI only. INTx - PCI INTx interrupts. MSIx is the recommended option.     # noqa: E501

        :param mode: The mode of this VnicEthInterruptSettingsAllOf.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VnicEthInterruptSettingsAllOf):
            return False
