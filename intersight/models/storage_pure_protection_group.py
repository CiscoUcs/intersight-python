...
class StoragePureProtectionGroup(object):
    ...
    def __init__(self, account_moid=None, ancestors=None, create_time=None, domain_group_moid=None, mod_time=None, moid=None, object_type=None, owners=None, parent=None, shared_scope=None, tags=None, version_context=None, name=None, prefix=None, replication_enabled=None, snapshot_enabled=None, storage_array=None, host_groups=None, hosts=None, registered_device=None, size=None, source=None, targets=None, volumes=None):
        """
