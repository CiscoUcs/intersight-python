...
class AssetManagedDeviceStatus(object):
    ...
    def __init__(self, cloud_port=None, connection_failure_reason=None, connection_status='Unknown', error_code=None, error_reason=None, process_id=None, server_port=None, state='New'):
        """
    ...
    def state(self, state):
        ...
        :type: str
        """
        allowed_values = ["New", "StartSent", "StartSentFailure", "StartSuccess", "StartFailure", "UpdateSentFailure", "UpdateSent", "DeleteSentFailure", "DeleteInProgress", "DeleteFailure"]
