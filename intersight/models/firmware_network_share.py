...
class FirmwareNetworkShare(object):
    ...
    swagger_types = {
        'object_type': 'str',
        'cifs_server': 'FirmwareOptionalCifsServer',
        'http_server': 'FirmwareOptionalHttpServer',
        'is_password_set': 'bool',
        'map_type': 'str',
        'nfs_server': 'FirmwareOptionalNfsServer',
        'password': 'str',
        'upgradeoption': 'str',
        'username': 'str'
    }
    ...
    def __init__(self, object_type=None, cifs_server=None, http_server=None, is_password_set=None, map_type='nfs', nfs_server=None, password=None, upgradeoption='nw_upgrade_full', username=None):
        """
    ...
    def object_type(self):
        """
        Gets the object_type of this FirmwareNetworkShare.
        The concrete type of this complex type.  The ObjectType property must be set explicitly by API clients when the type is ambiguous. In all other cases, the  ObjectType is optional.  The type is ambiguous when a managed object contains an array of nested documents, and the documents in the array are heterogeneous, i.e. the array can contain nested documents of different types.    

        :return: The object_type of this FirmwareNetworkShare.
        :rtype: str
        """
    ...
    def object_type(self, object_type):
        """
        Sets the object_type of this FirmwareNetworkShare.
        The concrete type of this complex type.  The ObjectType property must be set explicitly by API clients when the type is ambiguous. In all other cases, the  ObjectType is optional.  The type is ambiguous when a managed object contains an array of nested documents, and the documents in the array are heterogeneous, i.e. the array can contain nested documents of different types.    

        :param object_type: The object_type of this FirmwareNetworkShare.
        :type: str
        """
    ...
    def cifs_server(self):
        ...
        :rtype: FirmwareOptionalCifsServer
        """
    ...
    def cifs_server(self, cifs_server):
        ...
        :type: FirmwareOptionalCifsServer
        """
    ...
    def http_server(self):
        ...
        :rtype: FirmwareOptionalHttpServer
        """
    ...
    def http_server(self, http_server):
        ...
        :type: FirmwareOptionalHttpServer
        """
    ...
    def nfs_server(self):
        ...
        :rtype: FirmwareOptionalNfsServer
        """
    ...
    def nfs_server(self, nfs_server):
        ...
        :type: FirmwareOptionalNfsServer
        """
