...
class WorkflowPrimitiveDataProperty(object):
    ...
    def __init__(self, object_type=None, constraints=None, secure=None, type='string'):
        """
    ...
    def secure(self):
        ...
        Intersight allows the secure properties to be used as task input/output. The values of these properties are encrypted and stored in Intersight.  This flag marks the property to be secure when it is set to true.   
