...
class VnicTcpOffloadSettingsAllOf(object):
    ...
    def large_receive(self):
        """Gets the large_receive of this VnicTcpOffloadSettingsAllOf.  # noqa: E501

        Enables the reassembly of segmented packets in hardware before sending them to the CPU.    # noqa: E501

        :return: The large_receive of this VnicTcpOffloadSettingsAllOf.  # noqa: E501
        :rtype: bool
        """
    ...
    def large_receive(self, large_receive):
        """Sets the large_receive of this VnicTcpOffloadSettingsAllOf.

        Enables the reassembly of segmented packets in hardware before sending them to the CPU.    # noqa: E501

        :param large_receive: The large_receive of this VnicTcpOffloadSettingsAllOf.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def large_send(self):
        """Gets the large_send of this VnicTcpOffloadSettingsAllOf.  # noqa: E501

        Enables the CPU to send large packets to the hardware for segmentation.    # noqa: E501

        :return: The large_send of this VnicTcpOffloadSettingsAllOf.  # noqa: E501
        :rtype: bool
        """
    ...
    def large_send(self, large_send):
        """Sets the large_send of this VnicTcpOffloadSettingsAllOf.

        Enables the CPU to send large packets to the hardware for segmentation.    # noqa: E501

        :param large_send: The large_send of this VnicTcpOffloadSettingsAllOf.  # noqa: E501
        :type: bool
        """
    ...
    def rx_checksum(self):
        """Gets the rx_checksum of this VnicTcpOffloadSettingsAllOf.  # noqa: E501

        When enabled, the CPU sends all packet checksums to the hardware for validation.    # noqa: E501

        :return: The rx_checksum of this VnicTcpOffloadSettingsAllOf.  # noqa: E501
        :rtype: bool
        """
    ...
    def rx_checksum(self, rx_checksum):
        """Sets the rx_checksum of this VnicTcpOffloadSettingsAllOf.

        When enabled, the CPU sends all packet checksums to the hardware for validation.    # noqa: E501

        :param rx_checksum: The rx_checksum of this VnicTcpOffloadSettingsAllOf.  # noqa: E501
        :type: bool
        """
    ...
    def tx_checksum(self):
        """Gets the tx_checksum of this VnicTcpOffloadSettingsAllOf.  # noqa: E501

        When enabled, the CPU sends all packets to the hardware so that the checksum can be calculated.     # noqa: E501

        :return: The tx_checksum of this VnicTcpOffloadSettingsAllOf.  # noqa: E501
        :rtype: bool
        """
    ...
    def tx_checksum(self, tx_checksum):
        """Sets the tx_checksum of this VnicTcpOffloadSettingsAllOf.

        When enabled, the CPU sends all packets to the hardware so that the checksum can be calculated.     # noqa: E501

        :param tx_checksum: The tx_checksum of this VnicTcpOffloadSettingsAllOf.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VnicTcpOffloadSettingsAllOf):
            return False
