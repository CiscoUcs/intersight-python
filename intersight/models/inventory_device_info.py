...
class InventoryDeviceInfo(object):
    ...
    def domain_group_moid(self):
        """
        Gets the domain_group_moid of this InventoryDeviceInfo.
        The DomainGroup ID for this managed object.  

        :return: The domain_group_moid of this InventoryDeviceInfo.
        :rtype: str
        """
    ...
    def domain_group_moid(self, domain_group_moid):
        """
        Sets the domain_group_moid of this InventoryDeviceInfo.
        The DomainGroup ID for this managed object.  

        :param domain_group_moid: The domain_group_moid of this InventoryDeviceInfo.
        :type: str
        """
    ...
    def shared_scope(self):
        """
        Gets the shared_scope of this InventoryDeviceInfo.
        Intersight provides pre-built workflows, tasks and policies to end users through global catalogs. Objects that are made available through global catalogs are said to have a 'shared' ownership. Shared objects are either made globally available to all end users or restricted to end users based on their license entitlement. Users can use this property to differentiate the scope (global or a specific license tier) to which a shared MO belongs.  

        :return: The shared_scope of this InventoryDeviceInfo.
        :rtype: str
        """
    ...
    def shared_scope(self, shared_scope):
        """
        Sets the shared_scope of this InventoryDeviceInfo.
        Intersight provides pre-built workflows, tasks and policies to end users through global catalogs. Objects that are made available through global catalogs are said to have a 'shared' ownership. Shared objects are either made globally available to all end users or restricted to end users based on their license entitlement. Users can use this property to differentiate the scope (global or a specific license tier) to which a shared MO belongs.  

        :param shared_scope: The shared_scope of this InventoryDeviceInfo.
        :type: str
        """
    ...
    def permission_resources(self):
        """
        Gets the permission_resources of this InventoryDeviceInfo.
        ...
        :return: The permission_resources of this InventoryDeviceInfo.
        :rtype: list[MoBaseMoRef]
        """
    ...
    def permission_resources(self, permission_resources):
        """
        Sets the permission_resources of this InventoryDeviceInfo.
        A slice of all permission resources (organizations) associated with this object. Permission ties resources and its associated roles/privileges. These resources which can be specified in a permission is PermissionResource. Currently only organizations can be specified in permission. All logical and physical resources part of an organization will have organization in PermissionResources field. If DeviceRegistration contains another DeviceRegistration and if parent is in org1 and child is part of org2, then child objects will have PermissionResources as org1 and org2. Parent Objects will have PermissionResources as org1. All profiles/policies created with in an organization will have the organization as PermissionResources. 

        :param permission_resources: The permission_resources of this InventoryDeviceInfo.
        :type: list[MoBaseMoRef]
        """
    ...
    def config_state(self):
        """
        Gets the config_state of this InventoryDeviceInfo.
        Configuration state of server profile config context.  

        :return: The config_state of this InventoryDeviceInfo.
        :rtype: str
        """
    ...
    def config_state(self, config_state):
        """
        Sets the config_state of this InventoryDeviceInfo.
        Configuration state of server profile config context.  

        :param config_state: The config_state of this InventoryDeviceInfo.
        :type: str
        """
    ...
    def control_action(self):
        """
        Gets the control_action of this InventoryDeviceInfo.
        Control action of server profile config context.  

        :return: The control_action of this InventoryDeviceInfo.
        :rtype: str
        """
    ...
    def control_action(self, control_action):
        """
        Sets the control_action of this InventoryDeviceInfo.
        Control action of server profile config context.  

        :param control_action: The control_action of this InventoryDeviceInfo.
        :type: str
        """
    ...
    def error_state(self):
        """
        Gets the error_state of this InventoryDeviceInfo.
        Error state of server profile config context.  

        :return: The error_state of this InventoryDeviceInfo.
        :rtype: str
        """
    ...
    def error_state(self, error_state):
        """
        Sets the error_state of this InventoryDeviceInfo.
        Error state of server profile config context.  

        :param error_state: The error_state of this InventoryDeviceInfo.
        :type: str
        """
    ...
    def oper_state(self):
        """
        Gets the oper_state of this InventoryDeviceInfo.
        Operational state of server profile config context.  

        :return: The oper_state of this InventoryDeviceInfo.
        :rtype: str
        """
    ...
    def oper_state(self, oper_state):
        """
        Sets the oper_state of this InventoryDeviceInfo.
        Operational state of server profile config context.  

        :param oper_state: The oper_state of this InventoryDeviceInfo.
        :type: str
        """
    ...
    def profile_mo_id(self):
        """
        Gets the profile_mo_id of this InventoryDeviceInfo.
        Server profile MO ID of the server.   

        :return: The profile_mo_id of this InventoryDeviceInfo.
        :rtype: str
        """
    ...
    def profile_mo_id(self, profile_mo_id):
        """
        Sets the profile_mo_id of this InventoryDeviceInfo.
        Server profile MO ID of the server.   

        :param profile_mo_id: The profile_mo_id of this InventoryDeviceInfo.
        :type: str
        """
