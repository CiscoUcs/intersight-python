...
class CondHclStatusDetail(object):
    ...
    def __init__(self, account_moid=None, ancestors=None, create_time=None, domain_group_moid=None, mod_time=None, moid=None, object_type=None, owners=None, parent=None, shared_scope=None, tags=None, version_context=None, component=None, hardware_status='Missing-Os-Driver-Info', hcl_cimc_version=None, hcl_driver_name=None, hcl_driver_version=None, hcl_firmware_version=None, hcl_model=None, hcl_status=None, inv_cimc_version=None, inv_driver_name=None, inv_driver_version=None, inv_firmware_version=None, inv_model=None, reason='Missing-Os-Driver-Info', software_status='Missing-Os-Driver-Info', status='Incomplete'):
        """
