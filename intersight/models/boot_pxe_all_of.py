...
class BootPxeAllOf(object):
    ...
    def __init__(self,
        ...
        """BootPxeAllOf - a model defined in OpenAPI"""  # noqa: E501
    ...
    def interface_name(self):
        """Gets the interface_name of this BootPxeAllOf.  # noqa: E501

        The name of the underlying virtual ethernet interface used by the PXE boot device.    # noqa: E501

        :return: The interface_name of this BootPxeAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def interface_name(self, interface_name):
        """Sets the interface_name of this BootPxeAllOf.

        The name of the underlying virtual ethernet interface used by the PXE boot device.    # noqa: E501

        :param interface_name: The interface_name of this BootPxeAllOf.  # noqa: E501
        :type: str
        """
    ...
    def interface_source(self):
        """Gets the interface_source of this BootPxeAllOf.  # noqa: E501

        Lists the supported Interface Source for PXE device. Supported values are \"name\" and \"mac\".    # noqa: E501

        :return: The interface_source of this BootPxeAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def interface_source(self, interface_source):
        """Sets the interface_source of this BootPxeAllOf.

        Lists the supported Interface Source for PXE device. Supported values are \"name\" and \"mac\".    # noqa: E501

        :param interface_source: The interface_source of this BootPxeAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def ip_type(self):
        """Gets the ip_type of this BootPxeAllOf.  # noqa: E501

        The IP Address family type to use during the PXE Boot process.    # noqa: E501

        :return: The ip_type of this BootPxeAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def ip_type(self, ip_type):
        """Sets the ip_type of this BootPxeAllOf.

        The IP Address family type to use during the PXE Boot process.    # noqa: E501

        :param ip_type: The ip_type of this BootPxeAllOf.  # noqa: E501
        :type: str
        """
    ...
    def mac_address(self):
        """Gets the mac_address of this BootPxeAllOf.  # noqa: E501

        The MAC Address of the underlying virtual ethernet interface used by the PXE boot device.    # noqa: E501

        :return: The mac_address of this BootPxeAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def mac_address(self, mac_address):
        """Sets the mac_address of this BootPxeAllOf.

        The MAC Address of the underlying virtual ethernet interface used by the PXE boot device.    # noqa: E501

        :param mac_address: The mac_address of this BootPxeAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def port(self):
        """Gets the port of this BootPxeAllOf.  # noqa: E501
        ...
        :return: The port of this BootPxeAllOf.  # noqa: E501
        :rtype: int
        """
        return self._port
    ...
    @port.setter
    def port(self, port):
        """Sets the port of this BootPxeAllOf.

        The logical port id of the ethernet interface used by the PXE device. Port is a deprecated property. Default value is changed to '-1' as this is invalid port. New or modified pxe device has the port value always set to '-1'.    # noqa: E501

        :param port: The port of this BootPxeAllOf.  # noqa: E501
        :type: int
        """
    ...
    @property
    def slot(self):
        """Gets the slot of this BootPxeAllOf.  # noqa: E501
        ...
        :return: The slot of this BootPxeAllOf.  # noqa: E501
        :rtype: str
        """
        return self._slot
    ...
    @slot.setter
    def slot(self, slot):
        """Sets the slot of this BootPxeAllOf.

        The slot ID of the adapter on which the underlying virtual ethernet interface is present. Supported values are ( 1 - 255, \"MLOM\", \"L\", \"L1\", \"L2\", \"OCP\").     # noqa: E501

        :param slot: The slot of this BootPxeAllOf.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BootPxeAllOf):
            return False
