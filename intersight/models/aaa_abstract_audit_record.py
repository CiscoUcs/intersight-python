...
class AaaAbstractAuditRecord(object):
    ...
    def __init__(self, account_moid=None, create_time=None, domain_group_moid=None, mod_time=None, moid=None, object_type=None, owners=None, shared_scope=None, tags=None, version_context=None, ancestors=None, parent=None, permission_resources=None, event=None, mo_display_names=None, mo_type=None, object_moid=None, request=None, trace_id=None):
        """
    ...
    def domain_group_moid(self):
        """
        Gets the domain_group_moid of this AaaAbstractAuditRecord.
        The DomainGroup ID for this managed object.

        :return: The domain_group_moid of this AaaAbstractAuditRecord.
        :rtype: str
        """
    ...
    def domain_group_moid(self, domain_group_moid):
        """
        Sets the domain_group_moid of this AaaAbstractAuditRecord.
        The DomainGroup ID for this managed object.

        :param domain_group_moid: The domain_group_moid of this AaaAbstractAuditRecord.
        :type: str
        """
    ...
    def shared_scope(self):
        """
        Gets the shared_scope of this AaaAbstractAuditRecord.
        Intersight provides pre-built workflows, tasks and policies to end users through global catalogs. Objects that are made available through global catalogs are said to have a 'shared' ownership. Shared objects are either made globally available to all end users or restricted to end users based on their license entitlement. Users can use this property to differentiate the scope (global or a specific license tier) to which a shared MO belongs.

        :return: The shared_scope of this AaaAbstractAuditRecord.
        :rtype: str
        """
    ...
    def shared_scope(self, shared_scope):
        """
        Sets the shared_scope of this AaaAbstractAuditRecord.
        Intersight provides pre-built workflows, tasks and policies to end users through global catalogs. Objects that are made available through global catalogs are said to have a 'shared' ownership. Shared objects are either made globally available to all end users or restricted to end users based on their license entitlement. Users can use this property to differentiate the scope (global or a specific license tier) to which a shared MO belongs.

        :param shared_scope: The shared_scope of this AaaAbstractAuditRecord.
        :type: str
        """
    ...
    def permission_resources(self):
        """
        Gets the permission_resources of this AaaAbstractAuditRecord.
        ...
        :return: The permission_resources of this AaaAbstractAuditRecord.
        :rtype: list[MoBaseMoRef]
        """
    ...
    def permission_resources(self, permission_resources):
        """
        Sets the permission_resources of this AaaAbstractAuditRecord.
        A slice of all permission resources (organizations) associated with this object. Permission ties resources and its associated roles/privileges. These resources which can be specified in a permission is PermissionResource. Currently only organizations can be specified in permission. All logical and physical resources part of an organization will have organization in PermissionResources field. If DeviceRegistration contains another DeviceRegistration and if parent is in org1 and child is part of org2, then child objects will have PermissionResources as org1 and org2. Parent Objects will have PermissionResources as org1. All profiles/policies created with in an organization will have the organization as PermissionResources.

        :param permission_resources: The permission_resources of this AaaAbstractAuditRecord.
        :type: list[MoBaseMoRef]
        """
    ...
    def mo_display_names(self):
        """
        Gets the mo_display_names of this AaaAbstractAuditRecord.
        The user-friendly names of the changed MO.

        :return: The mo_display_names of this AaaAbstractAuditRecord.
        :rtype: object
        """
    ...
    def mo_display_names(self, mo_display_names):
        """
        Sets the mo_display_names of this AaaAbstractAuditRecord.
        The user-friendly names of the changed MO.

        :param mo_display_names: The mo_display_names of this AaaAbstractAuditRecord.
        :type: object
        """
