...
class HyperflexClusterProfile(object):
    ...
    swagger_types = {
        ...
        'mgmt_platform': 'str',
        'replication': 'int',
        'storage_data_vlan': 'HyperflexOptionalNamedVlan',
        'wwxn_prefix': 'str',
    ...
    def __init__(self, account_moid=None, create_time=None, domain_group_moid=None, mod_time=None, moid=None, object_type=None, owners=None, shared_scope=None, tags=None, version_context=None, ancestors=None, parent=None, permission_resources=None, description=None, name=None, type='instance', src_template=None, action=None, config_context=None, data_ip_address=None, hypervisor_type='Unknown', mac_address_prefix=None, mgmt_ip_address=None, mgmt_platform='FI', replication=None, storage_data_vlan=None, wwxn_prefix=None, associated_cluster=None, auto_support=None, cluster_network=None, cluster_storage=None, config_result=None, ext_fc_storage=None, ext_iscsi_storage=None, local_credential=None, node_config=None, node_profile_config=None, organization=None, proxy_setting=None, running_workflows=None, software_version=None, sys_config=None, ucsm_config=None, vcenter_config=None):
        """
    ...
    def permission_resources(self):
        """
        Gets the permission_resources of this HyperflexClusterProfile.
        ...
        :return: The permission_resources of this HyperflexClusterProfile.
        :rtype: list[MoBaseMoRef]
        """
    ...
    def permission_resources(self, permission_resources):
        """
        Sets the permission_resources of this HyperflexClusterProfile.
        A slice of all permission resources (organizations) associated with this object. Permission ties resources and its associated roles/privileges. These resources which can be specified in a permission is PermissionResource. Currently only organizations can be specified in permission. All logical and physical resources part of an organization will have organization in PermissionResources field. If DeviceRegistration contains another DeviceRegistration and if parent is in org1 and child is part of org2, then child objects will have PermissionResources as org1 and org2. Parent Objects will have PermissionResources as org1. All profiles/policies created with in an organization will have the organization as PermissionResources. 

        :param permission_resources: The permission_resources of this HyperflexClusterProfile.
        :type: list[MoBaseMoRef]
        """
