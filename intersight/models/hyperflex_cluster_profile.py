...
class HyperflexClusterProfile(object):
    ...
    def __init__(self, account_moid=None, create_time=None, domain_group_moid=None, mod_time=None, moid=None, object_type=None, owners=None, shared_scope=None, tags=None, version_context=None, ancestors=None, parent=None, permission_resources=None, description=None, name=None, type='instance', src_template=None, action=None, config_context=None, data_ip_address=None, hypervisor_type='ESXi', mac_address_prefix=None, mgmt_ip_address=None, mgmt_platform='FI', replication=None, storage_data_vlan=None, wwxn_prefix=None, associated_cluster=None, auto_support=None, cluster_network=None, cluster_storage=None, config_result=None, ext_fc_storage=None, ext_iscsi_storage=None, local_credential=None, node_config=None, node_profile_config=None, organization=None, proxy_setting=None, running_workflows=None, software_version=None, sys_config=None, ucsm_config=None, vcenter_config=None):
        """
