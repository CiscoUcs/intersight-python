...
class IamUserAllOf(object):
    ...
    def client_ip_address(self):
        """Gets the client_ip_address of this IamUserAllOf.  # noqa: E501

        IP address from which the user last logged in to Intersight.    # noqa: E501

        :return: The client_ip_address of this IamUserAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def client_ip_address(self, client_ip_address):
        """Sets the client_ip_address of this IamUserAllOf.

        IP address from which the user last logged in to Intersight.    # noqa: E501

        :param client_ip_address: The client_ip_address of this IamUserAllOf.  # noqa: E501
        :type: str
        """
    ...
    def email(self, email):
        """Sets the email of this IamUserAllOf.

        Email of the user. Users are added to Intersight using the email configured in the IdP.    # noqa: E501

        :param email: The email of this IamUserAllOf.  # noqa: E501
        :type: str
        """
    ...
    def first_name(self, first_name):
        """Sets the first_name of this IamUserAllOf.

        First name of the user. This field is populated from the IdP attributes received after authentication.    # noqa: E501

        :param first_name: The first_name of this IamUserAllOf.  # noqa: E501
        :type: str
        """
    ...
    def last_login_time(self):
        """Gets the last_login_time of this IamUserAllOf.  # noqa: E501

        Last successful login time for user.    # noqa: E501

        :return: The last_login_time of this IamUserAllOf.  # noqa: E501
        :rtype: datetime
        """
    ...
    def last_login_time(self, last_login_time):
        """Sets the last_login_time of this IamUserAllOf.

        Last successful login time for user.    # noqa: E501

        :param last_login_time: The last_login_time of this IamUserAllOf.  # noqa: E501
        :type: datetime
        """
    ...
    def last_name(self, last_name):
        """Sets the last_name of this IamUserAllOf.

        Last name of the user. This field is populated from the IdP attributes received after authentication.    # noqa: E501

        :param last_name: The last_name of this IamUserAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this IamUserAllOf.  # noqa: E501

        UserID as configured in the IdP.    # noqa: E501

        :return: The name of this IamUserAllOf.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this IamUserAllOf.

        UserID as configured in the IdP.    # noqa: E501

        :param name: The name of this IamUserAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def user_type(self):
        """Gets the user_type of this IamUserAllOf.  # noqa: E501
        ...
        :return: The user_type of this IamUserAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def user_type(self, user_type):
        """Sets the user_type of this IamUserAllOf.

        Type of the User. If a user is added manually by specifying the email address, or has logged in using groups, based on the IdP attributes received during authentication. If added manually, the user type will be static, otherwise dynamic.     # noqa: E501

        :param user_type: The user_type of this IamUserAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def api_keys(self):
        """Gets the api_keys of this IamUserAllOf.  # noqa: E501
        ...
        :return: The api_keys of this IamUserAllOf.  # noqa: E501
    ...
    def api_keys(self, api_keys):
        """Sets the api_keys of this IamUserAllOf.

        A reference to a iamApiKey resource. When the $expand query parameter is specified, the referenced resource is returned inline. Current user's API keys. API keys are used to programatically perform API calls.   # noqa: E501

        :param api_keys: The api_keys of this IamUserAllOf.  # noqa: E501
        :type: list[IamApiKey]
        """
    ...
    def app_registrations(self):
        """Gets the app_registrations of this IamUserAllOf.  # noqa: E501
        ...
        :return: The app_registrations of this IamUserAllOf.  # noqa: E501
    ...
    def app_registrations(self, app_registrations):
        """Sets the app_registrations of this IamUserAllOf.

        A reference to a iamAppRegistration resource. When the $expand query parameter is specified, the referenced resource is returned inline. List of registered OAuth2 applications created by the User.   # noqa: E501

        :param app_registrations: The app_registrations of this IamUserAllOf.  # noqa: E501
    ...
    @property
    def idp(self):
        """Gets the idp of this IamUserAllOf.  # noqa: E501


        :return: The idp of this IamUserAllOf.  # noqa: E501
        :rtype: IamIdp
        """
        return self._idp
    ...
    @idp.setter
    def idp(self, idp):
        """Sets the idp of this IamUserAllOf.


        :param idp: The idp of this IamUserAllOf.  # noqa: E501
        :type: IamIdp
        """
    ...
    def idpreference(self):
        """Gets the idpreference of this IamUserAllOf.  # noqa: E501


        :return: The idpreference of this IamUserAllOf.  # noqa: E501
    ...
    def idpreference(self, idpreference):
        """Sets the idpreference of this IamUserAllOf.


        :param idpreference: The idpreference of this IamUserAllOf.  # noqa: E501
    ...
    def local_user_password(self):
        """Gets the local_user_password of this IamUserAllOf.  # noqa: E501


        :return: The local_user_password of this IamUserAllOf.  # noqa: E501
    ...
    def local_user_password(self, local_user_password):
        """Sets the local_user_password of this IamUserAllOf.


        :param local_user_password: The local_user_password of this IamUserAllOf.  # noqa: E501
    ...
    def oauth_tokens(self):
        """Gets the oauth_tokens of this IamUserAllOf.  # noqa: E501
        ...
        :return: The oauth_tokens of this IamUserAllOf.  # noqa: E501
    ...
    def oauth_tokens(self, oauth_tokens):
        """Sets the oauth_tokens of this IamUserAllOf.

        A reference to a iamOAuthToken resource. When the $expand query parameter is specified, the referenced resource is returned inline. Collection of the available OAuthTokens. Each OAuthToken lives 30 days unless it is deleted manually by User. OAuthToken is created when Login performed via OAuth Client (AppRegistration). OAuthToken itself is not sensitive data since it doesn't contain salt, salt is stored in Vault.   # noqa: E501

        :param oauth_tokens: The oauth_tokens of this IamUserAllOf.  # noqa: E501
    ...
    def permissions(self):
        """Gets the permissions of this IamUserAllOf.  # noqa: E501
        ...
        :return: The permissions of this IamUserAllOf.  # noqa: E501
    ...
    def permissions(self, permissions):
        """Sets the permissions of this IamUserAllOf.

        A reference to a iamPermission resource. When the $expand query parameter is specified, the referenced resource is returned inline. Permissions assigned to the user. Permission provides a way to assign roles to a user or user group to perform operations on object hierarchy.   # noqa: E501

        :param permissions: The permissions of this IamUserAllOf.  # noqa: E501
    ...
    @property
    def sessions(self):
        """Gets the sessions of this IamUserAllOf.  # noqa: E501
        ...
        :return: The sessions of this IamUserAllOf.  # noqa: E501
    ...
    def sessions(self, sessions):
        """Sets the sessions of this IamUserAllOf.

        A reference to a iamSession resource. When the $expand query parameter is specified, the referenced resource is returned inline. Current user's web sessions. After a user logs into Intersight, a session object is created. This session object is deleted upon logout, idle timeout, expiry timeout, or manual deletion.   # noqa: E501

        :param sessions: The sessions of this IamUserAllOf.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IamUserAllOf):
            return False
