...
class StoragePhysicalDisk(object):
    ...
    def __init__(self, account_moid=None, create_time=None, domain_group_moid=None, mod_time=None, moid=None, object_type=None, owners=None, shared_scope=None, tags=None, version_context=None, ancestors=None, parent=None, permission_resources=None, device_mo_id=None, dn=None, rn=None, model=None, revision=None, serial=None, vendor=None, block_size=None, bootable=None, configuration_checkpoint=None, configuration_state=None, discovered_path=None, disk_id=None, disk_state=None, drive_firmware=None, drive_state=None, fde_capable=None, link_speed=None, link_state=None, num_blocks=None, oper_power_state=None, oper_qualifier_reason=None, operability=None, physical_block_size=None, pid=None, presence=None, protocol=None, raw_size=None, secured=None, size=None, thermal=None, type=None, variant_type=None, locator_led=None, physical_disk_extensions=None, registered_device=None, running_firmware=None, sas_ports=None, storage_controller=None, storage_enclosure=None):
        """
    ...
    def permission_resources(self):
        """
        Gets the permission_resources of this StoragePhysicalDisk.
        ...
        :return: The permission_resources of this StoragePhysicalDisk.
        :rtype: list[MoBaseMoRef]
        """
    ...
    def permission_resources(self, permission_resources):
        """
        Sets the permission_resources of this StoragePhysicalDisk.
        A slice of all permission resources (organizations) associated with this object. Permission ties resources and its associated roles/privileges. These resources which can be specified in a permission is PermissionResource. Currently only organizations can be specified in permission. All logical and physical resources part of an organization will have organization in PermissionResources field. If DeviceRegistration contains another DeviceRegistration and if parent is in org1 and child is part of org2, then child objects will have PermissionResources as org1 and org2. Parent Objects will have PermissionResources as org1. All profiles/policies created with in an organization will have the organization as PermissionResources. 

        :param permission_resources: The permission_resources of this StoragePhysicalDisk.
        :type: list[MoBaseMoRef]
        """
