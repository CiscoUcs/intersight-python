...
class FirmwareDistributable(object):
    ...
    def domain_group_moid(self):
        """
        Gets the domain_group_moid of this FirmwareDistributable.
        The DomainGroup ID for this managed object.  

        :return: The domain_group_moid of this FirmwareDistributable.
        :rtype: str
        """
    ...
    def domain_group_moid(self, domain_group_moid):
        """
        Sets the domain_group_moid of this FirmwareDistributable.
        The DomainGroup ID for this managed object.  

        :param domain_group_moid: The domain_group_moid of this FirmwareDistributable.
        :type: str
        """
    ...
    def shared_scope(self):
        """
        Gets the shared_scope of this FirmwareDistributable.
        Intersight provides pre-built workflows, tasks and policies to end users through global catalogs. Objects that are made available through global catalogs are said to have a 'shared' ownership. Shared objects are either made globally available to all end users or restricted to end users based on their license entitlement. Users can use this property to differentiate the scope (global or a specific license tier) to which a shared MO belongs.  

        :return: The shared_scope of this FirmwareDistributable.
        :rtype: str
        """
    ...
    def shared_scope(self, shared_scope):
        """
        Sets the shared_scope of this FirmwareDistributable.
        Intersight provides pre-built workflows, tasks and policies to end users through global catalogs. Objects that are made available through global catalogs are said to have a 'shared' ownership. Shared objects are either made globally available to all end users or restricted to end users based on their license entitlement. Users can use this property to differentiate the scope (global or a specific license tier) to which a shared MO belongs.  

        :param shared_scope: The shared_scope of this FirmwareDistributable.
        :type: str
        """
    ...
    def permission_resources(self):
        """
        Gets the permission_resources of this FirmwareDistributable.
        ...
        :return: The permission_resources of this FirmwareDistributable.
        :rtype: list[MoBaseMoRef]
        """
    ...
    def permission_resources(self, permission_resources):
        """
        Sets the permission_resources of this FirmwareDistributable.
        A slice of all permission resources (organizations) associated with this object. Permission ties resources and its associated roles/privileges. These resources which can be specified in a permission is PermissionResource. Currently only organizations can be specified in permission. All logical and physical resources part of an organization will have organization in PermissionResources field. If DeviceRegistration contains another DeviceRegistration and if parent is in org1 and child is part of org2, then child objects will have PermissionResources as org1 and org2. Parent Objects will have PermissionResources as org1. All profiles/policies created with in an organization will have the organization as PermissionResources. 

        :param permission_resources: The permission_resources of this FirmwareDistributable.
        :type: list[MoBaseMoRef]
        """
    ...
    def download_count(self):
        """
        Gets the download_count of this FirmwareDistributable.
        ...
        :return: The download_count of this FirmwareDistributable.
        :rtype: int
        """
    ...
    def download_count(self, download_count):
        """
        Sets the download_count of this FirmwareDistributable.
        The number of times this file has been downloaded from the local repository. It is used by the repository monitoring process to determine the files that are to be evicted from the cache.  

        :param download_count: The download_count of this FirmwareDistributable.
        :type: int
        """
    ...
    def import_action(self):
        """
        Gets the import_action of this FirmwareDistributable.
        ...
        :return: The import_action of this FirmwareDistributable.
        :rtype: str
        """
    ...
    def import_action(self, import_action):
        """
        Sets the import_action of this FirmwareDistributable.
        The action to be performed on the imported file. If 'PreCache' is set, the image will be cached in Appliance. Applicable in Intersight appliance deployment. If 'Evict' is set, the cached file will be removed. Applicable in Intersight appliance deployment. If 'GeneratePreSignedUploadUrl' is set, generates pre signed URL (s) for the file to be imported into the repository. Applicable for local machine source. The URL (s) will be populated under LocalMachine file server. If 'CompleteImportProcess' is set, the ImportState is marked as 'Imported'. Applicable for local machine source. If 'Cancel' is set, the ImportState is marked as 'Failed'. Applicable for local machine source.   

        :param import_action: The import_action of this FirmwareDistributable.
        :type: str
        """
    ...
    def import_state(self):
        """
        Gets the import_state of this FirmwareDistributable.
        ...
        :return: The import_state of this FirmwareDistributable.
        :rtype: str
        """
    ...
    def import_state(self, import_state):
        """
        Sets the import_state of this FirmwareDistributable.
        The state  of this file in the repository or Appliance. The importState is updated during the import operation and as part of the repository monitoring process.  

        :param import_state: The import_state of this FirmwareDistributable.
        :type: str
        """
    ...
    def imported_time(self):
        """
        Gets the imported_time of this FirmwareDistributable.
        ...
        :return: The imported_time of this FirmwareDistributable.
        :rtype: datetime
        """
    ...
    def imported_time(self, imported_time):
        """
        Sets the imported_time of this FirmwareDistributable.
        The time at which this image or file was imported/cached into the repositry. if the 'ImportState' is 'Imported', the time at which this image or file was imported. if the 'ImportState' is 'Cached', the time at which this image or file was cached.  

        :param imported_time: The imported_time of this FirmwareDistributable.
        :type: datetime
        """
    ...
    def last_access_time(self):
        """
        Gets the last_access_time of this FirmwareDistributable.
        ...
        :return: The last_access_time of this FirmwareDistributable.
        :rtype: datetime
        """
    ...
    def last_access_time(self, last_access_time):
        """
        Sets the last_access_time of this FirmwareDistributable.
        The time at which this file was last downloaded from the local repository. It is used by the repository monitoring process to determine the files that are to be evicted from the cache.  

        :param last_access_time: The last_access_time of this FirmwareDistributable.
        :type: datetime
        """
    ...
    def sha512sum(self):
        """
        Gets the sha512sum of this FirmwareDistributable.
        ...
        :return: The sha512sum of this FirmwareDistributable.
        :rtype: str
        """
    ...
    def sha512sum(self, sha512sum):
        """
        Sets the sha512sum of this FirmwareDistributable.
        The sha512sum of the file. This information is available for all Cisco distributed images and files imported to the local repository.  

        :param sha512sum: The sha512sum of this FirmwareDistributable.
        :type: str
        """
    ...
    def recommended_build(self):
        """
        Gets the recommended_build of this FirmwareDistributable.
        The build which is recommended by Cisco.  

        :return: The recommended_build of this FirmwareDistributable.
        :rtype: str
        """
    ...
    def recommended_build(self, recommended_build):
        """
        Sets the recommended_build of this FirmwareDistributable.
        The build which is recommended by Cisco.  

        :param recommended_build: The recommended_build of this FirmwareDistributable.
        :type: str
        """
    ...
    def release_notes_url(self):
        """
        Gets the release_notes_url of this FirmwareDistributable.
        The url for the release notes of this image.  

        :return: The release_notes_url of this FirmwareDistributable.
        :rtype: str
        """
    ...
    def release_notes_url(self, release_notes_url):
        """
        Sets the release_notes_url of this FirmwareDistributable.
        The url for the release notes of this image.  

        :param release_notes_url: The release_notes_url of this FirmwareDistributable.
        :type: str
        """
    ...
    def catalog(self):
        """
        Gets the catalog of this FirmwareDistributable.
        The catalog where this image is present. 

        :return: The catalog of this FirmwareDistributable.
    ...
    def catalog(self, catalog):
        """
        Sets the catalog of this FirmwareDistributable.
        The catalog where this image is present. 

        :param catalog: The catalog of this FirmwareDistributable.
