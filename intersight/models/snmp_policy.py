...
class SnmpPolicy(object):
    ...
    swagger_types = {
        ...
        'engine_id': 'str',
        'snmp_port': 'int',
        'snmp_traps': 'list[SnmpOptionalTrap]',
        'snmp_users': 'list[SnmpOptionalUser]',
        'sys_contact': 'str',
        'sys_location': 'str',
        'trap_community': 'str',
