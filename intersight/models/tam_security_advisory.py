...
class TamSecurityAdvisory(object):
    ...
    swagger_types = {
        ...
        'state': 'str',
        'actions': 'list[TamOptionalAction]',
        'advisory_id': 'str',
        'api_data_sources': 'list[TamOptionalApiDataSource]',
        'base_score': 'float',
        'cve_ids': 'list[str]',
    ...
    def api_data_sources(self):
        ...
        :rtype: list[TamOptionalApiDataSource]
        """
    ...
    def api_data_sources(self, api_data_sources):
        ...
        :type: list[TamOptionalApiDataSource]
        """
