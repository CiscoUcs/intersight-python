...
class WorkflowWorkflowMeta(object):
    ...
    swagger_types = {
        ...
        'tasks': 'object',
        'version': 'int',
        'workflow_tasks': 'list[WorkflowWorkflowTaskRef]'
    }
    ...
    def workflow_tasks(self):
        """
        Gets the workflow_tasks of this WorkflowWorkflowMeta.
        The list of tasks contained inside the workflow 

        :return: The workflow_tasks of this WorkflowWorkflowMeta.
        :rtype: list[WorkflowWorkflowTaskRef]
        """
        return self._workflow_tasks

    @workflow_tasks.setter
    def workflow_tasks(self, workflow_tasks):
        """
        Sets the workflow_tasks of this WorkflowWorkflowMeta.
        The list of tasks contained inside the workflow 

        :param workflow_tasks: The workflow_tasks of this WorkflowWorkflowMeta.
        :type: list[WorkflowWorkflowTaskRef]
        """
