...
class WorkflowTaskDefinitionAllOf(object):
    ...
    def __init__(self,
        ...
        """WorkflowTaskDefinitionAllOf - a model defined in OpenAPI"""  # noqa: E501
    ...
    def default_version(self):
        """Gets the default_version of this WorkflowTaskDefinitionAllOf.  # noqa: E501
        ...
        :return: The default_version of this WorkflowTaskDefinitionAllOf.  # noqa: E501
        :rtype: bool
        """
    ...
    def default_version(self, default_version):
        """Sets the default_version of this WorkflowTaskDefinitionAllOf.

        When true this will be the task version that is used when a specific task definition version is not specified. The very first task definition created with a name will be set as the default version, after that user can explicitly set any version of the task definition as the default version.    # noqa: E501

        :param default_version: The default_version of this WorkflowTaskDefinitionAllOf.  # noqa: E501
        :type: bool
        """
    ...
    def description(self):
        """Gets the description of this WorkflowTaskDefinitionAllOf.  # noqa: E501

        The task definition description to describe what this task will do when executed.    # noqa: E501

        :return: The description of this WorkflowTaskDefinitionAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this WorkflowTaskDefinitionAllOf.

        The task definition description to describe what this task will do when executed.    # noqa: E501

        :param description: The description of this WorkflowTaskDefinitionAllOf.  # noqa: E501
        :type: str
        """
    ...
    def internal_properties(self):
        """Gets the internal_properties of this WorkflowTaskDefinitionAllOf.  # noqa: E501


        :return: The internal_properties of this WorkflowTaskDefinitionAllOf.  # noqa: E501
    ...
    def internal_properties(self, internal_properties):
        """Sets the internal_properties of this WorkflowTaskDefinitionAllOf.


        :param internal_properties: The internal_properties of this WorkflowTaskDefinitionAllOf.  # noqa: E501
    ...
    @property
    def label(self):
        """Gets the label of this WorkflowTaskDefinitionAllOf.  # noqa: E501

        A user friendly short name to identify the task definition.    # noqa: E501

        :return: The label of this WorkflowTaskDefinitionAllOf.  # noqa: E501
        :rtype: str
        """
        return self._label
    ...
    def label(self, label):
        """Sets the label of this WorkflowTaskDefinitionAllOf.

        A user friendly short name to identify the task definition.    # noqa: E501

        :param label: The label of this WorkflowTaskDefinitionAllOf.  # noqa: E501
        :type: str
        """
    ...
    def license_entitlement(self):
        """Gets the license_entitlement of this WorkflowTaskDefinitionAllOf.  # noqa: E501

        License entitlement required to run this task. It is determined by license requirement of features.    # noqa: E501

        :return: The license_entitlement of this WorkflowTaskDefinitionAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def license_entitlement(self, license_entitlement):
        """Sets the license_entitlement of this WorkflowTaskDefinitionAllOf.

        License entitlement required to run this task. It is determined by license requirement of features.    # noqa: E501

        :param license_entitlement: The license_entitlement of this WorkflowTaskDefinitionAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this WorkflowTaskDefinitionAllOf.  # noqa: E501
        ...
        :return: The name of this WorkflowTaskDefinitionAllOf.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this WorkflowTaskDefinitionAllOf.

        The name of the task definition. The name should follow this convention <Verb or Action><Category><Vendor><Product><Noun or object> Verb or Action is a required portion of the name and this must be part of the pre-approved verb list. Category is an optional field and this will refer to the broad category of the task referring to the type of resource or endpoint. If there is no specific category then use \"Generic\" if required. Vendor is an optional field and this will refer to the specific vendor this task applies to. If the task is generic and not tied to a vendor, then do not specify anything. Product is an optional field, this will contain the vendor product and model when desired. Noun or object is a required field and  this will contain the noun or object on which the action is being performed. Examples SendEmail  - This is a task in Generic category for sending email. NewStorageVolume - This is a vendor agnostic task under Storage device category for creating a new volume.    # noqa: E501

        :param name: The name of this WorkflowTaskDefinitionAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def properties(self):
        """Gets the properties of this WorkflowTaskDefinitionAllOf.  # noqa: E501


        :return: The properties of this WorkflowTaskDefinitionAllOf.  # noqa: E501
    ...
    def properties(self, properties):
        """Sets the properties of this WorkflowTaskDefinitionAllOf.


        :param properties: The properties of this WorkflowTaskDefinitionAllOf.  # noqa: E501
    ...
    @property
    def version(self):
        """Gets the version of this WorkflowTaskDefinitionAllOf.  # noqa: E501

        The version of the task definition so we can support multiple versions of a task definition.     # noqa: E501

        :return: The version of this WorkflowTaskDefinitionAllOf.  # noqa: E501
        :rtype: int
        """
    ...
    def version(self, version):
        """Sets the version of this WorkflowTaskDefinitionAllOf.

        The version of the task definition so we can support multiple versions of a task definition.     # noqa: E501

        :param version: The version of this WorkflowTaskDefinitionAllOf.  # noqa: E501
        :type: int
        """
    ...
    @property
    def catalog(self):
        """Gets the catalog of this WorkflowTaskDefinitionAllOf.  # noqa: E501


        :return: The catalog of this WorkflowTaskDefinitionAllOf.  # noqa: E501
    ...
    def catalog(self, catalog):
        """Sets the catalog of this WorkflowTaskDefinitionAllOf.


        :param catalog: The catalog of this WorkflowTaskDefinitionAllOf.  # noqa: E501
    ...
    def implemented_tasks(self):
        """Gets the implemented_tasks of this WorkflowTaskDefinitionAllOf.  # noqa: E501
        ...
        :return: The implemented_tasks of this WorkflowTaskDefinitionAllOf.  # noqa: E501
    ...
    def implemented_tasks(self, implemented_tasks):
        """Sets the implemented_tasks of this WorkflowTaskDefinitionAllOf.

        A reference to a workflowTaskDefinition resource. When the $expand query parameter is specified, the referenced resource is returned inline. List of all the implemented task for this TaskDefinition. When this list is populated it implies that this TaskDefinition has multiple implementations.   # noqa: E501

        :param implemented_tasks: The implemented_tasks of this WorkflowTaskDefinitionAllOf.  # noqa: E501
    ...
    def interface_task(self):
        """Gets the interface_task of this WorkflowTaskDefinitionAllOf.  # noqa: E501


        :return: The interface_task of this WorkflowTaskDefinitionAllOf.  # noqa: E501
    ...
    def interface_task(self, interface_task):
        """Sets the interface_task of this WorkflowTaskDefinitionAllOf.


        :param interface_task: The interface_task of this WorkflowTaskDefinitionAllOf.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WorkflowTaskDefinitionAllOf):
            return False
