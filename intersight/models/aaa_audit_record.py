...
class AaaAuditRecord(object):
    ...
    def __init__(self, account_moid=None, create_time=None, domain_group_moid=None, mod_time=None, moid=None, object_type=None, owners=None, shared_scope=None, tags=None, version_context=None, ancestors=None, parent=None, permission_resources=None, event=None, mo_type=None, object_moid=None, request=None, trace_id=None, email=None, inst_id=None, source_ip=None, timestamp=None, account=None, sessions=None, user=None):
        """
