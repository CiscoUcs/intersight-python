...
class MoMoRef(object):
    ...
    def __init__(self,
        ...
        """MoMoRef - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def moid(self):
        """Gets the moid of this MoMoRef.  # noqa: E501

        The Moid of the referenced REST resource.    # noqa: E501

        :return: The moid of this MoMoRef.  # noqa: E501
        :rtype: str
        """
        return self._moid
    ...
    @moid.setter
    def moid(self, moid):
        """Sets the moid of this MoMoRef.

        The Moid of the referenced REST resource.    # noqa: E501

        :param moid: The moid of this MoMoRef.  # noqa: E501
        :type: str
        """
    ...
    def object_type(self):
        """Gets the object_type of this MoMoRef.  # noqa: E501

        The Object Type of the referenced REST resource.    # noqa: E501

        :return: The object_type of this MoMoRef.  # noqa: E501
        :rtype: str
        """
    ...
    def object_type(self, object_type):
        """Sets the object_type of this MoMoRef.

        The Object Type of the referenced REST resource.    # noqa: E501

        :param object_type: The object_type of this MoMoRef.  # noqa: E501
        :type: str
        """
    ...
    @property
    def selector(self):
        """Gets the selector of this MoMoRef.  # noqa: E501
        ...
        :return: The selector of this MoMoRef.  # noqa: E501
        :rtype: str
        """
    ...
    def selector(self, selector):
        """Sets the selector of this MoMoRef.

        An OData $filter expression which describes the REST resource to be referenced. This field may be set instead of 'moid' by clients. If 'moid' is set this field is ignored. If 'selector' is set and 'moid' is empty/absent from the request, Intersight will determine the Moid of the resource matching the filter expression and populate it in the MoRef that is part of the object instance being inserted/updated to fulfill the REST request. An error is returned if the filter matches zero or more than one REST resource. An example filter string is: Serial eq '3AA8B7T11'.      # noqa: E501

        :param selector: The selector of this MoMoRef.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MoMoRef):
            return False
