...
class OnpremSchedule(object):
    ...
    def __init__(self, day_of_month=None, day_of_week=None, month_of_year=None, repeat_interval=None, time_of_day=None, time_zone='Pacific/Niue', week_of_month=None):
        """
