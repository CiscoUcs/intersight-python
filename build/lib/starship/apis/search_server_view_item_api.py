...
class SearchServerViewItemApi(object):
    """
    ...
    def search_server_view_items_get(self, **kwargs):
        """
        List of searchServerViewItems
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.search_server_view_items_get(callback=callback_function)
        ...
        :return: SearchServerViewItemList
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.search_server_view_items_get_with_http_info(**kwargs)
        else:
            (data) = self.search_server_view_items_get_with_http_info(**kwargs)
            return data

    def search_server_view_items_get_with_http_info(self, **kwargs):
        """
        List of searchServerViewItems
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.search_server_view_items_get_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method search_server_view_items_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/search/ServerViewItems', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        ...
                                        response_type='SearchServerViewItemList',
    ...
    def search_server_view_items_moid_get(self, moid, **kwargs):
        """
        A instance of searchServerViewItem
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        >>> def callback_function(response):
        >>>     pprint(response)
        >>>
        >>> thread = api.search_server_view_items_moid_get(moid, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str moid: The moid of the searchServerViewItem instance. (required)
        :return: SearchServerViewItem
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.search_server_view_items_moid_get_with_http_info(moid, **kwargs)
        else:
            (data) = self.search_server_view_items_moid_get_with_http_info(moid, **kwargs)
            return data

    def search_server_view_items_moid_get_with_http_info(self, moid, **kwargs):
        """
        A instance of searchServerViewItem
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.search_server_view_items_moid_get_with_http_info(moid, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method search_server_view_items_moid_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'moid' is set
        if ('moid' not in params) or (params['moid'] is None):
            raise ValueError("Missing the required parameter `moid` when calling `search_server_view_items_moid_get`")
        ...
        return self.api_client.call_api('/search/ServerViewItems/{moid}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='SearchServerViewItem',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
